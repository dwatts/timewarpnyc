...
import { DragEvent, SortableComponent } from "../../utils/sortableComponent";
/**
 ...
 */
export declare class ValueList<ItemElement extends HTMLCalciteValueListItemElement = HTMLCalciteValueListItemElement> implements InteractiveComponent, LoadableComponent, LocalizedComponent, T9nComponent, SortableComponent {
  /**
