...
import { f as focusFirstTabbable, g as getSlotted, t as toAriaBoolean, b as getElementDir } from './dom-643f9db5.js';
...
const Block = class {
  ...
  renderIcon() {
    ...
    return loading ? (h("div", { class: CSS$1.icon, key: "loader" }, h("calcite-loader", { inline: true, label: messages.loading }))) : !!status ? (h("div", { class: CSS$1.icon, key: "status-icon" }, h("calcite-icon", { class: {
      ...
      }, icon: ICONS$1[status], scale: "m" }))) : hasSlottedIcon ? (h("div", { class: CSS$1.icon, key: "icon-slot" }, h("slot", { key: "icon-slot", name: SLOTS.icon }))) : null;
  }
  renderTitle() {
