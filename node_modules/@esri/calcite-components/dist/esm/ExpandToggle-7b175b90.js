 ...
 * v1.5.0
 */
import { f as forceUpdate, h } from './index-53d57a76.js';
import { b as getElementDir } from './dom-643f9db5.js';
import { S as SLOTS$1 } from './resources-dd40526d.js';
import { S as SLOTS } from './resources-55f4ce49.js';
...
const ExpandToggle = ({ expanded, expandText, collapseText, toggle, el, position, tooltip, ref, scale, }) => {
  ...
  const actionNode = (h("calcite-action", { icon: expanded ? expandIcon : collapseIcon, onClick: toggle, scale: scale, text: text, textEnabled: expanded, 
