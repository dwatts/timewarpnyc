 ...
 * v1.5.0
 */
import { r as registerInstance, c as createEvent, h, F as Fragment, a as getElement } from './index-53d57a76.js';
import { e as slotChangeHasAssignedElement, s as slotChangeGetAssignedElements, f as focusFirstTabbable, t as toAriaBoolean } from './dom-643f9db5.js';
import { c as connectInteractive, u as updateHostInteraction, d as disconnectInteractive } from './interactive-42caa6bb.js';
import { s as setUpLoadableComponent, a as setComponentLoaded, c as componentFocusable } from './loadable-a5c3241b.js';
import { c as createObserver } from './observers-09626586.js';
import { S as SLOTS$1 } from './resources-55f4ce49.js';
import { H as Heading } from './Heading-2b21a618.js';
import { S as SLOTS, C as CSS, I as ICONS } from './resources-66c3dcf8.js';
...
const Panel = class {
  ...
  renderActionBar() {
    return (h("div", { class: { [CSS.actionBarContainer]: true, [CSS.bottomSeparator]: this.hasDefaultContent }, hidden: !this.hasActionBar }, h("slot", { name: SLOTS.actionBar, onSlotchange: this.handleActionBarSlotChange })));
  }
  /**
  ...
  renderHeaderNode() {
    ...
    const showHeader = hasHeaderContent ||
      ...
      closable ||
      hasMenuItems;
    return (h("header", { class: { [CSS.header]: true, [CSS.bottomSeparator]: hasDefaultContent || hasActionBar }, hidden: !showHeader }, this.renderHeaderStartActions(), this.renderHeaderSlottedContent(), headerContentNode, this.renderHeaderActionsEnd()));
  }
  renderFooterNode() {
  ...
  renderContent() {
    return (h("div", { class: CSS.contentWrapper, onScroll: this.panelScrollHandler,
      // eslint-disable-next-line react/jsx-sort-props
      ref: this.setPanelScrollEl }, h("section", { class: CSS.contentContainer }, h("slot", { onSlotchange: this.handleDefaultSlotChange })), this.renderFab()));
  }
  renderFab() {
