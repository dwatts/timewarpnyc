...
const resources$1 = require('./resources-bb06ebc6.js');
const Heading = require('./Heading-93968223.js');
const resources = require('./resources-ae7ab81c.js');
...
const Panel = class {
  constructor(hostRef) {
    ...
    this.handleDefaultSlotChange = (event) => {
      this.hasDefaultContent = dom.slotChangeHasAssignedElement(event);
    };
  ...
  renderActionBar() {
    return (index.h("div", { class: { [resources.CSS.actionBarContainer]: true, [resources.CSS.bottomSeparator]: this.hasDefaultContent }, hidden: !this.hasActionBar }, index.h("slot", { name: resources.SLOTS.actionBar, onSlotchange: this.handleActionBarSlotChange })));
  }
  /**
  ...
  renderHeaderActionsEnd() {
    ...
    const closableNode = closable ? (index.h("calcite-action", { "aria-label": text, "data-test": "close", icon: resources.ICONS.close, onClick: close, text: text,
  ...
  renderHeaderNode() {
    ...
    const showHeader = hasHeaderContent ||
      ...
      closable ||
      hasMenuItems;
    return (index.h("header", { class: { [resources.CSS.header]: true, [resources.CSS.bottomSeparator]: hasDefaultContent || hasActionBar }, hidden: !showHeader }, this.renderHeaderStartActions(), this.renderHeaderSlottedContent(), headerContentNode, this.renderHeaderActionsEnd()));
  }
  renderFooterNode() {
  ...
  renderContent() {
    return (index.h("div", { class: resources.CSS.contentWrapper, onScroll: this.panelScrollHandler,
      // eslint-disable-next-line react/jsx-sort-props
      ref: this.setPanelScrollEl }, index.h("section", { class: resources.CSS.contentContainer }, index.h("slot", { onSlotchange: this.handleDefaultSlotChange })), this.renderFab()));
  }
  renderFab() {
