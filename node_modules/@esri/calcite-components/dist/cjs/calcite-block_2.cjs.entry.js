...
const Block = class {
  ...
  renderIcon() {
    ...
    return loading ? (index.h("div", { class: CSS$1.icon, key: "loader" }, index.h("calcite-loader", { inline: true, label: messages.loading }))) : !!status ? (index.h("div", { class: CSS$1.icon, key: "status-icon" }, index.h("calcite-icon", { class: {
      ...
      }, icon: ICONS$1[status], scale: "m" }))) : hasSlottedIcon ? (index.h("div", { class: CSS$1.icon, key: "icon-slot" }, index.h("slot", { key: "icon-slot", name: SLOTS.icon }))) : null;
  }
  renderTitle() {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("article", { "aria-busy": dom.toAriaBoolean(loading), class: {
      ...
      } }, headerNode, index.h("section", { "aria-expanded": dom.toAriaBoolean(open), "aria-labelledby": buttonId, class: CSS$1.content, hidden: !open, id: regionId }, this.renderScrim()))));
  }
