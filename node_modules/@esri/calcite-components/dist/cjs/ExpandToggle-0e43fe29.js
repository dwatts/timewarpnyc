...
const resources$1 = require('./resources-8b9a4cef.js');
const resources = require('./resources-bb06ebc6.js');
...
const ExpandToggle = ({ expanded, expandText, collapseText, toggle, el, position, tooltip, ref, scale, }) => {
  ...
  const actionNode = (index.h("calcite-action", { icon: expanded ? expandIcon : collapseIcon, onClick: toggle, scale: scale, text: text, textEnabled: expanded, 
