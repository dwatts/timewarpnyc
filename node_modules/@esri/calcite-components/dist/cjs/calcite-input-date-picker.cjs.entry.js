...
const utils = require('./utils-d6910e24.js');
const dom = require('./dom-b7601405.js');
const floatingUi = require('./floating-ui-a0ae9786.js');
...
const openCloseComponent = require('./openCloseComponent-a4424982.js');
...
require('./debounce-20d3c430.js');
require('./observers-e29e2712.js');
...
const InputDatePicker = class {
  constructor(hostRef) {
    ...
    this.setRangeValue = (valueAsDate) => {
      ...
      const newStartDateISO = valueIsArray ? utils.dateToISO(newStartDate) : "";
      const newEndDate = valueIsArray ? valueAsDate[1] : null;
      const newEndDateISO = valueIsArray ? utils.dateToISO(newEndDate) : "";
    ...
    this.setValue = (value) => {
      ...
      const newValue = utils.dateToISO(value);
      if (newValue === oldValue) {
        return;
      }
      this.userChangedValue = true;
  ...
  render() {
    ...
    return (index.h(index.Host, { onBlur: this.deactivate, onKeyDown: this.keyDownHandler }, this.localeData && (index.h("div", { class: "input-container" }, index.h("div", { class: "input-wrapper", onClick: this.onInputWrapperClick,
      ...
      // eslint-disable-next-line react/jsx-sort-props
      ref: this.setEndInput }), this.renderToggleIcon(this.open && this.focusedInput === "end"))))), index.h(form.HiddenFormInputSlot, { component: this })));
  }
