...
const conditionalSlot = require('./conditionalSlot-07ff4561.js');
...
const ExpandToggle = require('./ExpandToggle-0e43fe29.js');
const debounce = require('./debounce-20d3c430.js');
require('./guid-1a635f47.js');
require('./resources-53a07e71.js');
require('./key-e590036d.js');
require('./resources-8b9a4cef.js');
require('./resources-bb06ebc6.js');
...
const ActionBar = class {
  ...
  renderBottomActionGroup() {
    ...
    const expandToggleNode = !expandDisabled ? (index.h(ExpandToggle.ExpandToggle, { collapseText: messages.collapse, el: el, expandText: messages.expand, expanded: expanded, position: position, scale: scale, toggle: toggleExpand, tooltip: tooltip,
