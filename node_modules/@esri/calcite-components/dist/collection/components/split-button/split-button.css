...
:host([appearance=outline-fill]) .split-button__divider-container,
:host([appearance=outline]) .split-button__divider-container {
  border-block: 1px solid var(--calcite-split-button-divider);
}
:host([appearance=outline-fill]):hover .split-button__divider-container,
...
:host([appearance=outline-fill]:focus-within) .split-button__divider-container,
