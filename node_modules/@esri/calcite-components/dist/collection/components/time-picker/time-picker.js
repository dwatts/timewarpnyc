    ...
    return {
      ...
      "messages": {
        ...
        "complexType": {
          ...
          "resolved": "{ hour: string; hourDown: string; hourUp: string; meridiem: string; meridiemDown: string; meridiemUp: string; minute: string; minuteDown: string; minuteUp: string; second: string; secondDown: string; secondUp: string; }",
          "references": {
            "TimePickerMessages": {
              "location": "import",
