...
async function a(t2, a2) {
  const s = [], c = (...o) => {
    for (const l of o)
      null != l && (Array.isArray(l) ? c(...l) : V.isCollection(l) ? l.forEach((o2) => c(o2)) : _.isLoadable(l) && s.push(l));
  };
  a2(c);
  let f = null;
  if (await p(s, async (o) => {
    const n = await _2(i(o) ? o.loadAll() : o.load());
    false !== n.ok || f || (f = n);
  }), f)
    throw f.error;
  return t2;
...
//# sourceMappingURL=chunk-LG2ZH3JE.js.map
