...
var i;
var o = { exports: {} };
o.exports, e = o, o.exports, r = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, "undefined" != typeof __filename && (r = r || __filename), i = function(t2) {
  var n2, e2;
  (t2 = void 0 !== (t2 = t2 || {}) ? t2 : {}).ready = new Promise(function(t3, r2) {
    n2 = t3, e2 = r2;
  });
  var i2, o2, u2, s2, a, c, f = Object.assign({}, t2), p = "object" == typeof window, l = "function" == typeof importScripts, h = "object" == typeof process && "object" == typeof process.versions && "string" == typeof process.versions.node, d = "";
  function m(n3) {
    return t2.locateFile ? t2.locateFile(n3, d) : d + n3;
  }
  h ? (d = l ? require_path().dirname(d) + "/" : __dirname + "/", c = () => {
    a || (s2 = require_fs(), a = require_path());
  }, i2 = function(t3, n3) {
    return c(), t3 = a.normalize(t3), s2.readFileSync(t3, n3 ? void 0 : "utf8");
  }, u2 = (t3) => {
    var n3 = i2(t3, true);
    return n3.buffer || (n3 = new Uint8Array(n3)), n3;
  }, o2 = (t3, n3, e3) => {
    c(), t3 = a.normalize(t3), s2.readFile(t3, function(t4, r2) {
      t4 ? e3(t4) : n3(r2.buffer);
    });
  ...
  }) : (p || l) && (l ? d = self.location.href : "undefined" != typeof document && document.currentScript && (d = document.currentScript.src), r && (d = r), d = 0 !== d.indexOf("blob:") ? d.substr(0, d.replace(/[?#].*/, "").lastIndexOf("/") + 1) : "", i2 = (t3) => {
  ...
  Object.assign(t2, f), f = null, t2.arguments && t2.arguments, t2.thisProgram && t2.thisProgram, t2.quit && t2.quit, t2.wasmBinary && (_ = t2.wasmBinary), t2.noExitRuntime, "object" != typeof WebAssembly && L("no native wasm support detected");
  var v, w, b, A, R, x, S = false, P = "undefined" != typeof TextDecoder ? new TextDecoder("utf8") : void 0;
  function j(t3, n3, e3) {
    for (var r2 = n3 + e3, i3 = n3; t3[i3] && !(i3 >= r2); )
      ++i3;
    ...
    for (var o3 = ""; n3 < i3; ) {
      ...
      if (128 & u3) {
        ...
        if (192 != (224 & u3)) {
          var a2 = 63 & t3[n3++];
          if ((u3 = 224 == (240 & u3) ? (15 & u3) << 12 | s3 << 6 | a2 : (7 & u3) << 18 | s3 << 12 | a2 << 6 | 63 & t3[n3++]) < 65536)
  ...
  function z(n3) {
    if (F--, t2.monitorRunDependencies && t2.monitorRunDependencies(F), 0 == F && B) {
      var e3 = B;
      B = null, e3();
    }
  }
  ...
  function Q() {
    ...
    function r2(n4, e3) {
      var r3 = n4.exports;
      t2.asm = r3, I((y = t2.asm.g).buffer), x = t2.asm.m, q(t2.asm.h), z();
    }
    function i3(t3) {
      r2(t3.instance);
    }
    ...
    function u3() {
      return _ || "function" != typeof WebAssembly.instantiateStreaming || N(G) || Y(G) || h || "function" != typeof fetch ? o3(i3) : fetch(G, { credentials: "same-origin" }).then(function(t3) {
    ...
    if (k(), t2.instantiateWasm)
      try {
        return t2.instantiateWasm(n3, r2);
      } catch (s3) {
  ...
  function tt(t3, n3, e3, r2) {
    L("Assertion failed: " + E(t3) + ", at: " + [n3 ? E(n3) : "unknown filename", e3, r2 ? E(r2) : "unknown function"]);
  }
  function nt(t3) {
    return ft(t3 + 24) + 24;
  }
  ...
  function rt(t3, n3, e3) {
    throw new et(t3).init(n3, e3), t3;
  }
  function it() {
    L("");
  }
  function ot(t3, n3, e3) {
    b.copyWithin(t3, n3, n3 + e3);
  }
  function ut() {
    return 2147483648;
  }
  function st(t3) {
    try {
      return y.grow(t3 - v.byteLength + 65535 >>> 16), I(y.buffer), 1;
    } catch (n3) {
    }
  }
  function at(t3) {
    ...
    if (t3 > e3)
      return false;
    let r2 = (t4, n4) => t4 + (n4 - t4 % n4) % n4;
    for (var i3 = 1; i3 <= 4; i3 *= 2) {
      var o3 = n3 * (1 + 0.2 / i3);
      if (o3 = Math.min(o3, t3 + 100663296), st(Math.min(e3, r2(Math.max(t3, o3), 65536))))
        return true;
    }
    return false;
  }
...
var u = o.exports;
var s = n({ __proto__: null, default: t(u) }, [u]);
export {
  s as l
};
//# sourceMappingURL=lerc-wasm-MVNP2YVB.js.map
