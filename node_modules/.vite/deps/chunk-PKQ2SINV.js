...
var y4 = class extends n3.EventedMixin(m) {
  ...
  constructor(e9) {
    super(e9), this._elevationOffset = 0, this._layerHandes = new t3();
  }
  initialize() {
...
var Fe = Ae = class extends m {
  ...
  _findGraphics3DGraphicByObjectId(e9) {
    return t(this.graphics3DGraphics, (i7) => this._getGraphicObjectID(i7.graphic) === e9);
  }
...
var c7 = class extends m {
  constructor(e9) {
    super(e9), this._dirtyExtents = new l8(), this._globalDirty = false, this._averageExtentUpdateSize = 0, this._dirtyGraphicsSet = /* @__PURE__ */ new Set(), this._handles = new t3(), this._updateElevation = false, this.graphicsCoreOwner = null, this.graphicsCore = null, this.events = new n3();
  }
  initialize() {
...
var _2 = class extends m {
  constructor(e9) {
    super(e9), this.suspended = false, this._extent = null, this._extentIntersectionDirty = true, this._isVisibleBelowSurfaceInternal = false, this._handles = new t3(), this.graphicsCoreOwner = null, this.updating = true;
  }
  initialize() {
...
//# sourceMappingURL=chunk-PKQ2SINV.js.map
