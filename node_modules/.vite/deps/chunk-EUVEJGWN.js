...
async function h2(t, e2, r) {
  const { applyEdits: n2 } = await import("./editingSupport-V4Y55T2Y.js"), o = await t.load();
  return n2(o, o.source, e2, r);
}
async function w(t, e2, r) {
  const { uploadAssets: n2 } = await import("./editingSupport-V4Y55T2Y.js"), o = await t.load();
  return n2(o, o.source, e2, r);
}
...
//# sourceMappingURL=chunk-EUVEJGWN.js.map
