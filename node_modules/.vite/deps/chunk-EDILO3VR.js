...
var n5 = class {
  ...
  async _load(a2, o8, i7) {
    ...
    const n7 = await _2(this._streamDataRequester.request(o8, a2, i7));
    if (true === n7.ok)
      return n7.value;
...
var Y = class _Y {
  ...
  getNodeTransform(e7) {
    ...
    if (!t9) {
      ...
      o8.matrix ? t9 = c(e(), r8, o8.matrix) : o8.translation || o8.rotation || o8.scale ? (t9 = r3(r8), o8.translation && i(t9, t9, o8.translation), o8.rotation && (z[3] = x2(z, o8.rotation), b(t9, t9, z[3], z)), o8.scale && f2(t9, t9, o8.scale)) : t9 = r3(r8), this._nodeTransformCache.set(e7, t9);
    }
    return t9;
  }
  _wrapAccessor(e7, t9) {
  ...
  _checkVersionSupported() {
    const e7 = r2.parse(this.json.asset.version, "glTF");
    J.validate(e7);
  }
...
async function l5(t9, r8, a2 = {}, l6 = true) {
  ...
  await c4(m3, async (t10, r9, s7, i7) => {
    ...
    const g3 = m3.getPositionData(t10, a2), h2 = m3.getMaterial(t10, a2, l6), v = m3.hasNormals(t10) ? m3.getNormalData(t10, a2) : null, w2 = m3.hasTangents(t10) ? m3.getTangentData(t10, a2) : null, R = m3.hasTextureCoordinates(t10) ? m3.getTextureCoordinates(t10, a2) : null, S = m3.hasVertexColors(t10) ? m3.getVertexColors(t10, a2) : null, _3 = m3.getIndexData(t10, a2), E4 = { transform: r3(r9), attributes: { position: await g3, normal: v ? await v : null, texCoord0: R ? await R : null, color: S ? await S : null, tangent: w2 ? await w2 : null }, indices: await _3, primitiveType: f8, material: d2(T, await h2, p3) };
    let I = null;
...
//# sourceMappingURL=chunk-EDILO3VR.js.map
