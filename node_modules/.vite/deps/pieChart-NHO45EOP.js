...
var N = class extends qe {
  ...
  _beforeChanged() {
    super._beforeChanged(), this._display.clear(), this.isDirty("textType") && (this._display.textType = this.get("textType"), this.markDirtyBounds()), this.isDirty("radius") && (this._display.radius = this.get("radius"), this.markDirtyBounds()), this.isDirty("startAngle") && (this._display.startAngle = (this.get("startAngle", 0) + 90) * ie, this.markDirtyBounds()), this.isDirty("inside") && (this._display.inside = this.get("inside"), this.markDirtyBounds()), this.isDirty("orientation") && (this._display.orientation = this.get("orientation"), this.markDirtyBounds()), this.isDirty("kerning") && (this._display.kerning = this.get("kerning"), this.markDirtyBounds());
  }
};
Object.defineProperty(N, "className", { enumerable: true, configurable: true, writable: true, value: "RadialText" }), Object.defineProperty(N, "classNames", { enumerable: true, configurable: true, writable: true, value: qe.classNames.concat([N.className]) });
var C = class extends Qe {
  constructor() {
  ...
  _updateChildren() {
    if (super._updateChildren(), this.isDirty("baseRadius") || this.isPrivateDirty("radius") || this.isPrivateDirty("innerRadius") || this.isDirty("labelAngle") || this.isDirty("radius") || this.isDirty("inside") || this.isDirty("orientation") || this.isDirty("textType")) {
      ...
      let s2 = le(this.get("labelAngle", 0));
      this._text.set("startAngle", this.get("labelAngle", 0)), this._text.set("inside", t2);
      const a = oe(s2), r = he(s2);
      let l3 = this.baseRadius(), n = this.radius();
      if (this._display.angle = 0, "circular" == e)
        ...
        0 == l3 && (s2 = 0, n = 0);
        let t3 = n * r, o = n * a;
        "radial" == e ? (this.setRaw("x", t3), this.setRaw("y", o), s2 < 90 || s2 > 270 || "auto" != i ? (this._display.angle = s2, this._flipped = false) : (this._display.angle = s2 + 180, this._flipped = true), this._dirty.rotation = false) : "adjusted" == e ? (this.setRaw("centerX", G), this.setRaw("centerY", G), this.setRaw("x", t3), this.setRaw("y", o)) : "regular" == e && (this.setRaw("x", t3), this.setRaw("y", o));
      }
  ...
  _updatePosition() {
    ...
    let i = 0, s2 = 0, a = this.get("labelAngle", 0), r = this.localBounds(), l3 = r.right - r.left, n = r.bottom - r.top;
    if ("radial" == e) {
      if (this._flipped) {
        let e2 = this.get("centerX");
        e2 instanceof K && (l3 *= 1 - 2 * e2.value), i = l3 * he(a), s2 = l3 * oe(a);
      }
    } else
      t2 || "adjusted" != e || (i = l3 / 2 * he(a), s2 = n / 2 * oe(a));
...
Object.defineProperty(C, "className", { enumerable: true, configurable: true, writable: true, value: "RadialLabel" }), Object.defineProperty(C, "classNames", { enumerable: true, configurable: true, writable: true, value: Qe.classNames.concat([C.className]) });
var j = Math.abs;
var S = Math.atan2;
var O = Math.cos;
var I = Math.max;
...
function J(e, t2, i, s2, a, r, l3, n) {
  var o = i - e, h = s2 - t2, c = l3 - a, u = n - r, d = u * o - c * h;
  if (!(d * d < X))
    return [e + (d = (c * (t2 - r) - u * (e - a)) / d) * o, t2 + d * h];
}
function Q(e, t2, i, s2, a, r, l3) {
  var n = e - i, o = t2 - s2, h = (l3 ? r : -r) / F(n * n + o * o), c = h * o, u = -h * n, d = e + c, g = t2 + u, p = i + c, y = s2 + u, b = (d + p) / 2, m2 = (g + y) / 2, f = p - d, _ = y - g, x = f * f + _ * _, v = a - r, w = d * y - p * g, k2 = (_ < 0 ? -1 : 1) * F(I(0, v * v * x - w * w)), D2 = (w * _ - f * k2) / x, R = (-w * f - _ * k2) / x, A = (w * _ + f * k2) / x, P = (-w * f + _ * k2) / x, T = D2 - b, L = R - m2, N2 = A - b, C2 = P - m2;
  return T * T + L * L > N2 * N2 + C2 * C2 && (D2 = A, R = P), { cx: D2, cy: R, x01: -c, y01: -u, x11: D2 * (a / v - 1), y11: R * (a / v - 1) };
}
function Z() {
  var e = U3, s2 = q, a = k(0), r = null, l3 = K2, n = E, o = G2, h = null, c = V(u);
  function u() {
    var t2, i, u2 = +e.apply(this, arguments), d = +s2.apply(this, arguments), g = l3.apply(this, arguments) - Y, p = n.apply(this, arguments) - Y, y = j(p - g), b = p > g;
    if (h || (h = t2 = c()), d < u2 && (i = d, d = u2, u2 = i), d > X)
      if (y > V2 - X)
        h.moveTo(d * O(g), d * B2(g)), h.arc(0, 0, d, g, p, !b), u2 > X && (h.moveTo(u2 * O(p), u2 * B2(p)), h.arc(0, 0, u2, p, g, b));
      else {
        ...
        if (A > X) {
          var N2 = W2(A / u2 * B2(R)), C2 = W2(A / d * B2(R));
          (k2 -= 2 * N2) > X ? (v += N2 *= b ? 1 : -1, w -= N2) : (k2 = 0, v = w = (g + p) / 2), (D2 -= 2 * C2) > X ? (_ += C2 *= b ? 1 : -1, x -= C2) : (D2 = 0, _ = x = (g + p) / 2);
        }
        var I2 = d * O(_), U4 = d * B2(_), q2 = u2 * O(w), K3 = u2 * B2(w);
        if (P > X) {
          var E2, G3 = d * O(x), Z2 = d * B2(x), $2 = u2 * O(v), ee2 = u2 * B2(v);
          if (y < H)
            if (E2 = J(I2, U4, $2, ee2, G3, Z2, q2, K3)) {
              var te2 = I2 - E2[0], ie3 = U4 - E2[1], se2 = G3 - E2[0], ae2 = Z2 - E2[1], re = 1 / B2(z2((te2 * se2 + ie3 * ae2) / (F(te2 * te2 + ie3 * ie3) * F(se2 * se2 + ae2 * ae2))) / 2), le2 = F(E2[0] * E2[0] + E2[1] * E2[1]);
              T = M(P, (u2 - le2) / (re - 1)), L = M(P, (d - le2) / (re + 1));
            } else
              T = L = 0;
        }
        D2 > X ? L > X ? (m2 = Q($2, ee2, I2, U4, d, L, b), f = Q(G3, Z2, q2, K3, d, L, b), h.moveTo(m2.cx + m2.x01, m2.cy + m2.y01), L < P ? h.arc(m2.cx, m2.cy, L, S(m2.y01, m2.x01), S(f.y01, f.x01), !b) : (h.arc(m2.cx, m2.cy, L, S(m2.y01, m2.x01), S(m2.y11, m2.x11), !b), h.arc(0, 0, d, S(m2.cy + m2.y11, m2.cx + m2.x11), S(f.cy + f.y11, f.cx + f.x11), !b), h.arc(f.cx, f.cy, L, S(f.y11, f.x11), S(f.y01, f.x01), !b))) : (h.moveTo(I2, U4), h.arc(0, 0, d, _, x, !b)) : h.moveTo(I2, U4), u2 > X && k2 > X ? T > X ? (m2 = Q(q2, K3, G3, Z2, u2, -T, b), f = Q(I2, U4, $2, ee2, u2, -T, b), h.lineTo(m2.cx + m2.x01, m2.cy + m2.y01), T < P ? h.arc(m2.cx, m2.cy, T, S(m2.y01, m2.x01), S(f.y01, f.x01), !b) : (h.arc(m2.cx, m2.cy, T, S(m2.y01, m2.x01), S(m2.y11, m2.x11), !b), h.arc(0, 0, u2, S(m2.cy + m2.y11, m2.cx + m2.x11), S(f.cy + f.y11, f.cx + f.x11), b), h.arc(f.cx, f.cy, T, S(f.y11, f.x11), S(f.y01, f.x01), !b))) : h.arc(0, 0, u2, w, v, b) : h.lineTo(q2, K3);
      }
    else
      h.moveTo(0, 0);
    if (h.closePath(), t2)
  ...
  return u.centroid = function() {
    var t2 = (+e.apply(this, arguments) + +s2.apply(this, arguments)) / 2, i = (+l3.apply(this, arguments) + +n.apply(this, arguments)) / 2 - H / 2;
    return [O(i) * t2, B2(i) * t2];
    ...
    return arguments.length ? (l3 = "function" == typeof e2 ? e2 : k(+e2), u) : l3;
...
var $ = class extends Re {
  ...
  _getTooltipPoint() {
    ...
    return a += this.get("dRadius", 0), r += this.get("dInnerRadius", 0), r < 0 && (r = a + r), e instanceof K && (i = this.ix * (r + (a - r) * e.value)), t2 instanceof K && (s2 = this.iy * (r + (a - r) * t2.value)), this.get("arc") >= 360 && 0 == r && (i = 0, s2 = 0), { x: i, y: s2 };
  }
  _beforeChanged() {
  ...
  _changed() {
    if (super._changed(), this._clear) {
      ...
      s2 += this.get("dRadius", 0), a += this.get("dInnerRadius", 0), a < 0 && (a = s2 + a), i({ innerRadius: a, outerRadius: s2, startAngle: (e + 90) * ie, endAngle: (e + t2 + 90) * ie });
      let r = e + t2 / 2;
      this.ix = he(r), this.iy = oe(r);
    }
...
Object.defineProperty(te, "className", { enumerable: true, configurable: true, writable: true, value: "PercentChart" }), Object.defineProperty(te, "classNames", { enumerable: true, configurable: true, writable: true, value: U2.classNames.concat([te.className]) });
var ie2 = class extends D {
  constructor() {
    super(...arguments), Object.defineProperty(this, "slicesContainer", { enumerable: true, configurable: true, writable: true, value: this.children.push(Je.new(this._root, { position: "absolute", isMeasured: false })) }), Object.defineProperty(this, "labelsContainer", { enumerable: true, configurable: true, writable: true, value: this.children.push(Je.new(this._root, { position: "absolute", isMeasured: false })) }), Object.defineProperty(this, "ticksContainer", { enumerable: true, configurable: true, writable: true, value: this.children.push(Je.new(this._root, { position: "absolute", isMeasured: false })) }), Object.defineProperty(this, "_lLabels", { enumerable: true, configurable: true, writable: true, value: [] }), Object.defineProperty(this, "_rLabels", { enumerable: true, configurable: true, writable: true, value: [] }), Object.defineProperty(this, "_hLabels", { enumerable: true, configurable: true, writable: true, value: [] }), Object.defineProperty(this, "slices", { enumerable: true, configurable: true, writable: true, value: this._makeSlices() }), Object.defineProperty(this, "labels", { enumerable: true, configurable: true, writable: true, value: this._makeLabels() }), Object.defineProperty(this, "ticks", { enumerable: true, configurable: true, writable: true, value: this._makeTicks() });
  }
  makeSlice(e) {
  ...
  _prepareChildren() {
    if (super._prepareChildren(), this._lLabels = [], this._rLabels = [], this._hLabels = [], this._valuesDirty) {
      ...
      m(this._dataItems, (i2) => {
        ...
        r > i && (i = r), r < s2 && (s2 = r), a++;
        let l3 = r / t2;
        0 == t2 && (l3 = 0), e2.setRaw("valuePercentTotal", 100 * l3);
  ...
  show(t2) {
    ...
    return t(this, void 0, void 0, function* () {
      let e = [];
      e.push(i.show.call(this, t2)), e.push(this._sequencedShowHide(true, t2)), yield Promise.all(e);
    });
  }
  hide(t2) {
    ...
    return t(this, void 0, void 0, function* () {
      let e = [];
      e.push(i.hide.call(this, t2)), e.push(this._sequencedShowHide(false, t2)), yield Promise.all(e);
    });
  }
  _updateChildren() {
  ...
  showDataItem(t2, i) {
    ...
    return t(this, void 0, void 0, function* () {
      const e = [s2.showDataItem.call(this, t2, i)];
      l(i) || (i = this.get("stateAnimationDuration", 0));
      const a = this.get("stateAnimationEasing");
      let r = t2.get("value");
      const l3 = t2.animate({ key: "valueWorking", to: r, duration: i, easing: a });
      l3 && e.push(l3.waitForStop());
      const n = t2.get("tick");
      n && e.push(n.show(i));
      const o = t2.get("label");
      o && e.push(o.show(i));
      const h = t2.get("slice");
  ...
  hideDataItem(t2, i) {
    ...
    return t(this, void 0, void 0, function* () {
      const e = [s2.hideDataItem.call(this, t2, i)], a = this.states.create("hidden", {});
      l(i) || (i = a.get("stateAnimationDuration", this.get("stateAnimationDuration", 0)));
      const r = a.get("stateAnimationEasing", this.get("stateAnimationEasing")), l3 = t2.animate({ key: "valueWorking", to: 0, duration: i, easing: r });
      l3 && e.push(l3.waitForStop());
      const n = t2.get("tick");
      n && e.push(n.hide(i));
      const o = t2.get("label");
...
Object.defineProperty(ie2, "className", { enumerable: true, configurable: true, writable: true, value: "PercentSeries" }), Object.defineProperty(ie2, "classNames", { enumerable: true, configurable: true, writable: true, value: D.classNames.concat([ie2.className]) });
var se = class extends te {
  ...
  _afterNew() {
    super._afterNew(), this.seriesContainer.setAll({ x: G, y: G });
  }
  _prepareChildren() {
    ...
    let l3 = de(0, 0, s2, a, 1);
    const n = t2 / (l3.right - l3.left), o = i / (l3.bottom - l3.top);
    let c = { left: 0, right: 0, top: 0, bottom: 0 };
    if (r instanceof K) {
      let e2 = r.value, l4 = Math.min(n, o);
      e2 = Math.max(l4 * e2, l4 - Math.min(i, t2)) / l4, c = de(0, 0, s2, a, e2), this.setPrivateRaw("irModifyer", e2 / r.value);
    }
    l3 = pe([l3, c]);
    const u = this._maxRadius;
    this._maxRadius = Math.min(n, o);
    const d = mt(this.get("radius", 0), this._maxRadius);
    this.seriesContainer.setAll({ dy: -d * (l3.bottom + l3.top) / 2, dx: -d * (l3.right + l3.left) / 2 }), (this.isDirty("startAngle") || this.isDirty("endAngle") || u != this._maxRadius) && this.series.each((e2) => {
  ...
  radius(e) {
    let t2 = mt(this.get("radius", 0), this._maxRadius), i = mt(this.get("innerRadius", 0), t2);
    if (e) {
      let s2 = this.series.indexOf(e), a = this.series.length, r = e.get("radius");
      return null != r ? i + mt(r, t2 - i) : i + (t2 - i) / a * (s2 + 1);
    }
    return t2;
  }
  innerRadius(e) {
    const t2 = this.radius();
    let i = mt(this.get("innerRadius", 0), t2);
    if (i < 0 && (i = t2 + i), e) {
      let s2 = this.series.indexOf(e), a = this.series.length, r = e.get("innerRadius");
      return null != r ? i + mt(r, t2 - i) : i + (t2 - i) / a * s2;
    }
    return i;
  }
};
...
var ae = class extends ie2 {
  _makeSlices() {
    return new W(Me.new({}), () => $._new(this._root, { themeTags: Kt(this.slices.template.get("themeTags", []), ["pie", "series"]) }, [this.slices.template]));
  }
  _makeLabels() {
    return new W(Me.new({}), () => C._new(this._root, { themeTags: Kt(this.labels.template.get("themeTags", []), ["pie", "series"]) }, [this.labels.template]));
  }
  _makeTicks() {
    return new W(Me.new({}), () => B._new(this._root, { themeTags: Kt(this.ticks.template.get("themeTags", []), ["pie", "series"]) }, [this.ticks.template]));
  }
  processDataItem(e) {
    ...
    if (e) {
      ...
      if (this._valuesDirty || this.isDirty("radius") || this.isDirty("innerRadius") || this.isDirty("startAngle") || this.isDirty("endAngle") || this.isDirty("alignLabels")) {
        ...
        r < 0 && (r = a + r), m(this._dataItems, (e2) => {
          ...
          const l3 = e2.get("slice");
          if (l3) {
            l3.set("radius", a), l3.set("innerRadius", r), l3.set("startAngle", s2), l3.set("arc", t3);
            const i2 = e2.get("fill");
            l3._setDefault("fill", i2), l3._setDefault("stroke", i2);
          }
          let n = le(s2 + t3 / 2);
          const o = e2.get("label");
          if (o && (o.setPrivate("radius", a), o.setPrivate("innerRadius", r), o.set("labelAngle", n), "aligned" == o.get("textType"))) {
            let e3 = a + o.get("radius", 0), t4 = a * oe(n);
            n > 90 && n <= 270 ? (o.isHidden() || o.isHiding() || this._lLabels.push({ label: o, y: t4 }), e3 *= -1, e3 -= this.labelsContainer.get("paddingLeft", 0), o.set("centerX", z), o.setPrivateRaw("left", true)) : (o.isHidden() || o.isHiding() || this._rLabels.push({ label: o, y: t4 }), e3 += this.labelsContainer.get("paddingRight", 0), o.set("centerX", 0), o.setPrivateRaw("left", false)), o.set("x", e3), o.set("y", a * oe(n));
          }
  ...
  _updateTick(e) {
    ...
    if (t2 && i && s2) {
      const e2 = (s2.get("shiftRadius", 0) + s2.get("radius", 0)) * s2.get("scale", 1) * a, r = i.get("labelAngle", 0), l3 = he(r), n = oe(r), o = this.labelsContainer, h = o.get("paddingLeft", 0), c = o.get("paddingRight", 0);
      let g = 0, p = 0;
      if (g = i.x(), p = i.y(), "circular" == i.get("textType")) {
        const e3 = i.radius() - i.get("paddingBottom", 0), t3 = i.get("labelAngle", 0);
        g = e3 * he(t3), p = e3 * oe(t3);
      }
      let y = -c;
      i.getPrivate("left") && (y = h), t2.set("points", [{ x: s2.x() + e2 * l3, y: s2.y() + e2 * n }, { x: g + y, y: p }, { x: g, y: p }]);
    }
  }
  _positionBullet(e) {
    ...
    if (t2) {
      ...
      if (i) {
        const s2 = i.get("innerRadius", 0), a = i.get("radius", 0), r = i.get("startAngle", 0) + i.get("arc", 0) * e.get("locationX", 0.5), l3 = s2 + (a - s2) * e.get("locationY", 0.5);
        t2.setAll({ x: he(r) * l3, y: oe(r) * l3 });
      }
    }
  }
};
Object.defineProperty(ae, "className", { enumerable: true, configurable: true, writable: true, value: "PieSeries" }), Object.defineProperty(ae, "classNames", { enumerable: true, configurable: true, writable: true, value: ie2.classNames.concat([ae.className]) });
export {
  se as PieChartAm5,
  ae as PieSeriesAm5
};
//# sourceMappingURL=pieChart-NHO45EOP.js.map
