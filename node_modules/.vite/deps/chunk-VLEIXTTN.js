...
import {
  oe
} from "./chunk-LED4NUY5.js";
import {
  n as n7
} from "./chunk-7CYULSA3.js";
import {
  n as n6,
  s as s3
      ...
      case "parameter": {
        ...
        if (s6 instanceof Array) {
          ...
          for (let a6 = 0; a6 < s6.length; a6++)
            "string" == typeof s6[a6] ? e4.push("'" + s6[a6].toString().replaceAll("'", "''") + "'") : s6[a6] instanceof Date ? e4.push(T3(s6[a6], r3, null)) : s6[a6] instanceof c ? e4.push(h(s6[a6], r3, null)) : e4.push(s6[a6].toString());
          return e4;
        }
        return s6.toString();
      }
...
var D = class extends v {
  ...
  async _getFeatures(t5, s6, a6, i2) {
    ...
    for (const o4 of c5) {
      ...
      this._featureCache[o4.id] = new h2({ attributes: t6, geometry: c2(o4.geometry) });
    }
    return "success";
  }
...
var C = class _C extends v {
  ...
  async _getPhysicalPage(t5, i2, s6) {
    ...
    for (const r3 of n8) {
      ...
      this._featureCache[t6.attributes[this.objectIdField]] = new h2(t6);
    }
    return n8.length;
  }
  ...
  _calculateAndAppendAggregateItem(t5) {
    ...
    return this._featureCache[i2.attributes[this.objectIdField]] = new h2({ attributes: i2.attributes, geometry: i2.geometry }), i2;
  }
...
async function m4(t5, r3, e3, n8) {
  ...
  const { meshFeatureSetFromJSON: a6 } = await p(import("./meshFeatureSet-2Y6DHCA6.js"), n8);
  return a6(t5, s6, r3);
}
function p5(o4, s6) {
  let a6 = b.from(o4);
...
var C2 = class _C extends v {
  ...
  async _getAgregagtePhysicalPage(t5, i2, r3) {
    ...
    for (let c5 = 0; c5 < u4.features.length; c5++)
      d5.push(new h2({ attributes: u4.features[c5].attributes, geometry: null }));
      ...
      if (i3 && i3.relatedRecordGroups) {
        ...
        for (const s7 of i3.relatedRecordGroups) {
          ...
          for (const t6 of s7.relatedRecords) {
            ...
            const i4 = new h2({ geometry: t6.geometry ? p3(t6.geometry) : null, attributes: t6.attributes });
            n8.push(i4);
          }
...
var f6 = class _f extends v {
  ...
  _changeFeature(t5) {
    ...
    return new h2({ geometry: true === this._removeGeometry ? null : t5.geometry, attributes: r3 });
  }
  async _getFilteredSet(e3, t5, r3, s6, a6) {
    let l2 = "", u4 = false;
...
async function q(e3, t5, a6, r3, n8, i2, s6, l2 = null) {
  if (a2.applicationCache) {
    ...
    if (o5) {
      const e4 = await o5;
      return g3(new Be({ url: x(e4.url) + "/" + t5, outFields: ["*"] }), a6, r3, n8, s6, l2);
    }
  }
  const o4 = new x2({ id: e3, portal: i2 }).load();
...
//# sourceMappingURL=chunk-VLEIXTTN.js.map
