...
var i3 = class {
  ...
  registerOutgoing(e4) {
    ...
    const t2 = new a3(e4, { onEmit: (e5, t3, n2, i5) => {
      var _a;
      (_a = this._manager) == null ? void 0 : _a.emit(e5.eventType, t3, n2, i5);
    }, onRemove: (e5) => {
      var _a;
...
var s3 = class extends i3 {
  ...
  _update(t2) {
    const s4 = "touch" === t2.native.pointerType ? "touch" : "mouse", { x: e4, y: i5 } = t2;
...
var d = class extends m {
  ...
  installHandlers(e4, t2, i5 = _.INTERNAL) {
    ...
    const n2 = { name: e4, handlers: t2.map((e5) => ({ handler: e5, active: true, removed: false, priorityIndex: 0, groupPriority: i5, eventCallback: null, uninstallCallback: null })) };
    ...
    for (let r2 = n2.handlers.length - 1; r2 >= 0; r2--) {
      ...
      this._handlers.push(e5), e5.handler.onInstall({ updateDependencies: () => {
        ...
        this._emitInputEvent(e5.priorityIndex + 1, t3, r3, i6, s4, n3);
  ...
  updateDependencies() {
    ...
    for (let r2 = this._handlersPriority.length - 1; r2 >= 0; r2--) {
      ...
      if (!n2) {
        for (const t3 of i5.handler.outgoingEventTypes)
          if (e4.has(t3)) {
            n2 = true;
            break;
          }
  ...
  _onEventReceived(e4, t2) {
    ...
    const r2 = null != this.test.timestamp ? this.test.timestamp : t2.native ? t2.native.timestamp : void 0, i5 = t2.native ? t2.native.cancelable : void 0;
    this._emitInputEventFromSource(e4, t2, r2, i5);
  }
  _updateKeyModifiers(e4, t2) {
    ...
    const i5 = () => {
      ...
      t3 && !this._activeKeyModifiers.has(e5) ? (i5(), this._activeKeyModifiers.add(e5)) : !t3 && this._activeKeyModifiers.has(e5) && (i5(), this._activeKeyModifiers.delete(e5));
    };
  ...
  _installRecognizers() {
    this._latestPointerHandler = new s3((e4, t2, r2) => this._setLatestPointer(e4, t2, r2)), this._multiTouchHandler = new i4(), this.installHandlers("input-manager-logic", [this._latestPointerHandler, this._multiTouchHandler], _.ALWAYS), this.recognizers.length > 0 && this.installHandlers("default", this.recognizers, _.INTERNAL);
  }
  _setPointerCapture(e4, t2, r2, i5) {
    const n2 = e4.name + "-" + t2.priorityIndex, s4 = this._pointerCaptures.get(r2.pointerId) || /* @__PURE__ */ new Set();
  ...
  _emitInputEventFromSource(e4, t2, r2, i5) {
    this._emitInputEvent(0, e4, t2, r2, i5);
  }
  _emitInputEvent(e4, t2, r2, i5, n2, s4) {
    const o3 = void 0 !== i5 ? i5 : this._currentPropagation ? this._currentPropagation.timestamp : performance.now(), a4 = void 0 !== n2 && n2, p = { event: new u(t2, r2, o3, s4 || this._activeKeyModifiers, a4), priorityIndex: e4 };
  ...
  _continuePropagation() {
    ...
    if (e4) {
      for (; e4.events.length > 0; ) {
        const { event: t2, priorityIndex: r2 } = e4.events.pop(), i5 = t2.data && t2.data.eventId;
        if (!(null != i5 && this._stoppedPropagationEventIds.has(i5)))
          for (e4.currentHandler = this._handlersPriority[r2]; e4.currentHandler; ) {
            if (e4.currentHandler.removed)
              ...
              if (e4.currentHandler.active && !t2.shouldStopPropagation() && ((_b = (_a = e4.currentHandler).eventCallback) == null ? void 0 : _b.call(_a, t2)), t2.shouldStopPropagation()) {
...
var u = class {
  constructor(e4, t2, r2, i5, n2) {
    this.type = e4, this.data = t2, this.timestamp = r2, this.modifiers = i5, this.cancelable = n2, this._propagationState = c.NONE, this._resumeCallback = null;
  }
  stopPropagation() {
...
//# sourceMappingURL=chunk-A47VN5MA.js.map
