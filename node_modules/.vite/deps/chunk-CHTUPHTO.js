...
function f(r2, i2, s8, u4, l2, a6) {
  ...
  if ((null === f3 && !l2.allowNull && !l2.writerEnsuresNonNull || void 0 === f3) && l2.isRequired) {
    ...
    return i3 && a6 && a6.messages ? a6.messages.push(i3) : i3 && !a6 && s2.getLogger("esri.core.accessorSupport.write").error(i3.name, i3.message), false;
  }
  if (void 0 === f3)
    return false;
...
function s7(e4, r2, o3) {
  ...
  if ("string" == typeof n3) {
    if (n3 === r2)
      return true;
    if (n3.includes(".") && 0 === n3.indexOf(r2) && s3(n3, o3))
      return true;
  } else
    for (const s8 of n3) {
      if (s8 === r2)
        return true;
      if (s8.includes(".") && 0 === s8.indexOf(r2) && s3(s8, o3))
        return true;
    }
  return false;
}
...
//# sourceMappingURL=chunk-CHTUPHTO.js.map
