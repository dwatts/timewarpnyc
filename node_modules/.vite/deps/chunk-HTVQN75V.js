...
function l(t) {
  for (const e of d.keys())
    m(t.pattern, e) && d.delete(e);
}
function u(t) {
  return c2.includes(t) || (l(t), c2.unshift(t)), { remove() {
    const e = c2.indexOf(t);
    e > -1 && (c2.splice(e, 1), l(t));
  } };
}
async function h(t) {
  const e = c();
  d.has(t) || d.set(t, _(t, e));
  const n = d.get(t);
...
var p = new class {
  ...
  _increase() {
    this._numLoading++, this._dfd || (this._dfd = C());
  }
  _decrease() {
...
//# sourceMappingURL=chunk-HTVQN75V.js.map
