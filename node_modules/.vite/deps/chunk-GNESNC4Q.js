...
var c = a2 = class extends l {
  ...
  clone() {
    ...
    return new a2({ mapLayerId: r, gdbVersion: o5 });
  }
};
e([o4({ mapLayer: "map-layer" })], c.prototype, "type", void 0), e([y({ type: T, json: { write: true } })], c.prototype, "mapLayerId", void 0), e([y({ type: String, json: { write: true } })], c.prototype, "gdbVersion", void 0), c = a2 = e([a("esri.layers.support.source.MapLayerSource")], c);
...
e([o4({ queryTable: "query-table" })], a3.prototype, "type", void 0), e([y({ type: String, json: { write: true } })], a3.prototype, "workspaceId", void 0), e([y({ type: String, json: { write: true } })], a3.prototype, "query", void 0), e([y({ type: String, json: { write: true } })], a3.prototype, "oidFields", void 0), e([y({ type: f, json: { write: true } })], a3.prototype, "spatialReference", void 0), e([o4(o3)], a3.prototype, "geometryType", void 0), a3 = c2 = e([a("esri.layers.support.source.QueryTableDataSource")], a3);
...
e([o4({ raster: "raster" })], a4.prototype, "type", void 0), e([y({ type: String, json: { write: true } })], a4.prototype, "dataSourceName", void 0), e([y({ type: String, json: { write: true } })], a4.prototype, "workspaceId", void 0), a4 = p = e([a("esri.layers.support.source.RasterDataSource")], a4);
...
e([o4({ table: "table" })], a5.prototype, "type", void 0), e([y({ type: String, json: { write: true } })], a5.prototype, "workspaceId", void 0), e([y({ type: String, json: { write: true } })], a5.prototype, "gdbVersion", void 0), e([y({ type: String, json: { write: true } })], a5.prototype, "dataSourceName", void 0), a5 = p2 = e([a("esri.layers.support.source.TableDataSource")], a5);

// node_modules/@arcgis/core/layers/support/source/DataLayerSource.js
var d2;
var m;
var T2 = o2()({ esriLeftInnerJoin: "left-inner-join", esriLeftOuterJoin: "left-outer-join" });
var j = d2 = class extends l {
  constructor(e2) {
  ...
  clone() {
    const { leftTableKey: e2, rightTableKey: r, leftTableSource: o5, rightTableSource: t, joinType: a6 } = this, s2 = { leftTableKey: e2, rightTableKey: r, leftTableSource: (o5 == null ? void 0 : o5.clone()) ?? void 0, rightTableSource: (t == null ? void 0 : t.clone()) ?? void 0, joinType: a6 };
    return new d2(s2);
  }
};
...
e([o4({ dataLayer: "data-layer" })], K.prototype, "type", void 0), e([y({ type: [y2], json: { write: true } })], K.prototype, "fields", void 0), e([y({ types: w, json: { write: true } })], K.prototype, "dataSource", void 0), K = m = e([a("esri.layers.support.source.DataLayerSource")], K), K.from = d(K);

export {
  c,
  K
};
//# sourceMappingURL=chunk-GNESNC4Q.js.map
