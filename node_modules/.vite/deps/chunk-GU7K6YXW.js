...
e([y({ type: String, json: { write: { writerEnsuresNonNull: true } } })], n.prototype, "expression", void 0), e([o("expression", ["expression", "value"])], n.prototype, "readExpression", null), e([r("expression")], n.prototype, "writeExpression", null), e([y({ type: String, json: { write: true, origins: { "web-scene": { write: false } } } })], n.prototype, "title", void 0), e([y({ json: { read: false, write: false } })], n.prototype, "value", void 0), n = l2 = e([a2("esri.layers.support.LabelExpressionInfo")], n);
var a4 = n;
...
function x2(e2, r2, t) {
  return { enabled: !o2(t == null ? void 0 : t.layer) };
}
function L(e2) {
  var _a;
...
var A = h = class extends l {
  static evaluateWhere(e2, r2) {
    ...
    try {
      ...
      const o4 = e2.split(" ");
      if (3 === o4.length)
        return t(r2[o4[0]], o4[1], o4[2]);
      if (7 === o4.length) {
        const e3 = t(r2[o4[0]], o4[1], o4[2]), i2 = o4[3], n2 = t(r2[o4[4]], o4[5], o4[6]);
        switch (i2) {
          case "AND":
            return e3 && n2;
          case "OR":
  ...
  writeLabelExpressionInfo(e2, r2, t, o4) {
...
//# sourceMappingURL=chunk-GU7K6YXW.js.map
