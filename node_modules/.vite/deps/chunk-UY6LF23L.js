...
function D2(e8) {
  const n9 = e8.labelClass.labelPlacement, { labelSymbol: r4, graphics3DGraphic: l3 } = e8, a3 = i4(l3.graphics3DSymbol), c5 = n2(a3, (e9) => "point-3d" === e9.symbol.type ? e9.symbol : null), o5 = C2[n9] || v(e8);
...
var b2 = class extends m {
  ...
  runTask(e8, t5 = true) {
    if (null == this._glTexture)
      return g.YIELD;
    let s7 = false;
    if (n(this._elementsToAddOrUpdate, (r4, i6) => {
    ...
    let i5 = false;
    this._elementsToRender.size > 0 && this._needsClear && (this._ctx.clearRect(0, 0, this._canvas.width, this._canvas.height), this._needsClear = false), n(this._elementsToRender, (t6, s8) => (this._processRenderingRequest(t6), this._elementsToRender.delete(s8), i5 = true, e8.madeProgress(), e8.done)), i5 && this._glTexture.setData(this._canvas), this.updating = this._elementsToRender.size > 0, !this.updating && e7.orderedRepackingEnabled && (this.repackOrdered(), e8.madeProgress());
  }
    ...
    if (this._dirty) {
      ...
      for (const t5 of this._labelingContexts)
        if (t5.active) {
          ...
          n(t5.labelsToInitialize, (s7, l3) => (this._ensureGraphics3DResources(s7) && (this._labels.set(l3, s7), this.deconflictor.setDirty(), e8.madeProgress()), (s7.visible && s7.textInitialized || !s7.visible && s7.hasGraphics3DResources) && (t5.labelsToInitialize.delete(l3), e8.madeProgress()), e8.done)) && (this._dirty = true);
        }
...
//# sourceMappingURL=chunk-UY6LF23L.js.map
