    ...
    if ("string" != typeof n2 && !Array.isArray(n2)) {
      for (const r3 in n2)
        if ("default" !== r3 && !(r3 in e)) {
          const t4 = Object.getOwnPropertyDescriptor(n2, r3);
          t4 && Object.defineProperty(e, r3, t4.get ? t4 : { enumerable: true, get: () => n2[r3] });
        }
    }
  }
...
var o;
var a = { exports: {} };
a.exports, t2 = a, a.exports, n = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, o = function(e) {
  var r2, t3, o2 = void 0 !== (e = e || {}) ? e : {};
  ...
  "undefined" != typeof document && document.currentScript && (l = document.currentScript.src), n && (l = n), l = 0 !== l.indexOf("blob:") ? l.substr(0, l.replace(/[?#].*/, "").lastIndexOf("/") + 1) : "", a2 = (e2) => {
    ...
    n2.open("GET", e2, true), n2.responseType = "arraybuffer", n2.onload = () => {
      200 == n2.status || 0 == n2.status && n2.response ? r3(n2.response) : t4();
  ...
  function C(e2, r3, t4) {
    for (var n2 = r3 + t4, o3 = r3; e2[o3] && !(o3 >= n2); )
      ++o3;
  ...
  function j(e2, r3, t4, n2) {
    if (!(n2 > 0))
      return 0;
    for (var o3 = t4, a3 = t4 + n2 - 1, i3 = 0; i3 < e2.length; ++i3) {
      ...
      if (s3 >= 55296 && s3 <= 57343 && (s3 = 65536 + ((1023 & s3) << 10) | 1023 & e2.charCodeAt(++i3)), s3 <= 127) {
        ...
        if (t4 + 1 >= a3)
          break;
        r3[t4++] = 192 | s3 >> 6, r3[t4++] = 128 | 63 & s3;
      } else if (s3 <= 65535) {
        if (t4 + 2 >= a3)
          break;
        r3[t4++] = 224 | s3 >> 12, r3[t4++] = 128 | s3 >> 6 & 63, r3[t4++] = 128 | 63 & s3;
      } else {
        if (t4 + 3 >= a3)
          break;
        r3[t4++] = 240 | s3 >> 18, r3[t4++] = 128 | s3 >> 12 & 63, r3[t4++] = 128 | s3 >> 6 & 63, r3[t4++] = 128 | 63 & s3;
      }
    }
    return r3[t4] = 0, t4 - o3;
  }
  function B(e2, r3, t4) {
    return j(e2, E, r3, t4);
  }
  function M(e2) {
    for (var r3 = 0, t4 = 0; t4 < e2.length; ++t4) {
      var n2 = e2.charCodeAt(t4);
      n2 >= 55296 && n2 <= 57343 && (n2 = 65536 + ((1023 & n2) << 10) | 1023 & e2.charCodeAt(++t4)), n2 <= 127 ? ++r3 : r3 += n2 <= 2047 ? 2 : n2 <= 65535 ? 3 : 4;
    }
    return r3;
  }
  function L(e2) {
  ...
  function oe() {
    ...
    function r3(e3, r4) {
      var t4 = e3.exports;
      o2.asm = t4, L((p = o2.asm.Za).buffer), A = o2.asm.$a, H(o2.asm._a), X();
    }
    function n2(e3) {
      r3(e3.instance);
    }
  ...
  function se(e2, r3, t4, n2) {
    Q("Assertion failed: " + T(e2) + ", at: " + [r3 ? T(r3) : "unknown filename", t4, n2 ? T(n2) : "unknown function"]);
  }
  function ue(e2) {
    return vo(e2 + 24) + 24;
  }
  ...
  function fe(e2, r3, t4) {
    throw new ce(e2).init(r3, t4), e2;
  }
  function le(e2) {
    return x[yo() >> 2] = e2, e2;
  }
  ...
  var de = { isAbs: (e2) => "/" === e2.charAt(0), splitPath: (e2) => /^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/.exec(e2).slice(1), normalizeArray: (e2, r3) => {
    for (var t4 = 0, n2 = e2.length - 1; n2 >= 0; n2--) {
      var o3 = e2[n2];
      "." === o3 ? e2.splice(n2, 1) : ".." === o3 ? (e2.splice(n2, 1), t4++) : t4 && (e2.splice(n2, 1), t4--);
    }
    if (r3)
      for (; t4; t4--)
        e2.unshift("..");
    ...
    var r3 = de.isAbs(e2), t4 = "/" === e2.substr(-1);
    return (e2 = de.normalizeArray(e2.split("/").filter((e3) => !!e3), !r3).join("/")) || r3 || (e2 = "."), e2 && t4 && (e2 += "/"), (r3 ? "/" : "") + e2;
  }, dirname: (e2) => {
    var r3 = de.splitPath(e2), t4 = r3[0], n2 = r3[1];
    return t4 || n2 ? (n2 && (n2 = n2.substr(0, n2.length - 1)), t4 + n2) : ".";
  }, basename: (e2) => {
    if ("/" === e2)
      return "/";
  ...
  var pe = { resolve: function() {
    for (var e2 = "", r3 = false, t4 = arguments.length - 1; t4 >= -1 && !r3; t4--) {
      var n2 = t4 >= 0 ? arguments[t4] : we.cwd();
      if ("string" != typeof n2)
    ...
    function t4(e3) {
      for (var r4 = 0; r4 < e3.length && "" === e3[r4]; r4++)
        ;
      for (var t5 = e3.length - 1; t5 >= 0 && "" === e3[t5]; t5--)
        ;
      return r4 > t5 ? [] : e3.slice(r4, t5 - r4 + 1);
    }
    e2 = pe.resolve(e2).substr(1), r3 = pe.resolve(r3).substr(1);
    for (var n2 = t4(e2.split("/")), o3 = t4(r3.split("/")), a3 = Math.min(n2.length, o3.length), i3 = a3, s3 = 0; s3 < a3; s3++)
      if (n2[s3] !== o3[s3]) {
        i3 = s3;
        break;
      }
  ...
  function he(e2, r3, t4) {
    var n2 = t4 > 0 ? t4 : M(e2) + 1, o3 = new Array(n2), a3 = j(e2, o3, 0, o3.length);
  ...
  }, write: function(e2, r3, t4, n2, o3) {
    if (!e2.tty || !e2.tty.ops.put_char)
      throw new we.ErrnoError(60);
    try {
      for (var a3 = 0; a3 < n2; a3++)
        e2.tty.ops.put_char(e2.tty, r3[t4 + a3]);
    } catch (i3) {
      throw new we.ErrnoError(29);
    }
  ...
  var ge = { ops_table: null, mount: function(e2) {
  ...
  }, createNode: function(e2, r3, t4, n2) {
    if (we.isBlkdev(t4) || we.isFIFO(t4))
    ...
    var o3 = we.createNode(e2, r3, t4, n2);
    ...
    var t4 = e2.contents ? e2.contents.length : 0;
    if (!(t4 >= r3)) {
      var n2 = 1048576;
      r3 = Math.max(r3, t4 * (t4 < n2 ? 2 : 1.125) >>> 0), 0 != t4 && (r3 = Math.max(r3, 256));
      var o3 = e2.contents;
    ...
    if (e2.usedBytes != r3)
      if (0 == r3)
        ...
        var t4 = e2.contents;
        e2.contents = new Uint8Array(r3), t4 && e2.contents.set(t4.subarray(0, Math.min(r3, e2.usedBytes))), e2.usedBytes = r3;
      }
  ...
  }, mknod: function(e2, r3, t4, n2) {
    return ge.createNode(e2, r3, t4, n2);
  }, rename: function(e2, r3, t4) {
    if (we.isDir(e2.mode)) {
      var n2;
      try {
        n2 = we.lookupNode(r3, t4);
      } catch (a3) {
      }
      if (n2)
    ...
    delete e2.parent.contents[e2.name], e2.parent.timestamp = Date.now(), e2.name = t4, r3.contents[t4] = e2, r3.timestamp = e2.parent.timestamp, e2.parent = r3;
  }, unlink: function(e2, r3) {
    delete e2.contents[r3], e2.timestamp = Date.now();
  }, rmdir: function(e2, r3) {
    var t4 = we.lookupNode(e2, r3);
    for (var n2 in t4.contents)
      throw new we.ErrnoError(55);
    delete e2.contents[r3], e2.timestamp = Date.now();
  }, readdir: function(e2) {
    var r3 = [".", ".."];
    for (var t4 in e2.contents)
      e2.contents.hasOwnProperty(t4) && r3.push(t4);
    return r3;
  }, symlink: function(e2, r3, t4) {
    var n2 = ge.createNode(e2, r3, 41471, 0);
    return n2.link = t4, n2;
  }, readlink: function(e2) {
    if (!we.isLink(e2.mode))
      throw new we.ErrnoError(28);
    return e2.link;
  } }, stream_ops: { read: function(e2, r3, t4, n2, o3) {
    var a3 = e2.node.contents;
    if (o3 >= e2.node.usedBytes)
      return 0;
    var i3 = Math.min(e2.node.usedBytes - o3, n2);
    if (i3 > 8 && a3.subarray)
      r3.set(a3.subarray(o3, o3 + i3), t4);
    else
      for (var s3 = 0; s3 < i3; s3++)
        r3[t4 + s3] = a3[o3 + s3];
    return i3;
  }, write: function(e2, r3, t4, n2, o3, a3) {
    if (r3.buffer === w.buffer && (a3 = false), !n2)
      return 0;
    var i3 = e2.node;
    if (i3.timestamp = Date.now(), r3.subarray && (!i3.contents || i3.contents.subarray)) {
      if (a3)
        return i3.contents = r3.subarray(t4, t4 + n2), i3.usedBytes = n2, n2;
      if (0 === i3.usedBytes && 0 === o3)
        return i3.contents = r3.slice(t4, t4 + n2), i3.usedBytes = n2, n2;
      if (o3 + n2 <= i3.usedBytes)
        return i3.contents.set(r3.subarray(t4, t4 + n2), o3), n2;
    }
    if (ge.expandFileStorage(i3, o3 + n2), i3.contents.subarray && r3.subarray)
      i3.contents.set(r3.subarray(t4, t4 + n2), o3);
    else
      for (var s3 = 0; s3 < n2; s3++)
        i3.contents[o3 + s3] = r3[t4 + s3];
    return i3.usedBytes = Math.max(i3.usedBytes, o3 + n2), n2;
  }, llseek: function(e2, r3, t4) {
    var n2 = r3;
    if (1 === t4 ? n2 += e2.position : 2 === t4 && we.isFile(e2.node.mode) && (n2 += e2.node.usedBytes), n2 < 0)
      throw new we.ErrnoError(28);
    return n2;
  }, allocate: function(e2, r3, t4) {
    ge.expandFileStorage(e2.node, r3 + t4), e2.node.usedBytes = Math.max(e2.node.usedBytes, r3 + t4);
  }, mmap: function(e2, r3, t4, n2, o3) {
    if (!we.isFile(e2.node.mode))
      throw new we.ErrnoError(43);
    var a3, i3, s3 = e2.node.contents;
    if (2 & o3 || s3.buffer !== y) {
      if ((t4 > 0 || t4 + r3 < s3.length) && (s3 = s3.subarray ? s3.subarray(t4, t4 + r3) : Array.prototype.slice.call(s3, t4, t4 + r3)), i3 = true, !(a3 = _e()))
        throw new we.ErrnoError(48);
      w.set(s3, a3);
    } else
      i3 = false, a3 = s3.byteOffset;
    return { ptr: a3, allocated: i3 };
  }, msync: function(e2, r3, t4, n2, o3) {
    if (!we.isFile(e2.node.mode))
      throw new we.ErrnoError(43);
    return 2 & o3 || ge.stream_ops.write(e2, r3, 0, n2, t4, false), 0;
  } } };
  function ye(e2, r3, t4, n2) {
    var o3 = n2 ? "" : G("al " + e2);
    i2(e2, function(t5) {
      g(t5, 'Loading data file "' + e2 + '" failed (no arrayBuffer).'), r3(new Uint8Array(t5)), o3 && X();
    }, function(r4) {
      if (!t4)
  ...
  var we = { root: null, mounts: [], devices: {}, streams: [], nextInode: 1, nameTable: null, currentPath: "/", initialized: false, ignorePermissions: true, ErrnoError: null, genericErrors: {}, filesystems: null, syncFSRequests: 0, lookupPath: (e2, r3 = {}) => {
    ...
    var t4 = { follow_mount: true, recurse_count: 0 };
    if ((r3 = Object.assign(t4, r3)).recurse_count > 8)
    ...
    for (var r3; ; ) {
      if (we.isRoot(e2)) {
        var t4 = e2.mount.mountpoint;
        return r3 ? "/" !== t4[t4.length - 1] ? t4 + "/" + r3 : t4 + r3 : t4;
      }
      r3 = r3 ? e2.name + "/" + r3 : e2.name, e2 = e2.parent;
    }
  }, hashName: (e2, r3) => {
    for (var t4 = 0, n2 = 0; n2 < r3.length; n2++)
      t4 = (t4 << 5) - t4 + r3.charCodeAt(n2) | 0;
    return (e2 + t4 >>> 0) % we.nameTable.length;
  }, hashAddNode: (e2) => {
    ...
    if (we.nameTable[r3] === e2)
      ...
      for (var t4 = we.nameTable[r3]; t4; ) {
        if (t4.name_next === e2) {
          t4.name_next = e2.name_next;
          break;
        }
        t4 = t4.name_next;
      }
  }, lookupNode: (e2, r3) => {
    var t4 = we.mayLookup(e2);
    if (t4)
      throw new we.ErrnoError(t4, e2);
  ...
  }, createNode: (e2, r3, t4, n2) => {
    var o3 = new we.FSNode(e2, r3, t4, n2);
    ...
    for (var t4 = e2; t4 <= r3; t4++)
      if (!we.streams[t4])
        return t4;
    throw new we.ErrnoError(33);
  }, getStream: (e2) => we.streams[e2], createStream: (e2, r3, t4) => {
    ...
    for (var r3 = [], t4 = [e2]; t4.length; ) {
      var n2 = t4.pop();
      r3.push(n2), t4.push.apply(t4, n2.mounts);
    }
    return r3;
  }, syncfs: (e2, r3) => {
    ...
    var t4 = we.getMounts(we.root.mount), n2 = 0;
    function o3(e3) {
    ...
    if (!o3 && !a3) {
      var i3 = we.lookupPath(t4, { follow_mount: false });
      if (t4 = i3.path, n2 = i3.node, we.isMountpoint(n2))
        throw new we.ErrnoError(10);
      if (!we.isDir(n2.mode))
        throw new we.ErrnoError(54);
    }
    var s3 = { type: e2, opts: r3, mountpoint: t4, mounts: [] }, u2 = e2.mount(s3);
    ...
    if (!we.isMountpoint(r3.node))
      throw new we.ErrnoError(28);
    var t4 = r3.node, n2 = t4.mounted, o3 = we.getMounts(n2);
    Object.keys(we.nameTable).forEach((e3) => {
      for (var r4 = we.nameTable[e3]; r4; ) {
        var t5 = r4.name_next;
        o3.includes(r4.mount) && we.destroyNode(r4), r4 = t5;
      }
    }), t4.mounted = null;
    var a3 = t4.mount.mounts.indexOf(n2);
    t4.mount.mounts.splice(a3, 1);
  }, lookup: (e2, r3) => e2.node_ops.lookup(e2, r3), mknod: (e2, r3, t4) => {
    ...
    if (!n2.node_ops.mknod)
      throw new we.ErrnoError(63);
    return n2.node_ops.mknod(n2, o3, r3, t4);
    ...
    for (var t4 = e2.split("/"), n2 = "", o3 = 0; o3 < t4.length; ++o3)
      if (t4[o3]) {
        n2 += "/" + t4[o3];
        try {
          we.mkdir(n2, r3);
  ...
  }, mkdev: (e2, r3, t4) => (void 0 === t4 && (t4 = r3, r3 = 438), r3 |= 8192, we.mknod(e2, r3, t4)), symlink: (e2, r3) => {
    if (!pe.resolve(e2))
      throw new we.ErrnoError(44);
    var t4 = we.lookupPath(r3, { parent: true }).node;
    if (!t4)
      throw new we.ErrnoError(44);
    var n2 = de.basename(r3), o3 = we.mayCreate(t4, n2);
    if (o3)
      throw new we.ErrnoError(o3);
    if (!t4.node_ops.symlink)
      throw new we.ErrnoError(63);
    return t4.node_ops.symlink(t4, n2, e2);
  }, rename: (e2, r3) => {
    var t4, n2, o3 = de.dirname(e2), a3 = de.dirname(r3), i3 = de.basename(e2), s3 = de.basename(r3);
    if (t4 = we.lookupPath(e2, { parent: true }).node, n2 = we.lookupPath(r3, { parent: true }).node, !t4 || !n2)
      throw new we.ErrnoError(44);
    if (t4.mount !== n2.mount)
      throw new we.ErrnoError(75);
    var u2, c2 = we.lookupNode(t4, i3), f2 = pe.relative(e2, a3);
    if ("." !== f2.charAt(0))
      throw new we.ErrnoError(28);
    ...
    var r3 = we.lookupPath(e2, { parent: true }).node, t4 = de.basename(e2), n2 = we.lookupNode(r3, t4), o3 = we.mayDelete(r3, t4, true);
    if (o3)
      throw new we.ErrnoError(o3);
    ...
    if (we.isMountpoint(n2))
      throw new we.ErrnoError(10);
    r3.node_ops.rmdir(r3, t4), we.destroyNode(n2);
  }, readdir: (e2) => {
    ...
    if (!r3)
      throw new we.ErrnoError(44);
    var t4 = de.basename(e2), n2 = we.lookupNode(r3, t4), o3 = we.mayDelete(r3, t4, false);
    if (o3)
      throw new we.ErrnoError(o3);
    ...
    if (we.isMountpoint(n2))
      throw new we.ErrnoError(10);
    r3.node_ops.unlink(r3, t4), we.destroyNode(n2);
  }, readlink: (e2) => {
    ...
    var t4 = we.lookupPath(e2, { follow: !r3 }).node;
    if (!t4)
      throw new we.ErrnoError(44);
    if (!t4.node_ops.getattr)
      throw new we.ErrnoError(63);
    return t4.node_ops.getattr(t4);
  }, lstat: (e2) => we.stat(e2, true), chmod: (e2, r3, t4) => {
    var n2;
    if (!(n2 = "string" == typeof e2 ? we.lookupPath(e2, { follow: !t4 }).node : e2).node_ops.setattr)
      throw new we.ErrnoError(63);
    n2.node_ops.setattr(n2, { mode: 4095 & r3 | -4096 & n2.mode, timestamp: Date.now() });
  }, lchmod: (e2, r3) => {
    we.chmod(e2, r3, true);
  }, fchmod: (e2, r3) => {
    var t4 = we.getStream(e2);
    if (!t4)
    ...
    we.chown(e2, r3, t4, true);
  }, fchown: (e2, r3, t4) => {
    var n2 = we.getStream(e2);
    if (!n2)
      throw new we.ErrnoError(8);
    we.chown(n2.node, r3, t4);
  }, truncate: (e2, r3) => {
    if (r3 < 0)
      throw new we.ErrnoError(28);
    var t4;
    if (!(t4 = "string" == typeof e2 ? we.lookupPath(e2, { follow: true }).node : e2).node_ops.setattr)
      throw new we.ErrnoError(63);
    if (we.isDir(t4.mode))
      throw new we.ErrnoError(31);
    if (!we.isFile(t4.mode))
      throw new we.ErrnoError(28);
    var n2 = we.nodePermissions(t4, "w");
    if (n2)
      throw new we.ErrnoError(n2);
    t4.node_ops.setattr(t4, { size: r3, timestamp: Date.now() });
  }, ftruncate: (e2, r3) => {
    var t4 = we.getStream(e2);
    if (!t4)
      throw new we.ErrnoError(8);
    if (0 == (2097155 & t4.flags))
      throw new we.ErrnoError(28);
    we.truncate(t4.node, r3);
  }, utime: (e2, r3, t4) => {
    var n2 = we.lookupPath(e2, { follow: true }).node;
    n2.node_ops.setattr(n2, { timestamp: Math.max(r3, t4) });
  }, open: (e2, r3, t4) => {
    if ("" === e2)
      throw new we.ErrnoError(44);
    var n2;
    if (t4 = void 0 === t4 ? 438 : t4, t4 = 64 & (r3 = "string" == typeof r3 ? we.modeStringToFlags(r3) : r3) ? 4095 & t4 | 32768 : 0, "object" == typeof e2)
      n2 = e2;
    else {
      e2 = de.normalize(e2);
      try {
    ...
    e2.fd = null;
  }, isClosed: (e2) => null === e2.fd, llseek: (e2, r3, t4) => {
    if (we.isClosed(e2))
      throw new we.ErrnoError(8);
    ...
    if (0 != t4 && 1 != t4 && 2 != t4)
      throw new we.ErrnoError(28);
    return e2.position = e2.stream_ops.llseek(e2, r3, t4), e2.ungotten = [], e2.position;
  }, read: (e2, r3, t4, n2, o3) => {
    if (n2 < 0 || o3 < 0)
      throw new we.ErrnoError(28);
    if (we.isClosed(e2))
    ...
    if (a3) {
      ...
      o3 = e2.position;
    var i3 = e2.stream_ops.read(e2, r3, t4, n2, o3);
    return a3 || (e2.position += i3), i3;
  }, write: (e2, r3, t4, n2, o3, a3) => {
    if (n2 < 0 || o3 < 0)
      throw new we.ErrnoError(28);
    if (we.isClosed(e2))
      throw new we.ErrnoError(8);
    ...
    if (i3) {
      ...
      o3 = e2.position;
    var s3 = e2.stream_ops.write(e2, r3, t4, n2, o3, a3);
    ...
    e2.stream_ops.allocate(e2, r3, t4);
  }, mmap: (e2, r3, t4, n2, o3) => {
    ...
    if (!e2.stream_ops.mmap)
      throw new we.ErrnoError(43);
    return e2.stream_ops.mmap(e2, r3, t4, n2, o3);
  }, msync: (e2, r3, t4, n2, o3) => e2 && e2.stream_ops.msync ? e2.stream_ops.msync(e2, r3, t4, n2, o3) : 0, munmap: (e2) => 0, ioctl: (e2, r3, t4) => {
    if (!e2.stream_ops.ioctl)
      throw new we.ErrnoError(59);
    return e2.stream_ops.ioctl(e2, r3, t4);
  }, readFile: (e2, r3 = {}) => {
    ...
    var t4, n2 = we.open(e2, r3.flags), o3 = we.stat(e2).size, a3 = new Uint8Array(o3);
    return we.read(n2, a3, 0, o3, 0), "utf8" === r3.encoding ? t4 = C(a3, 0) : "binary" === r3.encoding && (t4 = a3), we.close(n2), t4;
  }, writeFile: (e2, r3, t4 = {}) => {
    t4.flags = t4.flags || 577;
    var n2 = we.open(e2, t4.flags, t4.mode);
    if ("string" == typeof r3) {
      var o3 = new Uint8Array(M(r3) + 1), a3 = j(r3, o3, 0, o3.length);
      we.write(n2, o3, 0, a3, void 0, t4.canOwn);
    } else {
      if (!ArrayBuffer.isView(r3))
        throw new Error("Unsupported data type");
      we.write(n2, r3, 0, r3.byteLength, void 0, t4.canOwn);
    }
    we.close(n2);
    ...
    if (!we.isDir(r3.node.mode))
      throw new we.ErrnoError(54);
    var t4 = we.nodePermissions(r3.node, "x");
    if (t4)
      throw new we.ErrnoError(t4);
    we.currentPath = r3.path;
  }, createDefaultDirectories: () => {
    we.mkdir("/tmp"), we.mkdir("/home"), we.mkdir("/home/web_user");
  }, createDefaultDevices: () => {
    we.mkdir("/dev"), we.registerDevice(we.makedev(1, 3), { read: () => 0, write: (e3, r3, t4, n2, o3) => n2 }), we.mkdev("/dev/null", we.makedev(1, 3)), ve.register(we.makedev(5, 0), ve.default_tty_ops), ve.register(we.makedev(6, 0), ve.default_tty1_ops), we.mkdev("/dev/tty", we.makedev(5, 0)), we.mkdev("/dev/tty1", we.makedev(6, 0));
    var e2 = me();
    ...
    we.init.initialized = true, we.ensureErrnoError(), o2.stdin = e2 || o2.stdin, o2.stdout = r3 || o2.stdout, o2.stderr = t4 || o2.stderr, we.createStandardStreams();
  }, quit: () => {
    ...
    var t4 = 0;
    return e2 && (t4 |= 365), r3 && (t4 |= 146), t4;
  }, findObject: (e2, r3) => {
    var t4 = we.analyzePath(e2, r3);
    return t4.exists ? t4.object : null;
  }, analyzePath: (e2, r3) => {
    try {
      e2 = (n2 = we.lookupPath(e2, { follow: !r3 })).path;
    } catch (o3) {
    }
    var t4 = { isRoot: false, exists: false, error: 0, name: null, path: null, object: null, parentExists: false, parentPath: null, parentObject: null };
    try {
      var n2 = we.lookupPath(e2, { parent: true });
      t4.parentExists = true, t4.parentPath = n2.path, t4.parentObject = n2.node, t4.name = de.basename(e2), n2 = we.lookupPath(e2, { follow: !r3 }), t4.exists = true, t4.path = n2.path, t4.object = n2.node, t4.name = n2.node.name, t4.isRoot = "/" === n2.path;
    } catch (o3) {
      t4.error = o3.errno;
    }
    return t4;
  }, createPath: (e2, r3, t4, n2) => {
    ...
    return i3;
  }, createFile: (e2, r3, t4, n2, o3) => {
    var a3 = de.join2("string" == typeof e2 ? e2 : we.getPath(e2), r3), i3 = we.getMode(n2, o3);
    return we.create(a3, i3);
  }, createDataFile: (e2, r3, t4, n2, o3, a3) => {
    var i3 = r3;
    e2 && (e2 = "string" == typeof e2 ? e2 : we.getPath(e2), i3 = r3 ? de.join2(e2, r3) : e2);
    var s3 = we.getMode(n2, o3), u2 = we.create(i3, s3);
    if (t4) {
      if ("string" == typeof t4) {
        for (var c2 = new Array(t4.length), f2 = 0, l2 = t4.length; f2 < l2; ++f2)
          c2[f2] = t4.charCodeAt(f2);
        t4 = c2;
      }
      we.chmod(u2, 146 | s3);
      var d2 = we.open(u2, 577);
      we.write(d2, t4, 0, t4.length, 0, a3), we.close(d2), we.chmod(u2, s3);
    }
    return u2;
  }, createDevice: (e2, r3, t4, n2) => {
    var o3 = de.join2("string" == typeof e2 ? e2 : we.getPath(e2), r3), a3 = we.getMode(!!t4, !!n2);
  ...
  }, createLazyFile: (e2, r3, t4, n2, o3) => {
    function a3() {
      this.lengthKnown = false, this.chunks = [];
    }
    if (a3.prototype.get = function(e3) {
      if (!(e3 > this.length - 1 || e3 < 0)) {
        var r4 = e3 % this.chunkSize, t5 = e3 / this.chunkSize | 0;
        return this.getter(t5)[r4];
      }
    }, a3.prototype.setDataGetter = function(e3) {
      this.getter = e3;
    }, a3.prototype.cacheLength = function() {
      var e3 = new XMLHttpRequest();
      if (e3.open("HEAD", t4, false), e3.send(null), !(e3.status >= 200 && e3.status < 300 || 304 === e3.status))
        throw new Error("Couldn't load " + t4 + ". Status: " + e3.status);
      var r4, n3 = Number(e3.getResponseHeader("Content-length")), o4 = (r4 = e3.getResponseHeader("Accept-Ranges")) && "bytes" === r4, a4 = (r4 = e3.getResponseHeader("Content-Encoding")) && "gzip" === r4, i4 = 1048576;
      o4 || (i4 = n3);
      var s4 = (e4, r5) => {
        if (e4 > r5)
          throw new Error("invalid range (" + e4 + ", " + r5 + ") or no bytes requested!");
        if (r5 > n3 - 1)
          throw new Error("only " + n3 + " bytes available! programmer error!");
        var o5 = new XMLHttpRequest();
        if (o5.open("GET", t4, false), n3 !== i4 && o5.setRequestHeader("Range", "bytes=" + e4 + "-" + r5), o5.responseType = "arraybuffer", o5.overrideMimeType && o5.overrideMimeType("text/plain; charset=x-user-defined"), o5.send(null), !(o5.status >= 200 && o5.status < 300 || 304 === o5.status))
          throw new Error("Couldn't load " + t4 + ". Status: " + o5.status);
        return void 0 !== o5.response ? new Uint8Array(o5.response || []) : he(o5.responseText || "", true);
      }, u3 = this;
      u3.setDataGetter((e4) => {
        var r5 = e4 * i4, t5 = (e4 + 1) * i4 - 1;
        if (t5 = Math.min(t5, n3 - 1), void 0 === u3.chunks[e4] && (u3.chunks[e4] = s4(r5, t5)), void 0 === u3.chunks[e4])
          throw new Error("doXHR failed!");
        return u3.chunks[e4];
      }), !a4 && n3 || (i4 = n3 = 1, n3 = this.getter(0).length, i4 = n3, h("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = n3, this._chunkSize = i4, this.lengthKnown = true;
    }, "undefined" != typeof XMLHttpRequest)
      throw "Cannot do synchronous binary XHRs outside webworkers in modern browsers. Use --embed-file or --preload-file in emcc";
    var i3 = { isDevice: false, url: t4 }, s3 = we.createFile(e2, r3, i3, n2, o3);
    ...
    var u2 = {};
    function c2(e3, r4, t5, n3, o4) {
      var a4 = e3.node.contents;
      if (o4 >= a4.length)
        return 0;
      var i4 = Math.min(a4.length - o4, n3);
      if (a4.slice)
        for (var s4 = 0; s4 < i4; s4++)
          r4[t5 + s4] = a4[o4 + s4];
      else
        for (s4 = 0; s4 < i4; s4++)
          r4[t5 + s4] = a4.get(o4 + s4);
      return i4;
    }
    ...
    }), u2.read = (e3, r4, t5, n3, o4) => (we.forceLoadFile(s3), c2(e3, r4, t5, n3, o4)), u2.mmap = (e3, r4, t5, n3, o4) => {
      we.forceLoadFile(s3);
      var a4 = _e();
      if (!a4)
        throw new we.ErrnoError(48);
      return c2(e3, w, a4, r4, t5), { ptr: a4, allocated: true };
    }, s3.stream_ops = u2, s3;
  }, createPreloadedFile: (e2, r3, t4, n2, o3, a3, i3, s3, u2, c2) => {
    var f2 = r3 ? pe.resolve(de.join2(e2, r3)) : e2;
    function l2(t5) {
      function l3(t6) {
        c2 && c2(), s3 || we.createDataFile(e2, r3, t6, n2, o3, u2), a3 && a3(), X();
      }
      Browser.handledByPreloadPlugin(t5, f2, l3, () => {
        i3 && i3(), X();
      }) || l3(t5);
    }
    Y(), "string" == typeof t4 ? ye(t4, (e3) => l2(e3), i3) : l2(t4);
  }, indexedDB: () => window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB, DB_NAME: () => "EM_FS_" + window.location.pathname, DB_VERSION: 20, DB_STORE_NAME: "FILE_DATA", saveFilesToDB: (e2, r3, t4) => {
    r3 = r3 || (() => {
    }), t4 = t4 || (() => {
    });
    var n2 = we.indexedDB();
    ...
    o3.onupgradeneeded = t4, o3.onsuccess = () => {
      var n3 = o3.result;
      try {
  ...
  } }, Ee = { DEFAULT_POLLMASK: 5, calculateAt: function(e2, r3, t4) {
    if (de.isAbs(r3))
      return r3;
    var n2;
    if (-100 === e2)
    ...
    return x[t4 >> 2] = n2.dev, x[t4 + 4 >> 2] = 0, x[t4 + 8 >> 2] = n2.ino, x[t4 + 12 >> 2] = n2.mode, x[t4 + 16 >> 2] = n2.nlink, x[t4 + 20 >> 2] = n2.uid, x[t4 + 24 >> 2] = n2.gid, x[t4 + 28 >> 2] = n2.rdev, x[t4 + 32 >> 2] = 0, $ = [n2.size >>> 0, (J = n2.size, +Math.abs(J) >= 1 ? J > 0 ? (0 | Math.min(+Math.floor(J / 4294967296), 4294967295)) >>> 0 : ~~+Math.ceil((J - +(~~J >>> 0)) / 4294967296) >>> 0 : 0)], x[t4 + 40 >> 2] = $[0], x[t4 + 44 >> 2] = $[1], x[t4 + 48 >> 2] = 4096, x[t4 + 52 >> 2] = n2.blocks, x[t4 + 56 >> 2] = n2.atime.getTime() / 1e3 | 0, x[t4 + 64 >> 2] = 0, x[t4 + 72 >> 2] = n2.mtime.getTime() / 1e3 | 0, x[t4 + 80 >> 2] = 0, x[t4 + 88 >> 2] = n2.ctime.getTime() / 1e3 | 0, x[t4 + 96 >> 2] = 0, $ = [n2.ino >>> 0, (J = n2.ino, +Math.abs(J) >= 1 ? J > 0 ? (0 | Math.min(+Math.floor(J / 4294967296), 4294967295)) >>> 0 : ~~+Math.ceil((J - +(~~J >>> 0)) / 4294967296) >>> 0 : 0)], x[t4 + 104 >> 2] = $[0], x[t4 + 108 >> 2] = $[1], 0;
  }, doMsync: function(e2, r3, t4, n2, o3) {
    var a3 = E.slice(e2, e2 + t4);
    we.msync(r3, a3, o3, t4, n2);
  ...
  function xe(e2, r3, t4, n2) {
    Ee.varargs = n2;
    try {
      r3 = Ee.getStr(r3), r3 = Ee.calculateAt(e2, r3);
      var o3 = n2 ? Ee.get() : 0;
      return we.open(r3, t4, o3).fd;
    } catch (a3) {
      if (void 0 === we || !(a3 instanceof we.ErrnoError))
        throw a3;
      return -a3.errno;
  ...
  function Le(e2, r3) {
    var t4 = Me(r3, function(e3) {
      this.name = r3, this.message = e3;
      var t5 = new Error(e3).stack;
      void 0 !== t5 && (this.stack = this.toString() + "\n" + t5.replace(/^Error(:[^\n]*)?\n/, ""));
    });
    return t4.prototype = Object.create(e2.prototype), t4.prototype.constructor = t4, t4.prototype.toString = function() {
  ...
  function Oe(e2) {
    var r3 = Se[e2];
    delete Se[e2];
    var t4 = r3.rawConstructor, n2 = r3.rawDestructor, o3 = r3.fields;
    Ne([e2], o3.map((e3) => e3.getterReturnType).concat(o3.map((e3) => e3.setterArgumentType)), (e3) => {
      var a3 = {};
      return o3.forEach((r4, t5) => {
        var n3 = r4.fieldName, i3 = e3[t5], s3 = r4.getter, u2 = r4.getterContext, c2 = e3[t5 + o3.length], f2 = r4.setter, l2 = r4.setterContext;
        a3[n3] = { read: (e4) => i3.fromWireType(s3(u2, e4)), write: (e4, r5) => {
          var t6 = [];
          f2(l2, e4, c2.toWireType(t6, r5)), De(t6);
        } };
  ...
  function nr(e2, r3, t4) {
    if (void 0 === e2[r3].overloadTable) {
      var n2 = e2[r3];
      e2[r3] = function() {
        return e2[r3].overloadTable.hasOwnProperty(arguments.length) || Ve("Function '" + t4 + "' called with an invalid number of arguments (" + arguments.length + ") - expects one of (" + e2[r3].overloadTable + ")!"), e2[r3].overloadTable[arguments.length].apply(this, arguments);
      }, e2[r3].overloadTable = [], e2[r3].overloadTable[n2.argCount] = n2;
    }
  }
  function or(e2, r3, t4) {
    o2.hasOwnProperty(e2) ? ((void 0 === t4 || void 0 !== o2[e2].overloadTable && void 0 !== o2[e2].overloadTable[t4]) && Ve("Cannot register public name '" + e2 + "' twice"), nr(o2, e2, e2), o2.hasOwnProperty(t4) && Ve("Cannot register multiple overloads of a function with the same number of arguments (" + t4 + ")!"), o2[e2].overloadTable[t4] = r3) : (o2[e2] = r3, void 0 !== t4 && (o2[e2].numArguments = t4));
  }
  function ar(e2, r3, t4) {
    switch (r3) {
      case 0:
        return function(e3) {
          var r4 = t4 ? w : E;
  ...
  function sr(e2) {
    var r3 = _o(e2), t4 = Ue(r3);
    return ho(r3), t4;
  }
  function ur(e2, r3) {
    var t4 = Pe[e2];
    return void 0 === t4 && Ve(r3 + " has unknown type " + sr(e2)), t4;
  }
  function cr(e2, r3, t4) {
    var n2 = ur(e2, "enum");
    r3 = Ue(r3);
    var o3 = n2.constructor, a3 = Object.create(n2.constructor.prototype, { value: { value: t4 }, constructor: { value: Me(n2.name + "_" + r3, function() {
    }) } });
    o3.values[t4] = a3, o3[r3] = a3;
  }
  function fr(e2, r3) {
    switch (r3) {
      case 2:
  ...
  function dr(e2, r3, t4, n2, o3) {
    var a3 = r3.length;
    a3 < 2 && Ve("argTypes array size mismatch! Must at least get return value and 'this' types!");
    for (var i3 = null !== r3[1] && null !== t4, s3 = false, u2 = 1; u2 < r3.length; ++u2)
    ...
    return function() {
      var t5;
      arguments.length !== f2 && Ve("function " + e2 + " called with " + arguments.length + " arguments, expected " + f2 + " args!"), m2.length = 0, d2.length = i3 ? 2 : 1, d2[0] = o3, i3 && (t5 = r3[1].toWireType(m2, this), d2[1] = t5);
  ...
  function mr(e2, r3) {
    for (var t4 = [], n2 = 0; n2 < e2; n2++)
      t4.push(S[r3 + 4 * n2 >> 2]);
    return t4;
  }
  function pr(e2, r3, t4) {
    o2.hasOwnProperty(e2) || Ie("Replacing nonexistant public symbol"), void 0 !== o2[e2].overloadTable && void 0 !== t4 ? o2[e2].overloadTable[t4] = r3 : (o2[e2] = r3, o2[e2].argCount = t4);
  }
  function hr(e2, r3, t4) {
    var n2 = o2["dynCall_" + e2];
    return t4 && t4.length ? n2.apply(null, [r3].concat(t4)) : n2.call(null, r3);
  }
  var vr = [];
  function _r(e2) {
    var r3 = vr[e2];
  ...
  function gr(e2, r3, t4) {
    return e2.includes("j") ? hr(e2, r3, t4) : _r(r3).apply(null, t4);
  }
  function yr(e2, r3) {
    var t4 = [];
    return function() {
      return t4.length = 0, Object.assign(t4, arguments), gr(e2, r3, t4);
    };
  }
  function wr(e2, r3) {
    function t4() {
  ...
  function br(e2, r3) {
    var t4 = [], n2 = {};
    function o3(e3) {
      n2[e3] || Pe[e3] || (Ce[e3] ? Ce[e3].forEach(o3) : (t4.push(e3), n2[e3] = true));
    }
    throw r3.forEach(o3), new Er(e2 + ": " + t4.map(sr).join([", "]));
  }
  function kr(e2, r3, t4, n2, o3, a3) {
    var i3 = mr(r3, t4);
    e2 = Ue(e2), o3 = wr(n2, o3), or(e2, function() {
      br("Cannot call " + e2 + " due to unbound types", i3);
    }, r3 - 1), Ne([], i3, function(t5) {
      var n3 = [t5[0], null].concat(t5.slice(1));
      return pr(e2, dr(e2, n3, null, o3, a3), r3 - 1), [];
    });
  }
  function xr(e2, r3, t4) {
    switch (r3) {
      case 0:
        return t4 ? function(e3) {
          return w[e3];
        } : function(e3) {
          return E[e3];
        };
  ...
  function Sr(e2, r3, t4, n2, o3) {
    r3 = Ue(r3);
    var a3 = We(t4), i3 = (e3) => e3;
    if (0 === n2) {
      var s3 = 32 - 8 * t4;
      i3 = (e3) => e3 << s3 >>> s3;
    }
  ...
  function Dr(e2, r3, t4) {
    var n2 = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array][r3];
    function o3(e3) {
      var r4 = S, t5 = r4[e3 >>= 2], o4 = r4[e3 + 1];
      return new n2(y, o4, t5);
    }
    Ge(e2, { name: t4 = Ue(t4), fromWireType: o3, argPackAdvance: 8, readValueFromPointer: o3 }, { ignoreDuplicateRegistrations: true });
  }
  function Fr(e2, r3) {
    var t4 = "std::string" === (r3 = Ue(r3));
    Ge(e2, { name: r3, fromWireType: function(e3) {
      ...
      o3 || r4 instanceof Uint8Array || r4 instanceof Uint8ClampedArray || r4 instanceof Int8Array || Ve("Cannot pass non-string to std::string"), n2 = t4 && o3 ? M(r4) : r4.length;
  ...
  function Pr(e2, r3) {
    for (var t4 = e2, n2 = t4 >> 1, o3 = n2 + r3 / 2; !(n2 >= o3) && k[n2]; )
      ++n2;
    if ((t4 = n2 << 1) - e2 > 32 && Ar)
      return Ar.decode(E.subarray(e2, t4));
  ...
  function Cr(e2, r3, t4) {
    if (void 0 === t4 && (t4 = 2147483647), t4 < 2)
      return 0;
    for (var n2 = r3, o3 = (t4 -= 2) < 2 * e2.length ? t4 / 2 : e2.length, a3 = 0; a3 < o3; ++a3) {
  ...
  function Br(e2, r3, t4) {
    if (void 0 === t4 && (t4 = 2147483647), t4 < 4)
      return 0;
    for (var n2 = r3, o3 = n2 + t4 - 4, a3 = 0; a3 < e2.length; ++a3) {
      var i3 = e2.charCodeAt(a3);
  ...
  function Mr(e2) {
    for (var r3 = 0, t4 = 0; t4 < e2.length; ++t4) {
      var n2 = e2.charCodeAt(t4);
      n2 >= 55296 && n2 <= 57343 && ++t4, r3 += 4;
    }
    return r3;
  }
  function Lr(e2, r3, t4) {
    var n2, o3, a3, i3, s3;
    t4 = Ue(t4), 2 === r3 ? (n2 = Pr, o3 = Cr, i3 = Tr, a3 = () => k, s3 = 1) : 4 === r3 && (n2 = jr, o3 = Br, i3 = Mr, a3 = () => S, s3 = 2), Ge(e2, { name: t4, fromWireType: function(e3) {
      for (var t5, o4 = S[e3 >> 2], i4 = a3(), u2 = e3 + 4, c2 = 0; c2 <= o4; ++c2) {
        var f2 = e3 + 4 + c2 * r3;
        if (c2 == o4 || 0 == i4[f2 >> s3]) {
          var l2 = n2(u2, f2 - u2);
          void 0 === t5 ? t5 = l2 : (t5 += String.fromCharCode(0), t5 += l2), u2 = f2 + r3;
        }
      }
      return ho(e3), t5;
    }, toWireType: function(e3, n3) {
      "string" != typeof n3 && Ve("Cannot pass non-string to C++ string type " + t4);
  ...
  function Rr(e2, r3, t4, n2, o3, a3) {
    Se[e2] = { name: Ue(r3), rawConstructor: wr(t4, n2), rawDestructor: wr(o3, a3), fields: [] };
  }
  function Ir(e2, r3, t4, n2, o3, a3, i3, s3, u2, c2) {
    Se[e2].fields.push({ fieldName: Ue(r3), getterReturnType: t4, getter: wr(n2, o3), getterContext: a3, setterArgumentType: i3, setter: wr(s3, u2), setterContext: c2 });
  }
  function Nr(e2, r3) {
  ...
  function Or(e2) {
    do {
      var r3 = S[e2 >> 2], t4 = S[(e2 += 4) >> 2], n2 = S[(e2 += 4) >> 2];
      e2 += 4;
      var o3 = T(r3);
      we.createPath("/", de.dirname(o3), true, true), we.createDataFile(o3, null, w.subarray(n2, n2 + t4), true, true, true);
    } while (S[e2 >> 2]);
  }
  function zr(e2) {
  ...
  function qr(e2, r3, t4) {
    e2 = rr.toValue(e2), r3 = rr.toValue(r3), t4 = rr.toValue(t4), e2[r3] = t4;
  }
  function Vr(e2, r3) {
    var t4 = (e2 = ur(e2, "_emval_take_value")).readValueFromPointer(r3);
    return rr.toHandle(t4);
  }
  function Gr() {
    Q("");
  }
  function Yr(e2, r3, t4) {
    E.copyWithin(e2, r3, r3 + t4);
  }
  function Xr() {
    return 2147483648;
  }
  ...
  function Kr(e2) {
    ...
    for (var o3 = 1; o3 <= 4; o3 *= 2) {
      var a3 = r3 * (1 + 0.2 / o3);
      if (a3 = Math.min(a3, e2 + 100663296), Qr(Math.min(t4, n2(Math.max(e2, a3), 65536))))
        return true;
    }
    return false;
  }
  ...
  var rt = { counter: 1, buffers: [], programs: [], framebuffers: [], renderbuffers: [], textures: [], shaders: [], vaos: [], contexts: [], offscreenCanvases: {}, queries: [], samplers: [], transformFeedbacks: [], syncs: [], stringCache: {}, stringiCache: {}, unpackAlignment: 4, recordError: function(e2) {
    ...
    for (var r3 = rt.counter++, t4 = e2.length; t4 < r3; t4++)
      e2[t4] = null;
    return r3;
  }, getSource: function(e2, r3, t4, n2) {
    for (var o3 = "", a3 = 0; a3 < r3; ++a3) {
      var i3 = n2 ? x[n2 + 4 * a3 >> 2] : -1;
      o3 += T(x[t4 + 4 * a3 >> 2], i3 < 0 ? void 0 : i3);
    }
    return o3;
  }, createContext: function(e2, r3) {
    if (o2.preinitializedWebGLContext) {
      var t4 = o2.preinitializedWebGLContext;
      r3.majorVersion = "undefined" != typeof WebGL2RenderingContext && t4 instanceof WebGL2RenderingContext ? 2 : 1;
    } else {
      if (!e2.getContextSafariWebGL2Fixed) {
        let n2 = function(r4, t5) {
          var n3 = e2.getContextSafariWebGL2Fixed(r4, t5);
          return "webgl" == r4 == n3 instanceof WebGLRenderingContext ? n3 : null;
        };
        e2.getContextSafariWebGL2Fixed = e2.getContext, e2.getContext = n2;
      }
      t4 = e2.getContext("webgl2", r3);
    }
    return t4 ? rt.registerContext(t4, r3) : 0;
  }, registerContext: function(e2, r3) {
    var t4 = rt.getNewId(rt.contexts), n2 = { handle: t4, attributes: r3, version: r3.majorVersion, GLctx: e2 };
    return e2.canvas && (e2.canvas.GLctxObject = n2), rt.contexts[t4] = n2, (void 0 === r3.enableExtensionsByDefault || r3.enableExtensionsByDefault) && rt.initExtensions(n2), t4;
  ...
  }, deferredCalls: [], deferCall: function(e2, r3, t4) {
    function n2(e3, r4) {
    ...
    for (var o3 in tt.deferredCalls) {
      ...
      if (a3.targetFunction == e2 && n2(a3.argsList, t4))
        return;
    }
    tt.deferredCalls.push({ targetFunction: e2, precedence: r3, argsList: t4 }), tt.deferredCalls.sort(function(e3, r4) {
    ...
    for (var t4 = 0; t4 < tt.eventHandlers.length; ++t4)
      tt.eventHandlers[t4].target != e2 || r3 && r3 != tt.eventHandlers[t4].eventTypeString || tt._removeHandler(t4--);
    ...
    if (e2.callbackfunc)
      ...
      for (var t4 = 0; t4 < tt.eventHandlers.length; ++t4)
        tt.eventHandlers[t4].target == e2.target && tt.eventHandlers[t4].eventTypeString == e2.eventTypeString && tt._removeHandler(t4--);
  ...
  function ut(e2, r3) {
    var t4 = r3 >> 2, n2 = x[t4 + 6], o3 = { alpha: !!x[t4 + 0], depth: !!x[t4 + 1], stencil: !!x[t4 + 2], antialias: !!x[t4 + 3], premultipliedAlpha: !!x[t4 + 4], preserveDrawingBuffer: !!x[t4 + 5], powerPreference: nt[n2], failIfMajorPerformanceCaveat: !!x[t4 + 7], majorVersion: x[t4 + 8], minorVersion: x[t4 + 9], enableExtensionsByDefault: x[t4 + 10], explicitSwapControl: x[t4 + 11], proxyContextToMainThread: x[t4 + 12], renderViaOffscreenBackBuffer: x[t4 + 13] }, a3 = st(e2);
    return a3 ? o3.explicitSwapControl ? 0 : rt.createContext(a3, o3) : 0;
  }
  var ct = ut;
  function ft(e2) {
    for (var r3 = e2 >> 2, t4 = 0; t4 < 14; ++t4)
      x[r3 + t4] = 0;
  ...
  function vt(e2, r3) {
    ...
    return pt().forEach(function(n2, o3) {
      var a3 = r3 + t4;
      S[e2 + 4 * o3 >> 2] = a3, ht(n2, a3), t4 += n2.length + 1;
    }), 0;
  }
  function _t(e2, r3) {
    var t4 = pt();
  ...
  function gt(e2) {
    try {
      ...
      if (void 0 === we || !(t4 instanceof we.ErrnoError))
        throw t4;
      return t4.errno;
    }
  }
  function yt(e2, r3, t4, n2) {
    for (var o3 = 0, a3 = 0; a3 < t4; a3++) {
  ...
  function wt(e2, r3, t4, n2) {
    try {
      var o3 = yt(Ee.getStreamFromFD(e2), r3, t4);
      return x[n2 >> 2] = o3, 0;
    } catch (a3) {
      if (void 0 === we || !(a3 instanceof we.ErrnoError))
        throw a3;
  ...
  function xt(e2, r3, t4, n2) {
    try {
      var o3 = kt(Ee.getStreamFromFD(e2), r3, t4);
      return S[n2 >> 2] = o3, 0;
    } catch (a3) {
      if (void 0 === we || !(a3 instanceof we.ErrnoError))
        throw a3;
  ...
  function Ft(e2, r3, t4) {
    uo.bindAttribLocation(rt.programs[e2], r3, T(t4));
  }
  function At(e2, r3) {
  ...
  function Pt(e2, r3, t4) {
    uo.bindBufferBase(e2, r3, rt.buffers[t4]);
  }
  function Ct(e2, r3, t4, n2, o3) {
    uo.bindBufferRange(e2, r3, rt.buffers[t4], n2, o3);
  }
  function Tt(e2, r3) {
  ...
  function Mt(e2, r3, t4, n2) {
    t4 && r3 ? uo.bufferData(e2, E, n2, t4, r3) : uo.bufferData(e2, r3, n2);
  }
  function Lt(e2, r3, t4, n2) {
    t4 && uo.bufferSubData(e2, r3, E, n2, t4);
  }
  function Rt(e2) {
    uo.clear(e2);
  }
  function It(e2, r3, t4, n2) {
    uo.clearBufferfi(e2, r3, t4, n2);
  }
  function Nt(e2, r3, t4) {
    uo.clearBufferfv(e2, r3, D, t4 >> 2);
  }
  function Ot(e2, r3, t4) {
    uo.clearBufferiv(e2, r3, x, t4 >> 2);
  }
  function zt(e2, r3, t4) {
    uo.clearBufferuiv(e2, r3, S, t4 >> 2);
  }
  function Wt(e2, r3, t4, n2) {
    uo.clearColor(e2, r3, t4, n2);
  }
  function Zt(e2) {
    uo.clearDepth(e2);
  }
  ...
  function Ut(e2, r3, t4, n2) {
    uo.colorMask(!!e2, !!r3, !!t4, !!n2);
  }
  function qt(e2) {
  ...
  function Yt(e2, r3) {
    for (var t4 = 0; t4 < e2; t4++) {
      var n2 = x[r3 + 4 * t4 >> 2], o3 = rt.buffers[n2];
  ...
  function Xt(e2, r3) {
    for (var t4 = 0; t4 < e2; ++t4) {
      var n2 = x[r3 + 4 * t4 >> 2], o3 = rt.framebuffers[n2];
  ...
  function Kt(e2, r3) {
    for (var t4 = 0; t4 < e2; t4++) {
      var n2 = x[r3 + 4 * t4 >> 2], o3 = rt.queries[n2];
  ...
  function $t(e2, r3) {
    for (var t4 = 0; t4 < e2; t4++) {
      var n2 = x[r3 + 4 * t4 >> 2], o3 = rt.textures[n2];
  ...
  function rn(e2, r3, t4) {
    uo.drawArrays(e2, r3, t4);
  }
  var tn = [];
  function nn(e2, r3) {
    for (var t4 = tn[e2], n2 = 0; n2 < e2; n2++)
      t4[n2] = x[r3 + 4 * n2 >> 2];
    uo.drawBuffers(t4);
  }
  function on(e2, r3, t4, n2) {
    uo.drawElements(e2, r3, t4, n2);
  }
  function an(e2, r3, t4, n2, o3) {
    uo.drawElementsInstanced(e2, r3, t4, n2, o3);
  }
  function sn(e2) {
    uo.enableVertexAttribArray(e2);
  }
  function un(e2, r3, t4, n2, o3) {
    uo.framebufferTexture2D(e2, r3, t4, rt.textures[n2], o3);
  }
  function cn(e2, r3, t4, n2) {
    for (var o3 = 0; o3 < e2; o3++) {
      var a3 = uo[t4](), i3 = a3 && rt.getNewId(n2);
    ...
    if (r3) {
      ...
      switch (e2) {
        case 36346:
          ...
          break;
        case 36344:
          return void (0 != t4 && 1 != t4 && rt.recordError(1280));
        case 34814:
        case 36345:
          n2 = 0;
          break;
          ...
          case "object":
            if (null === a3)
              ...
              try {
                ...
                return rt.recordError(1280), void v("GL_INVALID_ENUM in glGet" + t4 + "v: Unknown object returned from WebGL getParameter(" + e2 + ")! (error: " + s3 + ")");
              }
            }
            break;
          default:
            return rt.recordError(1280), void v("GL_INVALID_ENUM in glGet" + t4 + "v: Native code calling glGet" + t4 + "v(" + e2 + ") and it returns " + a3 + " of type " + typeof a3 + "!");
        }
      }
      switch (t4) {
        case 1:
  ...
  function yn(e2, r3, t4) {
    if (t4) {
      var n2, o3 = rt.queries[e2];
      vn(t4, "boolean" == typeof (n2 = rt.currentContext.version < 2 ? uo.disjointTimerQueryExt.getQueryObjectEXT(o3, r3) : uo.getQueryParameter(o3, r3)) ? n2 ? 1 : 0 : n2);
    } else
      rt.recordError(1281);
  }
  function wn(e2, r3, t4) {
    if (t4) {
      var n2, o3 = rt.queries[e2], a3 = uo.disjointTimerQueryExt.getQueryObjectEXT(o3, r3);
      n2 = "boolean" == typeof a3 ? a3 ? 1 : 0 : a3, x[t4 >> 2] = n2;
    } else
      rt.recordError(1281);
  }
  function En(e2, r3) {
  ...
  function xn(e2) {
    var r3, t4, n2 = e2.uniformLocsById, o3 = e2.uniformSizeAndIdsByName;
    if (!n2)
      for (e2.uniformLocsById = n2 = {}, e2.uniformArrayNamesById = {}, r3 = 0; r3 < uo.getProgramParameter(e2, 35718); ++r3) {
        ...
        for (e2.uniformIdCounter += s3, o3[c2] = [s3, f2], t4 = 0; t4 < s3; ++t4)
          n2[f2] = t4, e2.uniformArrayNamesById[f2++] = c2;
      }
  }
  function Sn(e2, r3) {
    if (r3 = T(r3), e2 = rt.programs[e2]) {
      xn(e2);
      var t4 = e2.uniformLocsById, n2 = 0, o3 = r3, a3 = kn(r3);
      a3 > 0 && (n2 = bn(r3.slice(a3 + 1)) >>> 0, o3 = r3.slice(0, a3));
      var i3 = e2.uniformSizeAndIdsByName[o3];
      if (i3 && n2 < i3[0] && (t4[n2 += i3[1]] = t4[n2] || uo.getUniformLocation(e2, r3)))
        return n2;
    } else
      rt.recordError(1281);
    return -1;
  ...
  function jn(e2, r3, t4, n2, o3, a3, i3) {
    if (uo.currentPixelPackBufferBinding)
      uo.readPixels(e2, r3, t4, n2, o3, a3, i3);
    else {
      var s3 = Cn(a3);
      uo.readPixels(e2, r3, t4, n2, o3, a3, s3, i3 >> Tn(s3));
    }
  }
  function Bn(e2, r3, t4, n2) {
    var o3 = rt.getSource(e2, r3, t4, n2);
    uo.shaderSource(rt.shaders[e2], o3);
  }
  function Mn(e2, r3, t4, n2, o3, a3, i3, s3, u2, c2) {
    if (uo.currentPixelUnpackBufferBinding)
      uo.texImage3D(e2, r3, t4, n2, o3, a3, i3, s3, u2, c2);
    else if (c2) {
      var f2 = Cn(u2);
      uo.texImage3D(e2, r3, t4, n2, o3, a3, i3, s3, u2, f2, c2 >> Tn(f2));
    } else
      uo.texImage3D(e2, r3, t4, n2, o3, a3, i3, s3, u2, null);
  }
  function Ln(e2, r3, t4) {
    uo.texParameteri(e2, r3, t4);
  }
  function Rn(e2, r3, t4, n2, o3) {
    uo.texStorage2D(e2, r3, t4, n2, o3);
  }
  function In(e2, r3, t4, n2, o3, a3, i3, s3, u2) {
    if (uo.currentPixelUnpackBufferBinding)
      uo.texSubImage2D(e2, r3, t4, n2, o3, a3, i3, s3, u2);
    else if (u2) {
      var c2 = Cn(s3);
      uo.texSubImage2D(e2, r3, t4, n2, o3, a3, i3, s3, c2, u2 >> Tn(c2));
    } else
      uo.texSubImage2D(e2, r3, t4, n2, o3, a3, i3, s3, null);
  }
  function Nn(e2, r3, t4, n2, o3, a3, i3, s3, u2, c2, f2) {
    if (uo.currentPixelUnpackBufferBinding)
      uo.texSubImage3D(e2, r3, t4, n2, o3, a3, i3, s3, u2, c2, f2);
    else if (f2) {
      var l2 = Cn(c2);
      uo.texSubImage3D(e2, r3, t4, n2, o3, a3, i3, s3, u2, c2, l2, f2 >> Tn(l2));
    } else
      uo.texSubImage3D(e2, r3, t4, n2, o3, a3, i3, s3, u2, c2, null);
  }
  function On(e2) {
    var r3 = uo.currentProgram;
    if (r3) {
      var t4 = r3.uniformLocsById[e2];
      return "number" == typeof t4 && (r3.uniformLocsById[e2] = t4 = uo.getUniformLocation(r3, r3.uniformArrayNamesById[e2] + (t4 > 0 ? "[" + t4 + "]" : ""))), t4;
    }
    rt.recordError(1282);
  }
  function zn(e2, r3) {
  ...
  function Wn(e2, r3, t4) {
    e2 = rt.programs[e2], uo.uniformBlockBinding(e2, r3, t4);
  }
  function Zn(e2) {
    e2 = rt.programs[e2], uo.useProgram(e2), uo.currentProgram = e2;
  }
  function Hn(e2, r3, t4, n2, o3) {
    uo.vertexAttribIPointer(e2, r3, t4, n2, o3);
  }
  function Un(e2, r3, t4, n2, o3, a3) {
    uo.vertexAttribPointer(e2, r3, t4, !!n2, o3, a3);
  }
  function qn(e2) {
  }
  function Vn(e2) {
  ...
  function Gn(e2, r3) {
    for (var t4 = 0, n2 = 0; n2 <= r3; t4 += e2[n2++])
      ;
    return t4;
  }
  var Yn = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], Xn = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
  function Qn(e2, r3) {
    for (var t4 = new Date(e2.getTime()); r3 > 0; ) {
      var n2 = Vn(t4.getFullYear()), o3 = t4.getMonth(), a3 = (n2 ? Yn : Xn)[o3];
      if (!(r3 > a3 - t4.getDate()))
        return t4.setDate(t4.getDate() + r3), t4;
      r3 -= a3 - t4.getDate() + 1, t4.setDate(1), o3 < 11 ? t4.setMonth(o3 + 1) : (t4.setMonth(0), t4.setFullYear(t4.getFullYear() + 1));
    }
    return t4;
  }
  function Kn(e2, r3, t4, n2) {
    var o3 = x[n2 + 40 >> 2], a3 = { tm_sec: x[n2 >> 2], tm_min: x[n2 + 4 >> 2], tm_hour: x[n2 + 8 >> 2], tm_mday: x[n2 + 12 >> 2], tm_mon: x[n2 + 16 >> 2], tm_year: x[n2 + 20 >> 2], tm_wday: x[n2 + 24 >> 2], tm_yday: x[n2 + 28 >> 2], tm_isdst: x[n2 + 32 >> 2], tm_gmtoff: x[n2 + 36 >> 2], tm_zone: o3 ? T(o3) : "" }, i3 = T(t4), s3 = { "%c": "%a %b %d %H:%M:%S %Y", "%D": "%m/%d/%y", "%F": "%Y-%m-%d", "%h": "%b", "%r": "%I:%M:%S %p", "%R": "%H:%M", "%T": "%H:%M:%S", "%x": "%m/%d/%y", "%X": "%H:%M:%S", "%Ec": "%c", "%EC": "%C", "%Ex": "%m/%d/%y", "%EX": "%H:%M:%S", "%Ey": "%y", "%EY": "%Y", "%Od": "%d", "%Oe": "%e", "%OH": "%H", "%OI": "%I", "%Om": "%m", "%OM": "%M", "%OS": "%S", "%Ou": "%u", "%OU": "%U", "%OV": "%V", "%Ow": "%w", "%OW": "%W", "%Oy": "%y" };
    for (var u2 in s3)
    ...
    function m2(e3, r4) {
      ...
      var n3;
      return 0 === (n3 = t5(e3.getFullYear() - r4.getFullYear())) && 0 === (n3 = t5(e3.getMonth() - r4.getMonth())) && (n3 = t5(e3.getDate() - r4.getDate())), n3;
    }
    function p2(e3) {
      switch (e3.getDay()) {
        case 0:
    ...
    function h2(e3) {
      var r4 = Qn(new Date(e3.tm_year + 1900, 0, 1), e3.tm_yday), t5 = new Date(r4.getFullYear(), 0, 4), n3 = new Date(r4.getFullYear() + 1, 0, 4), o4 = p2(t5), a4 = p2(n3);
    ...
    var v2 = { "%a": function(e3) {
      ...
      if ((e3.tm_wday + 371 - e3.tm_yday - 2) % 7 <= 2 && r4++, r4) {
        if (53 == r4) {
          var t5 = (e3.tm_wday + 371 - e3.tm_yday) % 7;
          4 == t5 || 3 == t5 && Vn(e3.tm_year) || (r4 = 1);
        }
      } else {
        r4 = 52;
      ...
      var r4 = e3.tm_gmtoff, t5 = r4 >= 0;
      return r4 = (r4 = Math.abs(r4) / 60) / 60 * 100 + r4 % 60, (t5 ? "+" : "-") + String("0000" + r4).slice(-4);
    }, "%Z": function(e3) {
      return e3.tm_zone;
    }, "%%": function() {
      return "%";
  ...
  function Jn(e2, r3, t4, n2) {
    return Kn(e2, r3, t4, n2);
  }
  function $n(e2, r3) {
    e2 < 128 ? r3.push(e2) : r3.push(e2 % 128 | 128, e2 >> 7);
  }
  function eo(e2) {
    for (var r3 = { i: "i32", j: "i64", f: "f32", d: "f64", p: "i32" }, t4 = { parameters: [], results: "v" == e2[0] ? [] : [r3[e2[0]]] }, n2 = 1; n2 < e2.length; ++n2)
      t4.parameters.push(r3[e2[n2]]);
    return t4;
  }
  function ro(e2, r3) {
    if ("function" == typeof WebAssembly.Function)
      return new WebAssembly.Function(eo(r3), e2);
    var t4 = [1, 96], n2 = r3.slice(0, 1), o3 = r3.slice(1), a3 = { i: 127, p: 127, j: 126, f: 125, d: 124 };
    $n(o3.length, t4);
    for (var i3 = 0; i3 < o3.length; ++i3)
      t4.push(a3[o3[i3]]);
    "v" == n2 ? t4.push(0) : t4.push(1, a3[n2]);
    var s3 = [0, 97, 115, 109, 1, 0, 0, 0, 1];
    $n(t4.length, s3), s3.push.apply(s3, t4), s3.push(2, 7, 1, 1, 101, 1, 102, 0, 0, 7, 5, 1, 1, 102, 0, 0);
    var u2 = new WebAssembly.Module(new Uint8Array(s3));
    return new WebAssembly.Instance(u2, { e: { f: e2 } }).exports.f;
  }
  function to(e2, r3) {
    if (no)
      for (var t4 = e2; t4 < e2 + r3; t4++) {
        var n2 = _r(t4);
        n2 && no.set(n2, t4);
      }
  }
  ...
  function so(e2, r3) {
    ...
    return no.set(e2, t4), t4;
  }
  var uo, co = function(e2, r3, t4, n2) {
    e2 || (e2 = this), this.parent = e2, this.mount = e2.mount, this.mounted = null, this.id = we.nextInode++, this.name = r3, this.mode = t4, this.node_ops = {}, this.stream_ops = {}, this.rdev = n2;
  }, fo = 365, lo = 146;
...
var i = a.exports;
var s = r({ __proto__: null, default: t(i) }, [i]);
export {
  s as v
};
//# sourceMappingURL=vxlLayer-EPWPJ5N5.js.map
