...
var n2 = class extends m {
  ...
  async update(t, r) {
    const { addOrUpdateResource: e3 } = await import("./resourceUtils-LAKVJ55E.js");
...
var S = f = class extends u2(_2) {
  ...
  updateThumbnail(e3) {
    return this.id ? this.load().then(() => this.portal.signIn()).then(() => {
      ...
      if ("string" == typeof t)
        tt(t) ? r.query = { data: t } : r.query = { url: _(t) }, null != i && (r.query.filename = i);
      else {
  ...
  async fetchResources(e3 = {}, t) {
    const { fetchResources: i } = await import("./resourceUtils-LAKVJ55E.js");
    return i(this, e3, t);
  }
  async addResource(e3, t, i) {
    const { addOrUpdateResource: r } = await import("./resourceUtils-LAKVJ55E.js");
    return e3.portalItem = this, r(e3, "add", t, i);
  }
  async removeResource(e3, t) {
    const { removeResource: i } = await import("./resourceUtils-LAKVJ55E.js");
  ...
  async removeAllResources(e3) {
    const { removeAllResources: t } = await import("./resourceUtils-LAKVJ55E.js");
    return t(this, e3);
  }
  resourceFromPath(e3) {
...
//# sourceMappingURL=chunk-PCTUO7WS.js.map
