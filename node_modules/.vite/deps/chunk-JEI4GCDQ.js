...
function e2() {
  return n3 || (n3 = new Promise((t) => import("./i3s-DRSHUSHF.js").then((t2) => t2.i).then(({ default: e3 }) => {
...
async function d(s2) {
  ...
  if ("georeferenced" === y3.type) {
    const { projectBuffer: e3, initializeProjection: r } = await import("./projection-RPW7KQT6.js");
    await r(u2, m4), p3 = new Float64Array(f2.length), e3(f2, u2, 0, p3, m4, 0, p3.length / 3);
  } else {
    const { project: e3 } = await import("./georeference-MTKOKJSQ.js");
...
//# sourceMappingURL=chunk-JEI4GCDQ.js.map
