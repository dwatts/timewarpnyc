...
function t(t2) {
  return new n2({ getCollections: () => [t2.tables, t2.layers], getChildrenFunction: (e2) => {
    const t3 = [];
...
function l(e2, r, t2) {
  ...
  if (e2)
    for (let a3 = 0, i = e2.length; a3 < i; a3++) {
      if (s2 = e2.at(a3), (s2 == null ? void 0 : s2[r]) === t2)
        return s2;
      if ("group" === (s2 == null ? void 0 : s2.type) && (o = l(s2.layers, r, t2), o))
        return o;
    }
}
var d = (d2) => {
  let y2 = class extends d2 {
    constructor(...e2) {
      ...
      const t2 = (e3) => {
        ...
        e3.parent = this, this.layerAdded(e3), "elevation" !== e3.type && "base-elevation" !== e3.type || s.getLogger(this).error(`Layer 'title:${e3.title}, id:${e3.id}' of type '${e3.type}' is not supported as an operational layer and will therefore be ignored.`);
      }, a3 = (e3) => {
        e3.parent = null, this.layerRemoved(e3);
      };
      this.addHandles([this.layers.on("before-add", (e3) => t2(e3.item)), this.layers.on("after-add", (e3) => o(e3.item)), this.layers.on("after-remove", (e3) => a3(e3.item))]);
    }
    destroy() {
    ...
    findLayerById(e2) {
      return l(this.layers, "id", e2);
    }
    findLayerByUid(e2) {
      return l(this.layers, "uid", e2);
    }
    remove(e2) {
...
var l2 = (l3) => {
  let n4 = class extends l3 {
    constructor(...t2) {
      super(...t2), this.tables = new V(), this.addHandles([this.tables.on("after-add", (t3) => {
        const e2 = t3.item;
        e2.parent && e2.parent !== this && "tables" in e2.parent && e2.parent.tables.remove(e2), e2.parent = this, "feature" !== e2.type && s.getLogger(this).error(`Layer 'title:${e2.title}, id:${e2.id}' of type '${e2.type}' is not supported as a table and will therefore be ignored.`);
  ...
  return e([y()], n4.prototype, "tables", null), n4 = e([a("esri.support.TablesMixin")], n4), n4;
};
...
//# sourceMappingURL=chunk-WIM5ZT5B.js.map
