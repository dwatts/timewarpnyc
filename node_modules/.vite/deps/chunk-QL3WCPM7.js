...
import {
  O as O8,
  n as n13
} from "./chunk-K7N526Q4.js";
import {
  P as P6,
  a as a16
} from "./chunk-YIZLAUCA.js";
import {
  C as C5,
  et,
  it,
...
import {
  m as m4
} from "./chunk-N33CV3QM.js";
import {
  r as r20
} from "./chunk-FF3JARPY.js";
import {
  v as v3
...
import {
  a as a9,
  f as f9
} from "./chunk-6AGTIZBD.js";
import {
  g as g4
} from "./chunk-UT4ZWPHT.js";
import {
  c as c11,
  c2 as c12
...
var l18 = class {
  ...
  runTask(e32) {
    ...
    const n26 = t23.map((e33) => [e33.x, e33.y]), a26 = t23.reduce((e33, t24) => Math.min(e33, t24.minDemResolution), 1 / 0), l33 = new u3({ points: n26, spatialReference: this.spatialReference }), u23 = t23.length > 1 && t23.some((e33) => !!e33.signal) ? new AbortController() : null, h23 = null != u23 ? u23.signal : t23[0].signal;
    if (null != u23) {
      let e33 = 0;
  ...
  computeAttachmentOrigin(e32) {
    if (this.useObjectOriginAsAttachmentOrigin) {
      ...
      for (const i20 of this.stageObject.geometries)
        i20.computeAttachmentOrigin(S6) && (O(S6, S6, this.stageObject.shaderTransformation), u2(e32.render.origin, e32.render.origin, S6), e32.render.num++);
  }
...
var r23 = class {
  ...
  abortLoad() {
    null != this._abortController ? this._abortController = e3(this._abortController) : this._loadStatus === l19.LOADING && (this._loadStatus = l19.FAILED), this._loader = null;
  }
};
var l19;
!function(t23) {
...
h14.shader = new t14(m4, () => import("./LineCallout.glsl-P7KJCYKK.js"));
...
var re2 = class _re extends h13 {
  ...
  async _prepareResourcesCIM(e32, t23, r38) {
    ...
    if (!this._context.sharedResources.cimSymbolRasterizer) {
      const e33 = (await import("./CIMSymbolRasterizer-THG73WWG.js")).CIMSymbolRasterizer;
...
var ye2 = class extends h13 {
  ...
  _convertTextureTransform(e32) {
    ...
    return { scale: r38, offset: o27, rotation: M2(a26) };
  }
    ...
    for (let p19 = 0; p19 < r38; p19++) {
      ...
      for (let t24 = 0; t24 < u24.length; t24++) {
        ...
        if (s27.push(s27.length), s27.push(s27.length), t24 % 3 == 0) {
          this._calculateFaceNormal(m16, u24, t24, je2), this._getFaceVertices(m16, u24, t24, Oe, we, Me), u2(Oe, Oe, we), u2(Oe, Oe, Me), g(Oe, Oe, 1 / 3);
  ...
  _createComponentNormalsSmooth(e32, t23) {
    ...
    for (let n26 = 0; n26 < t23.length; n26 += 3) {
      ...
      for (let e33 = 0; e33 < 3; e33++) {
        ...
        let s27 = r38[a27];
        s27 || (s27 = { normal: n2(), count: 0 }, r38[a27] = s27), u2(s27.normal, s27.normal, o28), s27.count++;
      }
    }
...
var f20 = class {
  ...
  _shrink() {
    const t23 = Math.max(u18, Math.floor(this._capacity * e2));
    this._resize(t23);
  }
  _resize(t23) {
...
e([y({ constructOnly: true })], y8.prototype, "shaderTransformation", void 0), e([y()], y8.prototype, "_size", void 0), e([y({ readOnly: true })], y8.prototype, "size", null), y8 = e([a2("esri.views.3d.webgl-engine.lib.lodRendering.InstanceData")], y8);
var w6 = n2();
var D3 = e11();
var V5 = e12();
var H4 = e12();
...
var a22 = class _a {
  static async create(e32, r38, i20) {
    ...
    if (a3(i20) || c34.length !== s27.length) {
...
var q6 = class extends m2 {
  ...
  async initializeRenderContext(e32, t23) {
    ...
    if (a3(t23) || o27.length !== s27.length) {
  ...
  _computeAnchor(e32, t23, s27) {
    ...
    switch (s27.anchor) {
      ...
      case "relative": {
        ...
        c4(r38, i20, o27), u2(r38, r38, t24), j(r38, r38);
        break;
      }
      default:
...
function l29(t23, r38) {
  ...
  for (let p19 = 1; p19 < v13; ++p19) {
    M12 = t23.vertices[p19], u2(q10, M12.vLeft, M12.vRight);
    let r39 = s4(q10);
...
var L6 = class {
  ...
  setFrameFromUpVector(t23) {
    r4(this.frame.up, t23), u2(I13, this.vLeft, this.vRight), z(I13, I13), g(y10, this.frame.up, P(I13, this.frame.up)), e6(D4, I13, y10), z(D4, D4), _(this.frame.right, D4, this.frame.up);
  }
  get foldingAngle() {
...
var b11 = class extends L6 {
  ...
  get rotationRight() {
    ...
    return g(k5, this.frame.up, -i20), g(x8, this.frame.right, s27), u2(k5, k5, x8), z(k5, k5), A10(U2, this.frame, k5), U2;
  }
  get rotationAngle() {
...
E12.shader = new t14(O8, () => import("./Path.glsl-OD7JZUZJ.js"));
...
function j10(t23, s27, c34, i20, f25 = 1) {
  ...
  const I16 = P(k6, E13);
  z4(P11, y11[0], y11[1], I16, Y4, _12, k6), z4(v9, A11[0], y11[1], I16, Y4, _12, k6), z4(x9, y11[0], A11[1], I16, Y4, _12, k6), e6(v9, v9, P11), g(v9, v9, 0.5), e6(x9, x9, P11), g(x9, x9, 0.5), u2(P11, P11, v9), u2(P11, P11, x9);
...
j11.shader = new t14(P6, () => import("./Pattern.glsl-KIMGFVBC.js"));
...
function j12(r38, c34, u23, o27) {
  ...
  return u2(r38, c34, g(r38, u23, s27));
}
...
var N6 = class {
  ...
  update(t23, e32, i20, r38 = true) {
    ...
    this._toRenderBoundingExtent(t23, e32, i20), u2(this._center.origin, a26[0].origin, a26[2].origin), g(this._center.origin, this._center.origin, 0.5), this._renderCoordsHelper.worldUpAtPosition(this._center.origin, this._center.direction), r38 || g(this._center.direction, this._center.direction, -1);
    for (let n26 = 0; n26 < 4; n26++) {
      const t24 = a26[n26];
      this._renderCoordsHelper.worldUpAtPosition(t24.origin, t24.direction);
      const e33 = a26[3 === n26 ? 0 : n26 + 1];
      t24.cap.next = e33.origin, H2(t24.cap.direction, t24.origin, e33.origin), P3(t24.direction, t24.cap.direction, t24.origin, this._planes[n26]), r38 || g(t24.direction, t24.direction, -1);
    }
...
//# sourceMappingURL=chunk-QL3WCPM7.js.map
