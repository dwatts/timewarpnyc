...
var D;
var U;
var b = { PortalGroup: () => import("./PortalGroup-IK3QVEIZ.js"), PortalItem: () => import("./PortalItem-USGRUAYU.js"), PortalUser: () => import("./PortalUser-NFXTKWFW.js") };
var Q = D = class extends u(_) {
  ...
  load(e3) {
    const t2 = import("./Basemap-2HSVALSM.js").then(({ default: t3 }) => {
      s3(e3), U = t3;
  ...
  async createElevationLayers() {
    await this.load();
    const e3 = this._getHelperService("defaultElevationLayers"), t2 = (await import("./ElevationLayer-53N2NCCR.js")).default;
  ...
  fetchCategorySchema(e3) {
    return this.hasCategorySchema ? this.request(this.restUrl + "/portals/self/categorySchema", e3).then((e4) => e4.categorySchema) : a2(e3) ? Promise.reject(c()) : Promise.resolve([]);
  }
  fetchFeaturedGroups(e3) {
    ...
    return a2(e3) ? Promise.reject(c()) : Promise.resolve([]);
  }
  fetchRegions(e3) {
    var _a;
...
//# sourceMappingURL=chunk-UNJDKTFU.js.map
