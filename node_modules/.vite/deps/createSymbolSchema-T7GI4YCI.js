...
function m(n, o2, i2) {
  ...
  if (p.push({ materialKey: h2, hash: y2.hash(), ...l(y2) }), u) {
    ...
    u.color = u.color ?? y2.color, p.push({ materialKey: r, hash: u.hash(), lineWidth: y2.width, ...l(u) });
  }
...
export {
  o as createSymbolSchema
};
//# sourceMappingURL=createSymbolSchema-T7GI4YCI.js.map
