  ...
  "async" === n.mode && (n.functions.disjoint = function(t4, e3) {
    ...
    return n.standardFunctionAsync(t4, e3, async (n2, r2, i) => {
      ...
      if (o = true === o || false === o ? "" : oe(o), 0 === i.length || i[0] instanceof t2) {
        let n3 = null;
        n3 = t4.services && t4.services.portal ? t4.services.portal : j2.getDefault(), i.length > 0 && (n3 = t3(i[0], n3));
      ...
      if (V(i[0]) && (u3 = i[0]), u3) {
        ...
        let e4 = null;
        e4 = t4.services && t4.services.portal ? t4.services.portal : j2.getDefault(), e4 = t3(new t2(n3), e4);
...
//# sourceMappingURL=chunk-32Z4LRQC.js.map
