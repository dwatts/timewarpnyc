...
function u(e2) {
  ...
  if ("equal-interval" === n2)
    ...
    if (0 === t3)
      c2.push({ minValue: b2[0], maxValue: b2[0], label: s3(b2[0], b2[0], a4) });
    else {
      ...
      for (let t4 = 1; t4 <= i2; t4++)
        r2 = u3 === 2 * i2 ? p : l3(e3 + (t4 + 0.5) * n3, 6), c2.push({ minValue: o3, maxValue: r2, label: s3(o3, r2, a4) }), o3 = r2, u3++;
    }
...
function r(e2, t2, l4) {
  ...
  l4 > n2 && (l4 = n2);
  for (let s4 = 0; s4 < l4; s4++)
    a4.push(Math.round(s4 * n2 / l4 - 1));
  a4.push(n2 - 1);
...
function i(e2, t2, l4, n2) {
  ...
  for (; h2 || o3 < f2; ) {
    ...
    for (let t3 = 0; t3 < n2; t3++)
      a4.push(e2[t3]);
    for (let l5 = 0; l5 < n2; l5++)
      for (let a5 = e2[l5] + 1; a5 <= e2[l5 + 1]; a5++)
        if (c2 = t2[a5], l5 > 0 && a5 !== e2[l5 + 1] && Math.abs(c2 - r2[l5]) > Math.abs(c2 - r2[l5 - 1]))
          e2[l5] = a5;
...
//# sourceMappingURL=chunk-YZ24SAPZ.js.map
