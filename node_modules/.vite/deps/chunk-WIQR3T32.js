...
e([y({ type: String, json: { write: true } })], p.prototype, "name", void 0), e([y({ type: [String, Number], json: { write: true } })], p.prototype, "code", void 0), p = t = e([a2("esri.layers.support.CodedValue")], p);
...
e([y({ type: String, json: { write: true } })], a3.prototype, "name", void 0), e([o2(c)], a3.prototype, "type", void 0), a3 = e([a2("esri.layers.support.Domain")], a3);
var i2 = a3;
...
e([y({ type: [p], json: { write: true } })], p2.prototype, "codedValues", void 0), e([o2({ codedValue: "coded-value" })], p2.prototype, "type", void 0), p2 = d = e([a2("esri.layers.support.CodedValueDomain")], p2);
var u = p2;
...
e([o2({ inherited: "inherited" })], i3.prototype, "type", void 0), i3 = t2 = e([a2("esri.layers.support.InheritedDomain")], i3);
var p3 = i3;
...
}, target: "range", writer(e2, r, a4) {
  r[a4] = [this.minValue || 0, e2];
} } } })], n.prototype, "maxValue", void 0), e([y({ type: Number, json: { type: [Number], read: { source: "range", reader: (e2, r) => r.range && r.range[0] }, write: { target: "range", writer(e2, r, a4) {
  r[a4] = [e2, this.maxValue || 0];
} } } })], n.prototype, "minValue", void 0), e([o2({ range: "range" })], n.prototype, "type", void 0), n = s2 = e([a2("esri.layers.support.RangeDomain")], n);
var i4 = n;

// node_modules/@arcgis/core/layers/support/domains.js
var n2 = { key: "type", base: i2, typeMap: { range: i4, "coded-value": u, inherited: p3 } };
function i5(r) {
  if (!r || !r.type)
    return null;
  switch (r.type) {
...
//# sourceMappingURL=chunk-WIQR3T32.js.map
