...
var o = class {
  constructor() {
    this._indexInvalid = false, this._boundsToLoad = [], this._boundsById = /* @__PURE__ */ new Map(), this._idByBounds = /* @__PURE__ */ new Map(), this._index = new h(9, has("esri-csp-restrictions") ? (i) => ({ minX: i[0], minY: i[1], maxX: i[2], maxY: i[3] }) : ["[0]", "[1]", "[2]", "[3]"]), this._loadIndex = () => {
  ...
  get fullBounds() {
    if (!this._boundsById.size)
      return null;
    const i = C();
    for (const s of this._boundsById.values())
      s && (i[0] = Math.min(s[0], i[0]), i[1] = Math.min(s[1], i[1]), i[2] = Math.max(s[2], i[2]), i[3] = Math.max(s[3], i[3]));
    return i;
  }
  get valid() {
...
//# sourceMappingURL=chunk-3LR4MDXK.js.map
