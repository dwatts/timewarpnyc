...
import {
  m as m3,
  p as p3
} from "./chunk-3VYBBKPH.js";
import {
  m as m2
} from "./chunk-DDU77THI.js";
import {
  l as l4
...
async function c3(e7, r4, n2) {
  const { source: o4 } = r4, { loadGLTFMesh: i3 } = await p(import("./loadGLTFMesh-ORBBAQMJ.js"), n2), a7 = await f4(o4, n2);
  s3(n2);
...
e([y()], p7.prototype, "externalSources", void 0), e([y()], p7.prototype, "displaySource", null), e([y()], p7.prototype, "_implicitDisplaySource", null), e([y()], p7.prototype, "_explicitDisplaySource", void 0), p7 = e([a("esri.geometry.support.meshUtils.Metadata")], p7);
...
var N2 = B = class extends a3(_.LoadableMixin(m(p2))) {
  ...
  async toBinaryGLTF(e7) {
    const t = import("./gltfexport-W4NGCYPX.js"), r4 = this.load(), o4 = await Promise.all([t, r4]), { toBinaryGLTF: s4 } = o4[0];
    return s4(this, e7);
  }
  get memoryUsage() {
    let e7 = 0;
  ...
  static async createFromGLTF(e7, r4, o4) {
    ...
    const { loadGLTFMesh: n2 } = await p(import("./loadGLTFMesh-ORBBAQMJ.js"), o4);
...
e([y({ type: [g4], json: { write: true } })], N2.prototype, "components", void 0), e([y({ nonNullable: true, types: D3, constructOnly: true, json: { write: true } })], N2.prototype, "vertexSpace", void 0), e([y({ type: N, json: { write: true } })], N2.prototype, "transform", void 0), e([y({ constructOnly: true })], N2.prototype, "metadata", void 0), e([y()], N2.prototype, "hasExtent", null), e([y()], N2.prototype, "_transformedExtent", null), e([y()], N2.prototype, "_untransformedExtent", null), e([y()], N2.prototype, "anchor", null), e([y()], N2.prototype, "origin", null), e([y({ readOnly: true, json: { read: false } })], N2.prototype, "extent", null), e([y({ readOnly: true, json: { read: false, write: true, default: true } })], N2.prototype, "hasZ", void 0), e([y({ readOnly: true, json: { read: false, write: true, default: false } })], N2.prototype, "hasM", void 0), e([y({ type: p4, nonNullable: true, json: { write: true } })], N2.prototype, "vertexAttributes", void 0), N2 = B = e([a(k3)], N2);
var Z2 = n();
var H = h();
var I3 = N2;
...
function y6(t, r4, o4) {
  ...
  if (s4.geometryType = "mesh", !o4.assetMaps)
    return s4;
  const i3 = M4(r4, o4.assetMaps), u5 = t.sourceSpatialReference ?? f.WGS84, c5 = o4.globalIdFieldName, { outFields: f6 } = t, m9 = null != f6 && f6.length > 0 ? E3(f6.includes("*") ? null : new Set(f6)) : () => ({});
  for (const a7 of n2) {
...
//# sourceMappingURL=chunk-5GTBTJ5J.js.map
