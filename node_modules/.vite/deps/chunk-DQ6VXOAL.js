...
var c = { maxSearchSteps: 8, maxDistanceAreaTex: 16 };
function x() {
  const x2 = new i(), { attributes: d2, varyings: a, vertex: i2, fragment: n2 } = x2;
  return d2.add(O.POSITION, "vec2"), a.add("uv", "vec2"), a.add("offsets[2]", "vec4"), a.add("maxOffset", "vec4"), a.add("pixelCoord", "vec2"), n(i2), i2.code.add(o`
      void main() {
        ...
        maxOffset = vec4( offsets[0].xz, offsets[1].yw ) + vec4( -2.0, 2.0, -2.0, 2.0 ) * resolution.xxyy * float( ${o.int(c.maxSearchSteps)} );
      }
    `), n2.uniforms.add(new s("edgesTexture", (e) => e.edges.colorTexture)), n2.uniforms.add(new s("areaTexture", (e) => e.areaTexture)), n2.uniforms.add(new s("searchTexture", (e) => e.searchTexture)), n(n2), n2.code.add(o`
      ...
      float searchXLeft( sampler2D edgesTex, sampler2D searchTex, vec2 texcoord, float end ) {
        vec2 e = vec2( 0.0, 1.0 );
        for ( int i = 0; i < ${o.int(c.maxSearchSteps)}; i ++ ) {
      ...
      vec2 getArea( sampler2D areaTex, vec2 dist, float e1, float e2, float offset ) {
        vec2 texcoord = float( ${o.int(c.maxDistanceAreaTex)} ) * round( 4.0 * vec2( e1, e2 ) ) + dist;
...
var d = Object.freeze(Object.defineProperty({ __proto__: null, build: x }, Symbol.toStringTag, { value: "Module" }));

export {
  x,
  d
};
//# sourceMappingURL=chunk-DQ6VXOAL.js.map
