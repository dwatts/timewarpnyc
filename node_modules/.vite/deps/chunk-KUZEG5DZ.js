...
async function t(t2, i, n) {
  ...
  if (s3 && "unique-value" === s3.type && s3.styleOrigin) {
    ...
    if (s2(n), false === a.ok) {
      const e = a.error;
      i && i.messages && i.messages.push(new s("renderer:style-reference", `Failed to create unique value renderer from style reference: ${e.message}`, { error: e, context: i })), t2.clear("renderer", i == null ? void 0 : i.origin);
    }
  }
}
...
//# sourceMappingURL=chunk-KUZEG5DZ.js.map
