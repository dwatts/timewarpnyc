...
function a2(o2, t2, r2) {
  if (null == o2)
    return null;
  const { context: l3, isLabelSymbol: i4 } = r2, a4 = l3 == null ? void 0 : l3.origin, b5 = l3 == null ? void 0 : l3.messages;
  if ("web-scene" === a4 && !m3(o2)) {
  ...
  return ("web-map" === a4 || "portal-item" === a4 && !o(l3 == null ? void 0 : l3.layer)) && m3(o2) ? (b5 == null ? void 0 : b5.push(new s("symbol:unsupported", `Symbols of type '${o2.declaredClass}' are not supported in web maps and portal items. Use 2D symbology and CIMSymbol instead when working with MapView`, { symbol: o2, context: l3 })), null) : o2.write(t2, l3);
}
function b3(e2, n3) {
...
var a3 = () => !!has("enable-feature:direct-3d-object-feature-layer-display");
...
function i3(e2, t2, r2) {
  const o2 = null != t2.portal ? t2.portal : j2.getDefault();
  let s2;
  const l3 = `${o2.url} - ${o2.user && o2.user.username} - ${e2}`;
  return u2[l3] || (u2[l3] = y2(e2, o2, r2).then((e3) => (s2 = e3, e3.fetchData())).then((t3) => ({ data: t3, baseUrl: s2.itemUrl ?? "", styleName: e2 }))), u2[l3];
}
function y2(e2, r2, o2) {
  return r2.load(o2).then(() => {
    const t2 = new c({ disableExtraQuery: true, query: `owner:${h2} AND type:${j3} AND typekeywords:"${e2}"` });
    return r2.queryItems(t2, o2);
  }).then(({ results: r3 }) => {
    var _a;
    let s2 = null;
...
function c4(e2, r2, o2) {
  return e2 && null != e2.styleUrl ? f2(e2.styleUrl, o2) : e2 && null != e2.styleName ? i3(e2.styleName, r2, o2) : Promise.reject(new s("symbolstyleutils:style-url-and-name-missing", "Either styleUrl or styleName is required to resolve a style"));
}
function p(e2) {
...
function b4(t2, r2) {
  const s2 = { responseType: "json", query: { f: "json" }, ...r2 };
  return j(K(t2), s2);
}
var h2 = "esri_en";
var j3 = "Style";
...
//# sourceMappingURL=chunk-7BMUKKBX.js.map
