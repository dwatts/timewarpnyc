...
async function n(n2, p2 = n2.popupTemplate) {
  ...
  if (null == p2)
    return [];
  const t2 = await p2.getRequiredFields(n2.fieldsIndex), { lastEditInfoEnabled: u } = p2, { objectIdField: d, typeIdField: i, globalIdField: s, relationships: a } = n2;
  if (t2.includes("*"))
    return ["*"];
  const o = u ? await C(n2) : [], f = g(n2.fieldsIndex, [...t2, ...o]);
...
//# sourceMappingURL=chunk-3FVFBGNT.js.map
