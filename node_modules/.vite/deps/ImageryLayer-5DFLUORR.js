...
import {
  n as n4,
  s as s8
} from "./chunk-K44N6VAT.js";
import {
  s as s9
} from "./chunk-AKJZJRZF.js";
import "./chunk-RVL4XTXD.js";
import {
  G,
  I2 as I,
  L2,
...
function w2(e4, t6) {
  ...
  const l11 = R[n3.toJSON(e4.stretchType)], c15 = "u8", m7 = { StretchType: l11, Statistics: N2(e4.statistics ?? []), DRA: e4.dynamicRangeAdjustment, UseGamma: e4.useGamma, Gamma: e4.gamma, ComputeGamma: e4.computeGamma };
...
async function y5(t6, r3, s10) {
  const i6 = f4(t6), m7 = r3.geometry ? [r3.geometry] : [], u8 = await b3(m7), c15 = r3.toJSON();
  g3(c15);
  const l11 = u8 && u8[0];
...
async function S3(e4, s10, i6) {
  ...
  const u8 = f4(e4), c15 = s4({ ...u8.query, f: "json", ...m7 }), l11 = i(c15, i6), { data: f7 } = await j3(`${u8.path}/computeAngles`, l11);
...
async function d5(e4, r3, s10) {
  ...
  const u8 = f4(e4), l11 = s4({ ...u8.query, f: "json", ...i6 }), f7 = i(l11, s10), { data: p15 } = await j3(`${u8.path}/computePixelLocation`, f7);
  return p10.fromJSON(p15);
}
async function N3(e4, o3, a13) {
  const r3 = await y5(e4, o3, a13), s10 = f4(e4), { data: i6 } = await j3(`${s10.path}/computeStatisticsHistograms`, r3), { statistics: m7 } = i6;
...
async function R2(e4, o3, a13) {
  const r3 = await y5(e4, o3, a13), s10 = f4(e4), { data: i6 } = await j3(`${s10.path}/computeHistograms`, r3);
...
async function J(r3, s10, i6) {
  ...
  const u8 = await b3(s10.geometry), c15 = u8 == null ? void 0 : u8[0];
  null != c15 && (m7.geometry = c15.toJSON());
  const l11 = f4(r3), p15 = s4({ ...l11.query, f: "json", ...m7 }), y11 = i(p15, i6), { data: S4 } = await j3(`${l11.path}/getSamples`, y11), d8 = (_b = S4 == null ? void 0 : S4.samples) == null ? void 0 : _b.map((t6) => {
...
async function C2(r3, s10, i6, m7) {
  const u8 = f4(r3), c15 = await b3(i6), l11 = s10.toJSON();
  null != c15[0] && (l11.fromGeometry = JSON.stringify(q2(c15[0]))), null != c15[1] && (l11.toGeometry = JSON.stringify(q2(c15[1])));
  const f7 = s4({ ...u8.query, f: "json", ...l11 }), p15 = i(f7, m7), { data: g5 } = await j3(u8.path + "/measure", p15);
  return g5;
}
function q2(t6) {
  var _a;
...
async function n7(n9, m7, p15) {
  var _a, _b;
  const f7 = f4(n9), u8 = s4({ ...f7 == null ? void 0 : f7.query, f: "json" }), h6 = i(u8, p15), d8 = `${f7 == null ? void 0 : f7.path}/${m7}/info`, c15 = j3(`${d8}`, h6), g5 = j3(`${d8}/keyProperties`, h6), x3 = await Promise.allSettled([c15, g5]), y11 = "fulfilled" === x3[0].status ? x3[0].value.data : null, v5 = "fulfilled" === x3[1].status ? x3[1].value.data : null;
  let P2 = null;
  ((_a = y11.statistics) == null ? void 0 : _a.length) && (P2 = y11.statistics.map((e4) => ({ min: e4[0], max: e4[1], avg: e4[2], stddev: e4[3] })));
  const S4 = M.fromJSON(y11.extent), j9 = Math.ceil(S4.width / y11.pixelSizeX - 0.1), w4 = Math.ceil(S4.height / y11.pixelSizeY - 0.1), b6 = S4.spatialReference, k3 = new x({ x: y11.pixelSizeX, y: y11.pixelSizeY, spatialReference: b6 }), z = ((_b = y11.histograms) == null ? void 0 : _b.length) ? y11.histograms : null, L4 = new n2({ origin: y11.origin, blockWidth: y11.blockWidth, blockHeight: y11.blockHeight, firstPyramidLevel: y11.firstPyramidLevel, maximumPyramidLevel: y11.maxPyramidLevel });
...
var je = (d8) => {
  let y11 = class extends d8 {
    ...
    async computeHistograms(e4, t6) {
      ...
      return e4 = v(h, e4).clone(), this._applyMosaicAndRenderingRules(e4), R2(this.url, e4, this._getRequestOptions(t6));
    }
    async computeStatisticsHistograms(e4, t6) {
      ...
      return e4 = v(h, e4).clone(), this._applyMosaicAndRenderingRules(e4), N3(this.url, e4, this._getRequestOptions(t6));
    }
    ...
    async fetchImage(e4, t6, r3, i6 = {}) {
      ...
      if (null == s10) {
        ...
        for (let e5 = 0; e5 < o4; e5++)
          u8.push(u3.createEmptyBand(l12, a13));
        return { pixelData: { pixelBlock: new u3({ width: t6, height: r3, pixels: u8, mask: new Uint8Array(a13), pixelType: l12 }), extent: e4 } };
      }
    ...
    fetchKeyProperties(e4) {
      return j3(je2(this.parsedUrl) + "/keyProperties", { query: this._getQueryParams({ renderingRule: this.version >= 10.3 ? e4 == null ? void 0 : e4.rasterFunction : null }) }).then((e5) => e5.data);
    }
    fetchRasterAttributeTable(e4) {
      return this.version < 10.1 ? Promise.reject(new s2("#fetchRasterAttributeTable()", "Failed to get rasterAttributeTable")) : j3(je2(this.parsedUrl) + "/rasterAttributeTable", { query: this._getQueryParams({ renderingRule: this.version >= 10.3 ? e4 == null ? void 0 : e4.rasterFunction : null }) }).then((e5) => d.fromJSON(e5.data));
    }
    ...
    async getCatalogItemICSInfo(e4, t6) {
      var _a, _b, _c;
      const { data: r3 } = await j3(je2(this.parsedUrl) + "/" + e4 + "/info/ics", { query: this._getQueryParams(), ...t6 }), i6 = r3 && r3.ics;
      if (!i6)
        return;
      let s10 = null;
      try {
        s10 = (await j3(je2(this.parsedUrl) + "/" + e4 + "/info", { query: this._getQueryParams(), ...t6 })).data.extent;
      } catch {
      }
      if (!s10 || !s10.spatialReference)
        return { ics: i6, icsToPixelTransform: null, icsExtent: null, northDirection: null };
      const o3 = this.version >= 10.7 ? j3(je2(this.parsedUrl) + "/" + e4 + "/info/icstopixel", { query: this._getQueryParams(), ...t6 }).then((e5) => e5.data).catch(() => ({})) : {}, a13 = s10.spatialReference, l11 = { geometries: JSON.stringify({ geometryType: "esriGeometryEnvelope", geometries: [s10] }), inSR: a13.wkid || JSON.stringify(a13), outSR: "0:" + e4 }, u8 = j3(je2(this.parsedUrl) + "/project", { query: this._getQueryParams(l11), ...t6 }).then((e5) => e5.data).catch(() => ({})), p15 = 5, c15 = (s10.xmin + s10.xmax) / 2, m7 = (s10.ymax - s10.ymin) / (p15 + 1), d9 = s10.ymin + m7, h6 = [];
      for (let n9 = 0; n9 < p15; n9++)
        h6.push({ x: c15, y: d9 + m7 * n9 });
      const f7 = { geometries: JSON.stringify({ geometryType: "esriGeometryPoint", geometries: h6 }), inSR: a13.wkid || JSON.stringify(a13), outSR: "0:" + e4 }, y12 = j3(je2(this.parsedUrl) + "/project", { query: this._getQueryParams(f7), ...t6 }).then((e5) => e5.data).catch(() => ({})), g5 = await Promise.all([o3, u8, y12]);
      let R3 = g5[0].ipxf;
      if (null == R3) {
    ...
    async queryRasters(e4, t6) {
      return { query: e4, requestOptions: t6 } = await this._prepareForQuery(e4, t6), s9(this.url, e4, t6);
    }
    async queryObjectIds(e4, t6) {
      return { query: e4, requestOptions: t6 } = await this._prepareForQuery(e4, t6), s8(this.url, e4, t6);
    }
    async queryRasterCount(e4, t6) {
      return { query: e4, requestOptions: t6 } = await this._prepareForQuery(e4, t6), n4(this.url, e4, t6);
    }
    async queryVisibleRasters(e4, t6) {
      ...
      try {
        ...
        }), d10 = new b4({ objectIds: c16, returnGeometry: true, outSpatialReference: e4.outSpatialReference, outFields: [l12] }), h7 = await this.queryRasters(d10);
        return ((_d = h7 == null ? void 0 : h7.features) == null ? void 0 : _d.length) && h7.features.forEach((t7) => {
          p16.forEach((r5) => {
            r5.attributes[l12] === t7.attributes[l12] && (r5.geometry = new j2(t7.geometry), null != e4.outSpatialReference && (r5.geometry.spatialReference = e4.outSpatialReference));
          });
    ...
    async fetchVariableStatisticsHistograms(e4, t6) {
      const r3 = j3(je2(this.parsedUrl) + "/statistics", { query: this._getQueryParams({ variable: e4 }), signal: t6 }).then((e5) => {
        var _a;
        return (_a = e5.data) == null ? void 0 : _a.statistics;
      }), i6 = j3(je2(this.parsedUrl) + "/histograms", { query: this._getQueryParams({ variable: e4 }), signal: t6 }).then((e5) => {
        var _a;
    ...
    async createFlowMesh(e4, t6) {
      ...
      return r3 ? r3.createFlowMesh(e4, t6) : s7(e4.meshType, e4.simulationSettings, e4.flowData, null != t6.signal ? t6.signal : new AbortController().signal);
    }
    ...
    async _prepareForQuery(e4, t6) {
      ...
      return e4 = null != e4 ? v(b4, e4) : this.createQuery(), t6 = this._getRequestOptions(t6), this.raster && (t6.query = { ...t6.query, raster: this.raster }), { query: e4, requestOptions: t6 };
    }
    ...
    async _fetchServiceInfo(e4) {
      ...
      if (!t6) {
        const { data: r3, ssl: i6 } = await j3(je2(this.parsedUrl), { query: this._getQueryParams(), signal: e4 });
    ...
    _configRenderer(e4) {
      ...
      if (!t6 && !this.pixelFilter || this._isVectorDataSet()) {
        ...
        e4 || (e4 = k(r3, { bandIds: this.bandIds, variableName: this.rasterFunction ? null : (_b = (_a = this.mosaicRule) == null ? void 0 : _a.multidimensionalDefinition) == null ? void 0 : _b[0].variableName }));
    ...
    async _getRasterFunctionInfos(e4) {
      ...
      if (t6 && this.version >= 10.3) {
        if (1 === t6.length && "none" === t6[0].name.toLowerCase())
          return t6;
        const r3 = await j3(je2(this.parsedUrl) + "/rasterFunctionInfos", { query: this._getQueryParams(), signal: e4 });
    ...
    async _requestArrayBuffer(e4) {
      ...
      if (r3 && this._canRequestImageElement(t6.format)) {
        const r4 = `${je2(this.parsedUrl)}/exportImage`, { data: o4 } = await j3(r4, { responseType: i6 ? "blob" : "image", query: this._getQueryParams({ f: "image", ...this.refreshParameters, ...e4.imageServiceParameters }), signal: s10 });
        if (o4 instanceof Blob) {
          return { imageBitmap: await t3(o4, r4, s10), params: t6 };
        }
        return { imageOrCanvasElement: o4, params: t6 };
      }
      const o3 = this._initJobHandler(), l11 = j3(je2(this.parsedUrl) + "/exportImage", { responseType: "array-buffer", query: this._getQueryParams({ f: "image", ...e4.imageServiceParameters }), signal: s10 }), u8 = (await Promise.all([l11, o3]))[0].data, p15 = t6.format || "jpgpng";
      let c15 = p15;
    ...
    _processVisibleRastersResponse(e4, r3) {
      ...
      if (i6 && !u8 && !m7) {
        const e5 = {};
        e5[c15] = 0;
        p15 = [i6], u8 = [new h2(this.fullExtent, null, e5)];
      }
      if (!u8)
        return [];
      let h6, f7, y12;
    ...
    _updateFeatureWithMagDirValues(e4, t6) {
      if (!this._isVectorDataSet())
        return;
      const r3 = t6.split(/,\s*/).map((e5) => parseFloat(e5)), i6 = r3.map((e5) => [e5]), s10 = r3.map((e5) => ({ minValue: e5, maxValue: e5, noDataValue: null })), n9 = new u3({ height: 1, width: 1, pixelType: "f32", pixels: i6, statistics: s10 });
      null != this.pixelFilter && this.pixelFilter({ pixelBlock: n9, extent: new M(0, 0, 0, 0, this.spatialReference) });
      const o3 = "esriImageServiceDataTypeVector-MagDir" === this.serviceDataType ? [n9.pixels[0][0], n9.pixels[1][0]] : l3([n9.pixels[0][0], n9.pixels[1][0]]);
    ...
    _applyMosaicAndRenderingRules(e4) {
      ...
      i6 && e4 instanceof h && null == e4.rasterFunction && (e4.rasterFunction = i6), r3 && null == e4.mosaicRule && (e4.mosaicRule = r3), t6 && null == e4.raster && (e4.raster = t6);
    }
...
var I3 = class extends a4(a5(t2(c3(j4(je(p3(o2(l4(O(b)))))))))) {
  ...
  createPopupTemplate(e4) {
    ...
    return s10 && o3.add("raster.magnitude").add("raster.direction"), p4({ fields: r3, title: t6 }, { ...e4, visibleFieldNames: o3 });
  }
  queryFeatures(e4, r3) {
...
e([y(c2)], I3.prototype, "legendEnabled", void 0), e([y({ type: ["show", "hide"] })], I3.prototype, "listMode", void 0), e([y({ type: Boolean, json: { read: false, write: { enabled: true, overridePolicy: () => ({ enabled: false }) } } })], I3.prototype, "isReference", void 0), e([y({ type: ["ArcGISImageServiceLayer"], json: { origins: { "web-map": { type: ["ArcGISImageServiceLayer", "ArcGISImageServiceVectorLayer"], read: false, write: { target: "layerType", ignoreOrigin: true } } } } })], I3.prototype, "operationalLayerType", void 0), e([r("web-map", "operationalLayerType")], I3.prototype, "writeOperationalLayerType", null), e([y(p2)], I3.prototype, "popupEnabled", void 0), e([y({ type: k2, json: { read: { source: "popupInfo" }, write: { target: "popupInfo" } } })], I3.prototype, "popupTemplate", void 0), e([y({ readOnly: true })], I3.prototype, "defaultPopupTemplate", null), e([y({ readOnly: true, json: { read: false } })], I3.prototype, "type", void 0), I3 = e([a3("esri.layers.ImageryLayer")], I3);
var L3 = I3;
export {
  L3 as default
};
//# sourceMappingURL=ImageryLayer-5DFLUORR.js.map
