...
function n(t, e, s2) {
  const n2 = L.SIZE_FIELD_STOPS | L.SIZE_MINMAX_VALUE | L.SIZE_SCALE_STOPS | L.SIZE_UNIT_VALUE, o2 = (e & (A.FIELD_TARGETS_OUTLINE | A.MINMAX_TARGETS_OUTLINE | A.SCALE_TARGETS_OUTLINE | A.UNIT_TARGETS_OUTLINE)) >>> 4;
  return t === E.LINE && s2.isOutline || t === E.FILL && _(s2.symbologyType) ? n2 & o2 : n2 & ~o2;
}
var o = 0;
var v = 8;
var l = 7;
...
var U = class {
  ...
  get symbologyType() {
    return this.bits(E2, L2);
  }
  set symbologyType(t) {
    this.setBits(t, E2, L2);
  }
...
var F = (t) => class extends t {
  ...
  setVV(t2, e) {
    ...
    this.vvSizeMinMaxValue = !!(s2 & L.SIZE_MINMAX_VALUE), this.vvSizeFieldStops = !!(s2 & L.SIZE_FIELD_STOPS), this.vvSizeUnitValue = !!(s2 & L.SIZE_UNIT_VALUE), this.vvSizeScaleStops = !!(s2 & L.SIZE_SCALE_STOPS);
  }
};
var x = (t) => class extends t {
  ...
  setVV(t2, e) {
    super.setVV(t2, e), this.vvRotation = !e.isOutline && !!(t2 & L.ROTATION);
  }
};
var B = (t) => class extends t {
  ...
  setVV(t2, e) {
    super.setVV(t2, e), this.vvColor = !e.isOutline && !!(t2 & L.COLOR);
  }
};
var R = (t) => class extends t {
  ...
  setVV(t2, e) {
    super.setVV(t2, e), this.vvOpacity = !e.isOutline && !!(t2 & L.OPACITY);
  }
};
...
//# sourceMappingURL=chunk-SI6VNZBP.js.map
