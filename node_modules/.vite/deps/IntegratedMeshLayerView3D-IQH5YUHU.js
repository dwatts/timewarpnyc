...
// node_modules/@arcgis/core/views/3d/layers/IntegratedMeshLayerView3D.js
var c = 0.2;
var d2 = class extends xt(n(d)) {
  constructor() {
    super(...arguments), this.type = "integrated-mesh-3d", this._elevationContext = "im", this._isIntegratedMesh = true, this._supportsLabeling = false, this.drapeTargetType = t2.WithoutRasterImage;
  }
  get i3slayer() {
    return this.layer;
  }
  ...
  get lodFactor() {
    var _a, _b, _c, _d;
    return ((_d = (_c = (_b = (_a = this.view) == null ? void 0 : _a.qualitySettings) == null ? void 0 : _b.sceneService) == null ? void 0 : _c.integratedMesh) == null ? void 0 : _d.lodFactor) ?? 1;
  }
  ...
  initialize() {
    this.updatingHandles.add(() => this.layer.modifications, () => this._loadModifications(), h), this.view.basemapTerrain.overlayManager.registerDrapeTarget(this);
  }
  destroy() {
  ...
  _loadModifications() {
    if (this.handles.remove("modifications"), null == this.layer.modifications)
      return void (this._modifications = []);
    const e2 = this.layer.modifications;
    this.handles.add(this.updatingHandles.addOnCollectionChange(() => e2, () => this._modifications = e2.toArray(), h), "modifications");
  }
};
e([y()], d2.prototype, "layer", void 0), e([y()], d2.prototype, "i3slayer", null), e([y(t)], d2.prototype, "updatingProgress", void 0), e([y()], d2.prototype, "updatingProgressValue", null), e([y()], d2.prototype, "lodFactor", null), e([y({ readOnly: true })], d2.prototype, "progressiveLoadFactor", null), d2 = e([a("esri.views.3d.layers.SceneLayerView3D")], d2);
var u = d2;
export {
  u as default
};
//# sourceMappingURL=IntegratedMeshLayerView3D-IQH5YUHU.js.map
