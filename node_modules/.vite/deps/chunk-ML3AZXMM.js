...
function i(n) {
  return Array.isArray(n) ? n.map((n2) => p(n2)) : p(n);
}
function o(n, t) {
  let e;
...
var c;
async function u() {
  return c || (c = f("geometryEngineWorker", { strategy: "distributed" })), c;
}
...
async function T(n, e, a2 = true) {
  ...
  return { ...i2, coordinate: x.fromJSON(i2.coordinate) };
}
async function V(n, e) {
  const a2 = await s("nearestVertex", [r(n), n, e]);
  return { ...a2, coordinate: x.fromJSON(a2.coordinate) };
}
function G(n) {
  var _a;
...
//# sourceMappingURL=chunk-ML3AZXMM.js.map
