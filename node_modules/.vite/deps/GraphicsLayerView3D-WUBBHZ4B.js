...
var d2 = class extends n(d) {
  ...
  async fetchPopupFeatures(e2, r2) {
    return (r2 == null ? void 0 : r2.clientGraphics) ?? [];
  }
  getHit(e2) {
  ...
  async elevationAlignPointsInFeatures(e2, s2) {
    ...
    if (null == i || null == i.graphics3DGraphics)
    ...
    return f2(this.view, this.layer, o, e2, s2);
  }
  async queryForSymbologySnapping(e2, r2) {
    return r(this.processor, e2, r2);
  }
  get updatePolicy() {
    var _a;
    return ((_a = this.processor) == null ? void 0 : _a.graphicsCore.effectiveUpdatePolicy) || C.SYNC;
  }
  canResume() {
    var _a;
...
e([y()], d2.prototype, "loadedGraphics", null), e([y({ readOnly: true })], d2.prototype, "legendEnabled", null), e([y()], d2.prototype, "layer", void 0), e([y({ readOnly: true })], d2.prototype, "processor", void 0), e([y()], d2.prototype, "_slicePlaneEnabled", void 0), e([y({ type: Boolean })], d2.prototype, "slicePlaneEnabled", null), d2 = e([a("esri.views.3d.layers.GraphicsLayerView3D")], d2);
var m = d2;
export {
  m as default
};
//# sourceMappingURL=GraphicsLayerView3D-WUBBHZ4B.js.map
