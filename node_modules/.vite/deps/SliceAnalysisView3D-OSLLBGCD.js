...
u6.shader = new t6(g4, () => import("./SlicePlaneMaterial.glsl-3AHPN7TX.js"));
...
function yt(t12, e9, n10, o5, i10, r9) {
  ...
  const a9 = s3(i10.basis1), c10 = s3(i10.basis2), l11 = e2(c4.get(), n10, s10), u7 = e2(c4.get(), e9, s10);
  let d6 = 0, m6 = 0;
  if ($t(t12)) {
...
function Ft(t12, e9, n10, o5) {
  const i10 = s3(o5.basis1), r9 = s3(o5.basis2), s10 = qt(o5), u7 = zt(o5), d6 = o2(c4.get(), 0, 0, 0);
...
function qt(t12) {
  const e9 = s3(t12.basis1), n10 = s3(t12.basis2);
...
function re(t12, n10, i10, r9 = new h5()) {
  ...
  if (null == c10)
    return null;
  r9.position = c10;
  const l11 = 2 * s3(t12.basis1), u7 = 2 * s3(t12.basis2), d6 = U3.renderUnitScaleFactor(n10.spatialReference, i10);
...
var Et = kt2 = class extends a5 {
  ...
  _shiftDragAdjustSensitivity(t12) {
    return (e9) => {
      if (null == this.analysisViewData.plane)
        return null;
      const i10 = 1e-3, a9 = Math.min((1 - Math.abs(P(ds(this.analysisViewData.plane), e9.ray.direction) / s3(e9.ray.direction))) / i10, 1), s10 = -R3(this._startPlane.plane, e9.renderEnd), n10 = -R3(this._startPlane.plane, t12.startPoint);
  ...
  _updateManipulators() {
    ...
    const a9 = o2(c4.get(), s3(t12.basis1), s3(t12.basis2), 1), s10 = d(f3.get(), a9), n10 = c2(s10, i10, s10);
...
var y2 = class extends m {
  ...
  _updatePlane(i10) {
    ...
    const t12 = o2(c4.get(), s3(i10.basis1), s3(i10.basis2), 1), e9 = d(f3.get(), t12), s10 = kt(i10, f3.get()), o5 = c2(e9, s10, e9);
...
//# sourceMappingURL=SliceAnalysisView3D-OSLLBGCD.js.map
