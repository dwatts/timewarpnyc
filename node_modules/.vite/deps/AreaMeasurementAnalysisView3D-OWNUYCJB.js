...
function b4(t8, e8, r8) {
  return In(t8, R3, r8) && In(e8, S2, r8) ? x2(R3, S2) : 0;
}
function k2(t8, e8) {
...
var S2 = n();
var U2 = n();
var G2 = new j3({ rings: [[R3, S2, U2]], spatialReference: f.WGS84 });
var T = n();
...
var B = class {
  ...
  _updatePathLengths(e8) {
    ...
    for (let o4 = 0; o4 < this._length; ++o4) {
      const r8 = s8[o4] = x2(t8[o4], t8[(o4 + 1) % this._length]);
  ...
  _updateArea(e8, o4, r8, n6, h8) {
    ...
    "horizontal" === this.fittingMode ? W3 = this._worldUp : "vertical" === this.fittingMode && (W3 = this._tempVec3, I2 = this._worldUp, q2(L, this._worldUp, W3)), r(this._frame[2], W3), q2(I2, W3, this._frame[0]), _(this._frame[1], this._frame[0], this._frame[2]), j2(this._frame[1], this._frame[1]);
  ...
  _computeGeodesicArea() {
    ...
    for (let o4 = 0; o4 < s8.length; o4 += 3)
      i5 += v2(e8[s8[o4]], e8[s8[o4 + 1]], e8[s8[o4 + 2]], f.WGS84);
    return i5;
  }
...
d3.shader = new t4(c4, () => import("./CheckerBoard.glsl-3QY6WF3P.js"));
...
var z2 = class extends m {
  ...
  _updateViewData(e8, t8, i5) {
    ...
    if (n6) {
      ...
      a9 = f2(Math.sqrt(t9.value) / Math.sqrt(300)), a9 *= Math.sqrt(j(1, t9.unit, "square-meters")), a9 /= e8.unitNormalizer.normalizeDistance(1);
    }
...
//# sourceMappingURL=AreaMeasurementAnalysisView3D-OWNUYCJB.js.map
