...
async function t3(t5, r2) {
  const { data: a3 } = await j(t5, { responseType: "image", ...r2 });
  return a3;
}
...
function t4() {
  if (null == s5) {
    ...
    s5 = import("./basis_transcoder-NPDZEBJV.js").then((e3) => e3.b).then(({ default: e3 }) => e3({ locateFile: t5 }).then((e4) => (e4.initializeBasis(), delete e4.then, e4)));
  }
  return s5;
}
var s5;
...
var w3 = class extends r {
  ...
  load(t5) {
    ...
    const e3 = this._data;
    return null == e3 ? (this._glTexture = new T(t5, this._createDescriptor(t5), null), this._glTexture) : "string" == typeof e3 ? this._loadFromURL(t5, e3) : e3 instanceof Image ? this._loadFromImageElement(t5, e3) : e3 instanceof HTMLVideoElement ? this._loadFromVideoElement(t5, e3) : e3 instanceof ImageData || e3 instanceof HTMLCanvasElement ? this._loadFromImage(t5, e3) : (n(e3) || t(e3)) && this.parameters.encoding === u.DDS_ENCODING ? (this._data = void 0, this._loadFromDDSData(t5, e3)) : (n(e3) || t(e3)) && this.parameters.encoding === u.KTX2_ENCODING ? (this._data = void 0, this._loadFromKTX2(t5, e3)) : (n(e3) || t(e3)) && this.parameters.encoding === u.BASIS_ENCODING ? (this._data = void 0, this._loadFromBasis(t5, e3)) : t(e3) ? this._loadFromPixelData(t5, e3) : n(e3) ? this._loadFromPixelData(t5, new Uint8Array(e3)) : null;
  }
  ...
  unload() {
    if (this._glTexture = t2(this._glTexture), null != this._loadingController) {
...
//# sourceMappingURL=chunk-NZZXHYUD.js.map
