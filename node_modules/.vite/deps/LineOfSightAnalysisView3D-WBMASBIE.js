...
e([y({ type: Number })], s5.prototype, "innerWidth", void 0), e([y({ type: Number })], s5.prototype, "outerWidth", void 0), e([y({ type: h3 })], s5.prototype, "visibleInnerColor", void 0), e([y({ type: h3 })], s5.prototype, "visibleOuterColor", void 0), e([y({ type: h3 })], s5.prototype, "occludedInnerColor", void 0), e([y({ type: h3 })], s5.prototype, "occludedOuterColor", void 0), e([y({ type: h3 })], s5.prototype, "undefinedInnerColor", void 0), e([y({ type: h3 })], s5.prototype, "undefinedOuterColor", void 0), s5 = e([a2("esri.views.3d.analysis.LineOfSight.LineOfSightConfiguration")], s5);
...
e([y()], s6.prototype, "target", void 0), e([y()], s6.prototype, "intersectedGraphic", void 0), e([y()], s6.prototype, "intersectedLocation", void 0), e([y()], s6.prototype, "elevationAlignedTargetLocation", void 0), e([y({ type: Boolean })], s6.prototype, "visible", void 0), s6 = e([a2("esri.views.3d.analysis.LineOfSightAnalysisResult")], s6);
...
e([y()], i4.prototype, "target", void 0), e([y()], i4.prototype, "elevationAlignedTargetLocation", void 0), e([y()], i4.prototype, "inputPoints", void 0), e([y()], i4.prototype, "computationResult", void 0), e([y()], i4.prototype, "result", void 0), i4 = e([a2("esri.views.3d.analysis.LineOfSight.LineOfSightComputation")], i4);
...
e([y()], y4.prototype, "type", void 0), e([y({ constructOnly: true })], y4.prototype, "id", void 0), e([y({ constructOnly: true })], y4.prototype, "mapPoint", void 0), e([y({ constructOnly: true })], y4.prototype, "renderPoint", void 0), e([y({ constructOnly: true })], y4.prototype, "normal", void 0), e([y({ constructOnly: true })], y4.prototype, "graphic", void 0), e([y({ constructOnly: true })], y4.prototype, "ray", void 0), y4 = m3 = e([a2("esri.views.3d.analysis.LineOfSight.LineOfSightIntersectionResult")], y4);
...
e([y()], R.prototype, "view", void 0), e([y()], R.prototype, "intersector", void 0), R = e([a2("esri.views.3d.analysis.LineOfSight.LineOfSightRayIntersector")], R);
var S = n3();
var U2 = n3();
var O = n3();
var C2 = n3();
...
var q = class extends n4.EventedMixin(m) {
  ...
  _updateAdjustedPointsFromFeatures(e9) {
    ...
    if (null == s7 && null == a5)
      return;
    const u7 = x2(r2, l6), c8 = this._intersector.intersector, d6 = h4(i5.observer, i5.target, J2);
  ...
  _computeIntersection({ computation: e9, interpolationInfo: t7 }) {
    ...
    const _2 = new x(m5, n7.spatialReference);
    {
  ...
  _connectComputationToTarget(e9) {
    return n([this._updatingHandles.add(() => ({ computation: e9, targetPosition: e9.target.position, targetElevationInfo: e9.target.elevationInfo, targetFeatureInfo: e9.target.feature, projectedTargetPosition: tn(e9.target.position, this.view.spatialReference) }), ({ computation: e10, targetPosition: t7, targetElevationInfo: n7, targetFeatureInfo: o3, projectedTargetPosition: i5 }) => {
  ...
  _connectComputationToTask(e9) {
    ...
    return n([this._updatingHandles.add(() => e9.inputPoints, () => {
      t7 = e3(t7), t7 = d(async (e10) => {
        await y2(this._frameTask.schedule(() => this._computeResult(n7), e10));
      });
    }, { initial: true, equals: () => false }), e2(() => t7 = e3(t7))]);
  }
  ...
  _connectTargets() {
    return n([this._updatingHandles.addOnCollectionChange(() => this.analysis.targets, (e9) => this._onTargetCollectionChange(e9), { initial: true, final: true }), this._updatingHandles.add(() => this.analysisViewData.cursorTarget, (e9, t7) => {
...
e([y({ constructOnly: true })], q.prototype, "analysis", void 0), e([y({ constructOnly: true })], q.prototype, "analysisViewData", void 0), e([y({ constructOnly: true })], q.prototype, "view", void 0), e([y()], q.prototype, "updating", null), e([y()], q.prototype, "priority", null), e([y()], q.prototype, "updateOnCameraChange", void 0), e([y()], q.prototype, "_computations", null), e([y()], q.prototype, "_elevationAlignedObserverPositionRenderSpace", null), e([y()], q.prototype, "_observerGroundOffsetRenderSpace", void 0), e([y()], q.prototype, "_effectiveObserverElevationMode", void 0), e([y()], q.prototype, "_observerFeatureId", void 0), e([y()], q.prototype, "_screenPixelSize", null), e([y({ readOnly: true })], q.prototype, "_updatingHandles", void 0), e([y()], q.prototype, "_frameTask", void 0), e([y()], q.prototype, "_isCameraDirty", null), q = e([a2(M)], q);
var B2 = 0.1;
var W = n3();
var J2 = d3();
var K = C();
...
e([y({ type: Boolean })], l5.prototype, "enabled", void 0), e([y({ type: h3 })], l5.prototype, "glowColor", void 0), e([y({ type: Number })], l5.prototype, "glowWidth", void 0), e([y({ type: h3 })], l5.prototype, "innerColor", void 0), e([y({ type: Number })], l5.prototype, "innerWidth", void 0), e([y({ type: Number })], l5.prototype, "globalAlpha", void 0), l5 = e([a2("esri.views.3d.interactive.analysisTools.lineOfSight.LineOfSightLaserLineConfiguration")], l5);
var d5 = class extends m {
  constructor(o3) {
    super(o3), this.size = 0.5, this.color = i2(0.75);
  }
};
e([y({ type: Number })], d5.prototype, "size", void 0), e([y({ type: h3 })], d5.prototype, "color", void 0), d5 = e([a2("esri.views.3d.interactive.analysisTools.lineOfSight.LineOfSightObserverConfiguration")], d5);
...
e([y({ type: Number })], y5.prototype, "size", void 0), e([y({ type: h3 })], y5.prototype, "visibleColor", void 0), e([y({ type: h3 })], y5.prototype, "occludedColor", void 0), e([y({ type: h3 })], y5.prototype, "undefinedColor", void 0), y5 = e([a2("esri.views.3d.interactive.analysisTools.lineOfSight.LineOfSightTargetConfiguration")], y5);
var c6 = class extends m {
  constructor(o3) {
    super(o3), this.innerWidth = 2, this.outerWidth = 8, this.visibleInnerColor = new h3([3, 252, 111, 1]), this.visibleOuterColor = new h3([3, 252, 111, 0.15]), this.occludedInnerColor = new h3([252, 3, 69, 1]), this.occludedOuterColor = new h3([252, 3, 69, 0.1]), this.undefinedInnerColor = new h3([255, 255, 255, 1]), this.undefinedOuterColor = new h3([127, 127, 127, 0.2]);
  }
};
e([y({ type: Number })], c6.prototype, "innerWidth", void 0), e([y({ type: Number })], c6.prototype, "outerWidth", void 0), e([y({ type: h3 })], c6.prototype, "visibleInnerColor", void 0), e([y({ type: h3 })], c6.prototype, "visibleOuterColor", void 0), e([y({ type: h3 })], c6.prototype, "occludedInnerColor", void 0), e([y({ type: h3 })], c6.prototype, "occludedOuterColor", void 0), e([y({ type: h3 })], c6.prototype, "undefinedInnerColor", void 0), e([y({ type: h3 })], c6.prototype, "undefinedOuterColor", void 0);
var h5 = class extends m {
  constructor(o3) {
    super(o3), this.laserLine = new l5(), this.observer = new d5(), this.target = new y5(), this.lineOfSight = new c6();
  }
};
e([y({ type: l5 })], h5.prototype, "laserLine", void 0), e([y({ type: d5 })], h5.prototype, "observer", void 0), e([y({ type: y5 })], h5.prototype, "target", void 0), e([y({ type: c6 })], h5.prototype, "lineOfSight", void 0), h5 = e([a2("esri.views.3d.interactive.analysisTools.lineOfSight.LineOfSightToolConfiguration")], h5);
...
var E = class extends a3 {
  ...
  _cancelTargetDragStep(e9) {
    const t7 = n2(e9.position, (e10) => e10.clone());
...
e([y({ constructOnly: true })], E.prototype, "view", void 0), e([y({ constructOnly: true })], E.prototype, "analysis", void 0), e([y({ readOnly: true })], E.prototype, "state", null), e([y({ readOnly: true })], E.prototype, "cursor", null), e([y()], E.prototype, "removeIncompleteOnCancel", void 0), e([y({ readOnly: true })], E.prototype, "updating", null), e([y({ type: h5 })], E.prototype, "configuration", void 0), e([y({ constructOnly: true })], E.prototype, "analysisViewData", void 0), e([y({ readOnly: true })], E.prototype, "_showTracker", null), e([y()], E.prototype, "_latestPointerMovePointerType", void 0), e([y()], E.prototype, "_shouldRenderTracker", null), e([y()], E.prototype, "_laserlineVisualElement", void 0), e([y()], E.prototype, "_grabbedManipulator", void 0), E = e([a2("esri.views.3d.interactive.analysisTools.lineOfSight.LineOfSightTool")], E);
var I3 = v();
...
var b3 = class extends m {
  ...
  _connectComputation(i5) {
    ...
    e9.add([this._updatingHandles.add(() => this._getLineOfSightVisualizationDependencies(i5), (e10) => this._updateLineOfSightVisualization(i5, t7, e10), { initial: true, equals: () => false }), e2(() => this._destroyLineOfSightVisualization(t7))], i5);
  }
...
e([y({ constructOnly: true })], b3.prototype, "analysis", void 0), e([y({ constructOnly: true })], b3.prototype, "analysisViewData", void 0), e([y({ constructOnly: true })], b3.prototype, "view", void 0), e([y({ readOnly: true })], b3.prototype, "visible", null), e([y()], b3.prototype, "updating", null), e([y()], b3.prototype, "interactiveAndEditable", null), e([y()], b3.prototype, "test", null), e([y()], b3.prototype, "_configuration", null), b3 = e([a2("esri.views.3d.analysis.LineOfSight.LineOfSightVisualization")], b3);
...
var g4 = class extends s4(n4.EventedMixin(m)) {
  ...
  getResultForTarget(t7) {
    ...
    return n2(i5, (t8) => t8.result);
  }
  get testInfo() {
    return { visualization: this._analysisVisualization, controller: this._analysisController };
  }
};
e([y({ readOnly: true })], g4.prototype, "type", void 0), e([y({ constructOnly: true, nonNullable: true })], g4.prototype, "analysis", void 0), e([y()], g4.prototype, "tool", void 0), e([y({ readOnly: true })], g4.prototype, "results", null), e([y()], g4.prototype, "priority", null), e([y()], g4.prototype, "computations", void 0), e([y()], g4.prototype, "elevationAlignedObserver", void 0), e([y()], g4.prototype, "configuration", void 0), e([y()], g4.prototype, "observerEngineLocation", void 0), e([y()], g4.prototype, "cursorTarget", void 0), e([y()], g4.prototype, "updating", null), e([y()], g4.prototype, "editable", void 0), e([y()], g4.prototype, "_analysisController", void 0), e([y()], g4.prototype, "_analysisVisualization", void 0), g4 = e([a2("esri.views.3d.analysis.LineOfSightAnalysisView3D")], g4);
var f2 = g4;
export {
  f2 as default
};
//# sourceMappingURL=LineOfSightAnalysisView3D-WBMASBIE.js.map
