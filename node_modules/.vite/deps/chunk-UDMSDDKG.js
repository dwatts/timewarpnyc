...
var V = class extends a4(n(d2)) {
  ...
  async _fetch(e6, t4) {
    ...
    n2.loadingAbortController = e3(n2.loadingAbortController);
  ...
  _clearImage(e6) {
    ...
    if (t4) {
      ...
      e7.remove(t4.texture), t4.texture = null, e7.remove(t4.material), t4.material = null, t4.loadingAbortController = e3(t4.loadingAbortController), t4.loadingPromise = null, t4.image = null, t4.pixelData = null;
    }
  }
...
//# sourceMappingURL=chunk-UDMSDDKG.js.map
