...
e([r2({ count: t3.COUNT })], s2.prototype, "mode", void 0);
...
return low2 + (x - low1) * (high2 - low2) / (high1 - low1);
    ...
    float getTextureForPointPerlinWorley(vec3 p) {
      float perlinNoise = getPerlinNoise(p, ${o.float(o3)});
  ...
  return n2.fragment.uniforms.add(new e2("weatherTile", (e5) => e5.weatherTile)), n2.fragment.code.add(o`
    ...
    vec2 hash(vec2 p){
      ...
      p = modulo(p, ${o.float(i2)});

      // Get global coordinates of p
      p += weatherTile * ${o.float(i2)};
  ...
  `), n2.fragment.code.add(o`void main() {`), e4.mode === t3.Full && n2.fragment.code.add(o`
      ...
      `), n2.fragment.code.add(o`
      vec2 mapUV = ${o.float(i2)} * (gl_FragCoord.xy / ${o.float(t2)});
...
var v = Object.freeze(Object.defineProperty({ __proto__: null, NoiseTextureAtlasPassParameters: s3, build: u }, Symbol.toStringTag, { value: "Module" }));
...
//# sourceMappingURL=chunk-GJTR3OEJ.js.map
