...
var S2 = C = class extends u(_) {
  ...
  initialize() {
    this.when().catch((r3) => {
      d2(r3) || s.getLogger(this).error("#load()", "Failed to load ground", r3);
  ...
  async queryElevation(r3, e3) {
    ...
    const { ElevationQuery: o5 } = await import("./ElevationQuery-F3TWL45Y.js");
    s3(e3);
  ...
  _loadLayersFromJSON(r3, e3, o5) {
    ...
    return import("./layersCreator-SCPFCMNG.js").then(({ populateOperationalLayers: e4 }) => {
      s3(o5);
      const i3 = [];
...
//# sourceMappingURL=chunk-OTGLQX7J.js.map
