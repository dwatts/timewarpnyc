...
var T = w2 = class extends m2 {
  ...
  async _fetchAvailabilityUpsamplePrefetch(e4, t3, i, r2, s4, o) {
    ...
    if (this.addHandles(h2, a4), await y2(10, n2.signal).catch(() => {
    }), c2 || (c2 = true, this.removeHandles(a4)), a3(n2))
      return;
...
T._maxPrefetch = 4, T._prefetches = new l({ initialSize: w2._maxPrefetch }), e([y({ constructOnly: true })], T.prototype, "layer", void 0), e([y({ constructOnly: true })], T.prototype, "minLOD", void 0), e([y({ constructOnly: true })], T.prototype, "maxLOD", void 0), e([y({ constructOnly: true })], T.prototype, "request", void 0), e([y({ constructOnly: true })], T.prototype, "size", void 0), T = w2 = e([a2("esri.layers.support.TilemapCache")], T);

export {
  T
};
//# sourceMappingURL=chunk-VDT2UHLV.js.map
