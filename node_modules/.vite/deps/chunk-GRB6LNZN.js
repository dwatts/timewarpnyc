...
var h = class {
    ...
    if (f2(t, n))
      for (g.clear(); n; ) {
        for (let s = 0, h2 = n.children.length; s < h2; s++) {
          ...
          f2(t, a2) && (n.leaf ? i(h3) : x(t, a2) ? this._all(h3, i) : g.push(h3));
        }
        n = g.pop();
      }
  }
  ...
  remove(i) {
    ...
    for (X.clear(), Y.clear(); s || X.length > 0; ) {
      if (s || (s = p(X.pop()), h2 = X.data[X.length - 1], a2 = Y.pop() ?? 0, r2 = true), s.leaf && (e = b(s.children, i, s.children.length, s.indexHint), -1 !== e))
  ...
  _build(t, i, n, e) {
    ...
    p2(t, i, n, l3, this._compareMinX);
    for (let a2 = i; a2 <= n; a2 += l3) {
      const i2 = Math.min(a2 + l3 - 1, n);
      p2(t, a2, i2, o2, this._compareMinY);
  ...
  _chooseSplitIndex(t, i, n) {
    ...
    for (let a2 = i; a2 <= n - i; a2++) {
      const i2 = r(t, 0, a2, this._toBBox), o2 = r(t, a2, n, this._toBBox), l3 = _(i2, o2), c2 = m(i2) + m(o2);
      l3 < e ? (e = l3, h2 = a2, s = c2 < s ? c2 : s) : l3 === e && c2 < s && (s = c2, h2 = a2);
    }
    return h2;
  }
...
function p2(t, i, e, h2, a2) {
  const r2 = [i, e];
  for (; r2.length; ) {
    const i2 = p(r2.pop()), e2 = p(r2.pop());
    if (i2 - e2 <= h2)
      continue;
    const o2 = e2 + Math.ceil((i2 - e2) / h2 / 2) * h2;
    f(t, o2, e2, i2, a2), r2.push(e2, o2, o2, i2);
  }
}
var g = new l();
var M = new l();
...
//# sourceMappingURL=chunk-GRB6LNZN.js.map
