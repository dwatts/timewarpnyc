...
var Action = proxyCustomElement(class extends H {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  async setFocus() {
    ...
    (_a = this.buttonEl) == null ? void 0 : _a.focus();
  }
  // --------------------------------------------------------------------------
  //
  //  Render Methods
  ...
  renderIconContainer() {
    ...
    const calciteIconNode = icon ? h("calcite-icon", { flipRtl: iconFlipRtl, icon, scale: iconScale }) : null;
  ...
  render() {
    ...
    }, this.renderIconContainer(), this.renderTextContainer()), h("slot", { name: SLOTS.tooltip, onSlotchange: this.handleTooltipSlotChange }), this.renderIndicatorText());
  }
...
@esri/calcite-components/dist/components/action.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=chunk-4PU7VCTE.js.map
