...
var L = class extends m {
  ...
  initialize() {
    ...
    }).then(() => this.loadAsyncModule(import("./geometryEngine-LO3MQFLQ.js").then((e3) => {
...
function z(e3, t5, r) {
  const i4 = { type: "point", x: t5[0], y: t5[1], hasZ: false, hasM: false, spatialReference: r }, s4 = !u(r) && !A(r), o4 = Number.isNaN(t5[3]) ? 0 : i(t5[3], 0, 2 * s3.radius), a3 = s4 ? e3.buffer(i4, o4, 1) : e3.geodesicBuffer(i4, o4, 1);
...
function Q2(e3, t5, r, i4) {
  ...
  if (!p2) {
    ...
    for (let r2 = 0; r2 < 4; ++r2)
      S(t6[r2], t6[r2], e4.rotationScale), u2(t6[r2], t6[r2], e4.position), Hn(t6[r2], o4, t6[r2], a3);
  ...
  for (let k = F; k < _; k += 3) {
    ...
    switch (o(h3, b3[r2], b3[r2 + 1], b3[r2 + 2]), o(j2, b3[i5], b3[i5 + 1], b3[i5 + 2]), o(S3, b3[s5], b3[s5 + 1], b3[s5 + 2]), S(h3, h3, R.rotationScale), S(j2, j2, R.rotationScale), S(S3, S3, R.rotationScale), u2(h3, h3, R.position), u2(j2, j2, R.position), u2(S3, S3, R.position), Hn(h3, o4, h3, a3), Hn(j2, o4, j2, a3), Hn(S3, o4, S3, a3), g2(e3, t5, u4)) {
      case K.DISCARD:
        return false;
      case K.KEEP:
        return true;
...
//# sourceMappingURL=chunk-A3SLC5TK.js.map
