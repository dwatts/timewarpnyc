...
import {
  x as x2
} from "./chunk-OK2X54ZK.js";
import {
  c as c9
} from "./chunk-RDB3JY7T.js";
import {
  i as i5
...
import {
  d,
  i as i4
} from "./chunk-XEG7QIWD.js";
import {
  s as s5
} from "./chunk-SME753HL.js";
import {
  t as t3
...
var s6 = class {
  constructor(r14, o11, s13, a8 = true) {
    this.output = o11, this.type = s13, this.valid = false, this.lastUsed = n2(1 / 0), this.fbo = new i8(r14, a8);
  }
};
var a6 = class {
  constructor(e14) {
  ...
  validateUsageForTarget(r14, t15, o11) {
    return r14 ? (t15.lastUsed = o11, false) : o11 - t15.lastUsed > d2 ? (t15.fbo.disposeRenderTargetMemory(), t15.lastUsed = n2(1 / 0), false) : t15.lastUsed < 1 / 0;
  }
  get gpuMemoryUsage() {
...
var n10 = class extends i9 {
  constructor(r14, s13, t15, a8, i12) {
    super(r14, t15, a8, i12), this.offscreenRenderingHelper = s13, this.sliceHelper = i12, this.time = n2(0);
  }
};
...
S3.shader = new t5(x2, () => import("./WaterSurface.glsl-VVAFFUA3.js"));
  ...
  _updateDrawCommands() {
    this._hasHighlights = false, this._hasOccludees = false, this._dataByOrigin.forEach((e14) => {
      e14.buffers.forEach((e15) => {
        e15.drawCommandsDirty && (e15.hasHiddenInstances = false, e15.hasHighlights = false, e15.hasOccludees = false, n(e15.instances, (t15) => (e15.updateDrawState(t15), e15.hasHiddenInstances && e15.hasHighlights && e15.hasOccludees)), e15.updateDrawCommands(this._bufferWriter.vertexBufferLayout.stride)), this._hasHighlights = this._hasHighlights || e15.hasHighlights, this._hasOccludees = this._hasOccludees || e15.hasOccludees;
      });
    });
  }
...
var _4 = class extends m {
  ...
  get rendersOccluded() {
    return n(this._materialRenderers, (e14) => e14.rendersOccluded);
  }
  get isEmpty() {
  ...
  commitChanges() {
    ...
    }), this._changes.clear(), r14 && this._updateSortedMaterialRenderers(), s13 && (this._hasHighlights = n(this._materialRenderers, (e15) => e15.hasHighlights)), i12 && (this._hasWater = n(this._materialRenderers, (e15) => e15.hasWater)), this.notifyChange("updating"), true;
  }
...
m2.shader = new t5(d, () => import("./TextureOnly.glsl-VCVVQACM.js"));
...
var ie = class extends m {
  ...
  get updating() {
    return this._sortedDrapeSourceRenderersDirty || n(this._renderers, (e14) => e14.updating);
  }
  get hasOverlays() {
  ...
  ensureDrapeTargets(e14) {
    null != this._overlays && this._overlays.forEach((r14) => r14.hasTargetWithoutRasterImage = n3(e14, (e15) => e15.drapeTargetType === t8.WithoutRasterImage));
  }
  ensureDrapeSources(e14) {
    null != this._overlays && this._overlays.forEach((r14) => {
      r14.hasDrapedFeatureSource = n3(e14, (e15) => e15.drapeSourceType === e11.Features), r14.hasDrapedRasterSource = n3(e14, (e15) => e15.drapeSourceType === e11.RasterImage);
    });
  }
  ...
  get isEmpty() {
    return !t7.OVERLAY_DRAW_DEBUG_TEXTURE && !n(this._renderers, (e14) => !e14.isEmpty);
  }
  get hasHighlights() {
    return this._hasHighlights;
  }
...
//# sourceMappingURL=chunk-AD4YIQAV.js.map
