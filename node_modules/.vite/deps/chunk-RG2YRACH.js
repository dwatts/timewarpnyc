...
var c = class extends m {
  ...
  addOnCollectionChange(s, e3, { initial: t2 = false, final: n = false } = {}) {
    ...
    return this._handles.add([a2(s, "after-changes", this._createSyncUpdatingCallback(), U), a2(s, "change", e3, { onListenerAdd: t2 ? (s2) => e3({ added: s2.toArray(), removed: [] }) : void 0, onListenerRemove: n ? (s2) => e3({ added: [], removed: s2.toArray() }) : void 0 })], d), e2(() => this._handles.remove(d));
  }
  addPromise(s) {
    if (null == s)
      return s;
  ...
  _installWatch(s, e3, t2 = {}, n) {
    const d = ++this._handleId;
    t2.sync || this._installSyncUpdatingWatch(s, d);
    const a3 = n(s, e3, t2);
    return this._handles.add(a3, d), e2(() => this._handles.remove(d));
  }
...
//# sourceMappingURL=chunk-RG2YRACH.js.map
