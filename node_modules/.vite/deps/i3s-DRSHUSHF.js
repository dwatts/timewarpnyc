    ...
    if ("string" != typeof t3 && !Array.isArray(t3)) {
      for (const r3 in t3)
        if ("default" !== r3 && !(r3 in n)) {
          const e3 = Object.getOwnPropertyDescriptor(t3, r3);
          e3 && Object.defineProperty(n, r3, e3.get ? e3 : { enumerable: true, get: () => t3[r3] });
        }
    }
  }
...
var i;
var o = { exports: {} };
o.exports, e = o, o.exports, t2 = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, i = function(n = {}) {
  var r2, e2, i2 = void 0 !== n ? n : {};
  i2.ready = new Promise((n2, t3) => {
    r2 = n2, e2 = t3;
  });
  ...
  (a2 || u2) && (u2 ? f = self.location.href : "undefined" != typeof document && document.currentScript && (f = document.currentScript.src), t2 && (f = t2), f = 0 !== f.indexOf("blob:") ? f.substr(0, f.replace(/[?#].*/, "").lastIndexOf("/") + 1) : "", u2 && (c = (n2) => {
  ...
  function G(n2, r3, e3, t3) {
    return n2 || "function" != typeof WebAssembly.instantiateStreaming || B(r3) || "function" != typeof fetch ? L(r3, e3, t3) : fetch(r3, { credentials: "same-origin" }).then((n3) => WebAssembly.instantiateStreaming(n3, e3).then(t3, function(n4) {
      return v("wasm streaming compile failed: " + n4), v("falling back to ArrayBuffer instantiation"), L(r3, e3, t3);
    }));
  }
  function X() {
  ...
  function vn(n2, r3, e3) {
    ...
    r3.forEach((n3, r4) => {
      on.hasOwnProperty(n3) ? i3[r4] = on[n3] : (o3.push(n3), tn.hasOwnProperty(n3) || (tn[n3] = []), tn[n3].push(() => {
        i3[r4] = on[n3], ++a3 === o3.length && t3(i3);
      }));
    }), 0 === o3.length && t3(i3);
  }
  function hn(n2) {
    var r3 = nn[n2];
    delete nn[n2];
    var e3 = r3.rawConstructor, t3 = r3.rawDestructor, i3 = r3.fields;
    vn([n2], i3.map((n3) => n3.getterReturnType).concat(i3.map((n3) => n3.setterArgumentType)), (n3) => {
      var o3 = {};
      return i3.forEach((r4, e4) => {
        var t4 = r4.fieldName, a3 = n3[e4], u3 = r4.getter, c2 = r4.getterContext, f2 = n3[e4 + i3.length], s2 = r4.setter, l2 = r4.setterContext;
        o3[t4] = { read: (n4) => a3.fromWireType(u3(c2, n4)), write: (n4, r5) => {
          var e5 = [];
  ...
  function Cn(n2, r3, e3, t3, i3) {
    ...
    Tn(n2, { name: r3 = wn(r3), fromWireType: function(n3) {
      ...
      return this.fromWireType(t4[n3 >> o3]);
    ...
    return function() {
      ...
      function a4(n3) {
        if (c2)
          ...
          for (var t4 = u3 ? 1 : 2; t4 < r3.length; t4++) {
            var i4 = 1 === t4 ? e4 : d2[t4 - 2];
  ...
  function Ln(n2, r3) {
    var e3 = [], t3 = {};
    function i3(n3) {
      t3[n3] || on[n3] || (an[n3] ? an[n3].forEach(i3) : (e3.push(n3), t3[n3] = true));
    }
    throw r3.forEach(i3), new qn(n2 + ": " + e3.map(Nn).join([", "]));
  }
  function Gn(n2, r3, e3, t3, i3, o3, a3) {
    var u3 = Hn(r3, e3);
    n2 = wn(n2), i3 = Bn(t3, i3), On(n2, function() {
      ...
      return Dn(n2, Un(n2, t4, null, i3, o3), r3 - 1), [];
    });
  }
  function Xn(n2, r3, e3) {
    switch (r3) {
  ...
  function Zn(n2, r3, e3, t3, i3) {
    ...
    }, argPackAdvance: 8, readValueFromPointer: Xn(r3, o3, 0 !== t3), destructorFunction: null });
  }
  function $n(n2, r3, e3) {
  ...
  function nr(n2, r3, e3) {
    for (var t3 = r3 + e3, i3 = r3; n2[i3] && !(i3 >= t3); )
      ++i3;
  ...
  function er(n2, r3) {
    ...
    Tn(n2, { name: r3, fromWireType: function(n3) {
      ...
      i3 || r4 instanceof Uint8Array || r4 instanceof Uint8ClampedArray || r4 instanceof Int8Array || An("Cannot pass non-string to std::string"), t3 = e3 && i3 ? Qn(r4) : r4.length;
      var o3 = Rr(4 + t3 + 1), a3 = o3 + 4;
      if (w[o3 >> 2] = t3, e3 && i3)
        Kn(r4, a3, t3 + 1);
      else if (i3)
        for (var u3 = 0; u3 < t3; ++u3) {
  ...
  function ir(n2, r3) {
    for (var e3 = n2, t3 = e3 >> 1, i3 = t3 + r3 / 2; !(t3 >= i3) && y[t3]; )
      ++t3;
    if ((e3 = t3 << 1) - n2 > 32 && tr)
  ...
  function or(n2, r3, e3) {
    if (void 0 === e3 && (e3 = 2147483647), e3 < 2)
      return 0;
    for (var t3 = r3, i3 = (e3 -= 2) < 2 * n2.length ? e3 / 2 : n2.length, o3 = 0; o3 < i3; ++o3) {
  ...
  function ur(n2, r3) {
    for (var e3 = 0, t3 = ""; !(e3 >= r3 / 4); ) {
      ...
      if (++e3, i3 >= 65536) {
        var o3 = i3 - 65536;
        t3 += String.fromCharCode(55296 | o3 >> 10, 56320 | 1023 & o3);
      } else
  ...
  function cr(n2, r3, e3) {
    if (void 0 === e3 && (e3 = 2147483647), e3 < 4)
      return 0;
    for (var t3 = r3, i3 = t3 + e3 - 4, o3 = 0; o3 < n2.length; ++o3) {
      var a3 = n2.charCodeAt(o3);
  ...
  function sr(n2, r3, e3) {
    var t3, i3, o3, a3, u3;
    e3 = wn(e3), 2 === r3 ? (t3 = ir, i3 = or, a3 = ar, o3 = () => y, u3 = 1) : 4 === r3 && (t3 = ur, i3 = cr, a3 = fr, o3 = () => w, u3 = 2), Tn(n2, { name: e3, fromWireType: function(n3) {
      ...
      var o4 = a3(t4), c2 = Rr(4 + o4 + r3);
      return w[c2 >> 2] = o4 >> u3, i3(t4, c2 + 4, o4 + r3), null !== n3 && n3.push(Sr, c2), c2;
    }, argPackAdvance: 8, readValueFromPointer: en, destructorFunction: function(n3) {
      Sr(n3);
    } });
  }
  function lr(n2, r3, e3, t3, i3, o3) {
    nn[n2] = { name: wn(r3), rawConstructor: Bn(e3, t3), rawDestructor: Bn(i3, o3), fields: [] };
  }
  function dr(n2, r3, e3, t3, i3, o3, a3, u3, c2, f2) {
    nn[n2].fields.push({ fieldName: wn(r3), getterReturnType: e3, getter: Bn(t3, i3), getterContext: o3, setterArgumentType: a3, setter: Bn(u3, c2), setterContext: f2 });
  }
  function pr(n2, r3) {
  ...
  function Cr(n2) {
    ...
    for (var i3 = 1; i3 <= 4; i3 *= 2) {
      var o3 = r3 * (1 + 0.2 / i3);
      if (o3 = Math.min(o3, n2 + 100663296), Tr(Math.min(e3, t3(Math.max(n2, o3), 65536))))
        return true;
    }
    return false;
  }
...
var a = o.exports;
var u = r({ __proto__: null, default: t(a) }, [a]);
export {
  u as i
};
//# sourceMappingURL=i3s-DRSHUSHF.js.map
