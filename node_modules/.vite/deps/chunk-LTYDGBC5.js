import {
  f as f2
} from "./chunk-H2WAWDF5.js";
import {
  t
} from "./chunk-LG2ZH3JE.js";
import {
  r as r2
...
async function a4(e2) {
  if (!e2)
    return;
  const a5 = e2.includes("-vector") ? e2.slice(0, e2.indexOf("-vector")) : e2, s4 = await h("esri/t9n/basemaps");
  return s4[e2] || s4[a5];
}
var s3 = { streets: { id: "streets", classic: true, deprecated: true, get thumbnailUrl() {
  return a3("esri/images/basemap/streets.jpg");
  ...
  return a3("esri/images/basemap/satellite.jpg");
  ...
  return a3("esri/images/basemap/hybrid.jpg");
  ...
  return a3("esri/images/basemap/terrain.jpg");
  ...
  return a3("esri/images/basemap/topo.jpg");
  ...
  return a3("esri/images/basemap/gray.jpg");
  ...
  return a3("esri/images/basemap/dark-gray.jpg");
  ...
  return a3("esri/images/basemap/oceans.jpg");
  ...
  return a3("esri/images/basemap/national-geographic.jpg");
  ...
  return a3("esri/images/basemap/osm.jpg");
  ...
  return a3("esri/images/basemap/dark-gray-vector.jpg");
  ...
  return a3("esri/images/basemap/gray-vector.jpg");
  ...
  return a3("esri/images/basemap/streets-vector.jpg");
  ...
  return a3("esri/images/basemap/topo-vector.jpg");
  ...
  return a3("esri/images/basemap/streets-night.jpg");
  ...
  return a3("esri/images/basemap/streets-relief.jpg");
  ...
  return a3("esri/images/basemap/streets-navigation.jpg");
...
var v = 0;
var _2 = "esri.Basemap";
var M = S = class extends u(_) {
  constructor(e2) {
    super(e2), this.id = null, this.portalItem = null, this.spatialReference = null, this.thumbnailUrl = null, this.title = "Basemap", this.id = Date.now().toString(16) + "-basemap-" + v++, this.baseLayers = new V(), this.referenceLayers = new V();
    const t2 = (e3) => {
    ...
    this.addHandles([this.baseLayers.on("after-add", (e3) => t2(e3.item)), this.referenceLayers.on("after-add", (e3) => t2(e3.item)), this.baseLayers.on("after-remove", (e3) => s4(e3.item)), this.referenceLayers.on("after-remove", (e3) => s4(e3.item))]);
  }
  initialize() {
    this.when().catch((e2) => {
  ...
  destroy() {
    ...
    for (const t2 of e2)
      t2.destroy();
    const r3 = this.referenceLayers.removeAll();
    for (const t2 of r3)
      t2.destroy();
  ...
  _writeBaseLayers(e2, r3, t2) {
    ...
    e2 ? (t2 = { ...t2, layerContainerType: "basemap" }, this.baseLayers.forEach((e3) => {
      const r4 = f2(e3, t2.webmap ? t2.webmap.getLayerJSONFromResourceInfo(e3) : null, t2);
      null != r4 && s4.push(r4);
  ...
  clone() {
    ...
    return this.loaded && (e2.loadStatus = "loaded"), new S({ resourceInfo: this.resourceInfo }).set(e2);
  }
  read(e2, r3) {
    this.resourceInfo || this._set("resourceInfo", { data: e2, context: r3 }), super.read(e2, r3);
  }
  write(e2, r3) {
    return e2 = e2 || {}, r3 && r3.origin || (r3 = { origin: "web-map", ...r3 }), super.write(e2, r3), !this.loaded && this.resourceInfo && this.resourceInfo.data.baseMapLayers && (e2.baseMapLayers = this.resourceInfo.data.baseMapLayers.map((e3) => {
      const r4 = a(e3);
      return r4.url && at(r4.url) && (r4.url = `https:${r4.url}`), r4.templateUrl && at(r4.templateUrl) && (r4.templateUrl = `https:${r4.templateUrl}`), r4;
    })), e2;
  }
  async _loadFromSource(e2) {
    const { resourceInfo: r3, portalItem: t2 } = this;
    s2(e2);
    const s4 = [];
    if (r3) {
      const t3 = r3.context ? r3.context.url : null;
      if (s4.push(this._loadLayersFromJSON(r3.data, t3, e2)), r3.data.id && !r3.data.title) {
        const e3 = r3.data.id;
        s4.push(a4(e3).then((e4) => {
          e4 && this.read({ title: e4 }, r3.context);
        }));
      }
    } else
      t2 && s4.push(this._loadFromItem(t2, e2));
    await Promise.all(s4);
  }
  async _loadLayersFromJSON(e2, r3, t2) {
    const s4 = this.resourceInfo && this.resourceInfo.context, o = this.portalItem && this.portalItem.portal || s4 && s4.portal || null, a5 = x2[(s4 == null ? void 0 : s4.origin) || ""] ?? "web-map", { populateOperationalLayers: i } = await import("./layersCreator-SCPFCMNG.js"), n2 = [];
    if (s2(t2), e2.baseMapLayers && Array.isArray(e2.baseMapLayers)) {
      const t3 = { context: { origin: a5, url: r3, portal: o, layerContainerType: "basemap" }, defaultLayerType: "DefaultTileLayer" }, s5 = (e3) => "web-scene" === a5 && "ArcGISSceneServiceLayer" === e3.layerType || e3.isReference, l = i(this.baseLayers, e2.baseMapLayers.filter((e3) => !s5(e3)), t3);
      n2.push(l);
      const p = i(this.referenceLayers, e2.baseMapLayers.filter(s5), t3);
      n2.push(p);
    }
    await j(n2);
  }
  async _loadFromItem(e2, r3) {
    const t2 = await e2.load(r3), s4 = await t2.fetchData("json", r3), o = L(e2.itemUrl ?? "");
    return this._set("resourceInfo", { data: s4.baseMap ?? {}, context: { origin: U[e2.type || ""] ?? "web-map", portal: e2.portal || j2.getDefault(), url: o } }), this.read(this.resourceInfo.data, this.resourceInfo.context), this.read({ spatialReference: s4.spatialReference }, this.resourceInfo.context), this.read({ title: e2.title, thumbnailUrl: e2.thumbnailUrl }, { origin: "portal-item", portal: e2.portal || j2.getDefault(), url: o }), this._loadLayersFromJSON(this.resourceInfo.data, o, r3);
  }
  static fromId(e2) {
    const r3 = s3[e2];
    if (!r3)
    ...
    if (r3.deprecated) {
      let r4 = null;
      "dark-gray" === e2 ? r4 = "dark-gray-vector" : "gray" === e2 ? r4 = "gray-vector" : "streets" === e2 ? r4 = "streets-vector" : "topo" === e2 && (r4 = "topo-vector"), r2(s.getLogger(_2), `The ${e2} basemap has entered mature support and is no longer being updated.`, { replacement: r4, see: "https://arcg.is/1iq8aD", warnOnce: true });
    }
    return S.fromJSON(r3);
  }
};
e([y2({ json: { write: { ignoreOrigin: true, target: "baseMapLayers", writer(e2, r3, t2, s4) {
  ...
  this._writeBaseLayers(e2, r3, s4);
} } } } } })], M.prototype, "baseLayers", null), e([y2({ type: String, json: { origins: { "web-scene": { write: true } } } })], M.prototype, "id", void 0), e([y2({ type: x })], M.prototype, "portalItem", void 0), e([y2()], M.prototype, "referenceLayers", null), e([y2({ readOnly: true })], M.prototype, "resourceInfo", void 0), e([y2({ type: f })], M.prototype, "spatialReference", void 0), e([y2()], M.prototype, "thumbnailUrl", void 0), e([y2({ type: String, json: { origins: { "web-scene": { write: { isRequired: true } } } } })], M.prototype, "title", void 0), e([r("title")], M.prototype, "writeTitle", null), M = S = e([a2(_2)], M);
var U = { "Web Scene": "web-scene", "Web Map": "web-map", "Link Chart": "link-chart" };
var x2 = { "web-scene": "web-scene", "web-map": "web-map", "link-chart": "link-chart" };
var O = M;
...
//# sourceMappingURL=chunk-LTYDGBC5.js.map
