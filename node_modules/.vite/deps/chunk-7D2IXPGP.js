...
var F = class extends m {
  ...
  async featureSetFromJSON(e2, t, r) {
    if (!this._queryIs3DObjectFormat(e2) || null == this.infoFor3D || !t.features)
      return d.fromJSON(t);
    const { meshFeatureSetFromJSON: s3 } = await p(import("./meshFeatureSet-2Y6DHCA6.js"), r);
  ...
  async executeRelationshipQuery(e2, t) {
    const [{ default: r }, { executeRelationshipQuery: s3 }] = await p(Promise.all([import("./RelationshipQuery-N7WA26SQ.js"), import("./executeRelationshipQuery-IP3JMRQF.js")]), t);
  ...
  async executeRelationshipQueryForCount(e2, t) {
    const [{ default: r }, { executeRelationshipQueryForCount: s3 }] = await p(Promise.all([import("./RelationshipQuery-N7WA26SQ.js"), import("./executeRelationshipQuery-IP3JMRQF.js")]), t);
    return e2 = r.from(e2), (this.gdbVersion || this.dynamicDataSource) && ((e2 = e2.clone()).gdbVersion = e2.gdbVersion || this.gdbVersion, e2.dynamicDataSource = e2.dynamicDataSource || this.dynamicDataSource), s3(this.url, e2, t);
  }
  async executeAttachmentQuery(e2, t) {
    const { executeAttachmentQuery: r, fetchAttachments: s3, processAttachmentQueryResult: i } = await p(import("./queryAttachments-UJNJVMQN.js"), t), u2 = f(this.url);
    return i(u2, await (this.queryAttachmentsSupported ? r(u2, e2, t) : s3(u2, e2, t)));
  }
  async executeTopFeaturesQuery(e2, t) {
    const { executeTopFeaturesQuery: r } = await p(import("./executeTopFeaturesQuery-KQHNACO4.js"), t);
    return r(this.parsedUrl, e2, this.sourceSpatialReference, t);
  }
  async executeForTopIds(e2, t) {
    const { executeForTopIds: r } = await p(import("./executeForTopIds-KZZC3BYQ.js"), t);
    return r(this.parsedUrl, e2, t);
  }
  async executeForTopExtents(e2, t) {
    const { executeForTopExtents: r } = await p(import("./executeForTopExtents-TQCODCGG.js"), t);
    return r(this.parsedUrl, e2, t);
  }
  async executeForTopCount(e2, t) {
    const { executeForTopCount: r } = await p(import("./executeForTopCount-F2TDA762.js"), t);
    return r(this.parsedUrl, e2, t);
  }
  _normalizeQuery(e2) {
    let t = b.from(e2);
...
//# sourceMappingURL=chunk-7D2IXPGP.js.map
