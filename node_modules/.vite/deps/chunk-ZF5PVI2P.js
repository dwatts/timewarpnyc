...
function i(e, o, t3 = false, n2) {
  return new Promise((s3, i2) => {
    ...
    const l2 = () => {
      has("esri-image-decode") || (e.removeEventListener("error", a4), e.removeEventListener("load", u2)), a4 = null, u2 = null, e = null, null != n2 && n2.removeEventListener("abort", m2), m2 = null, t3 && URL.revokeObjectURL(o);
    };
    null != n2 && n2.addEventListener("abort", m2), has("esri-image-decode") ? e.decode().then(u2, a4) : (e.addEventListener("error", a4), e.addEventListener("load", u2));
  });
}
function c2() {
  try {
...
async function j(e, t3) {
  ...
  w(t3, () => i2.abort());
  const h = { controller: i2, credential: void 0, credentialToken: void 0, fetchOptions: void 0, hasToken: false, interceptor: n2, params: a4, redoRequest: false, useIdentity: D2.useIdentity, useProxy: false, useSSL: false, withCredentials: false }, m2 = await V(h);
  return (_a = n2 == null ? void 0 : n2.after) == null ? void 0 : _a.call(n2, m2), m2;
}
var P2;
var D2 = s.request;
...
async function $() {
  has("host-webworker") ? P2 || (P2 = await import("./request-GYEW2AFA.js")) : j._abortableFetch || (j._abortableFetch = globalThis.fetch.bind(globalThis));
}
async function z() {
  n || await import("./IdentityManager-LO6TF4E4.js");
}
...
//# sourceMappingURL=chunk-ZF5PVI2P.js.map
