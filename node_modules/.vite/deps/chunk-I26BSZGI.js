...
var g2 = class extends d {
  ...
  async _queryBuddy(e2) {
    var _a;
    const t2 = new (await import("./@arcgis_core_layers_FeatureLayer.js")).default({ url: e2 }), { capabilities: r } = await t2.load(), s3 = r.query.supportsMaxRecordCountFactor, o2 = r.query.supportsPagination, i2 = r.query.supportsCentroid, n2 = this._config.maxRecordCountFactor, a2 = t2.capabilities.query.maxRecordCount, l = s3 ? a2 * n2 : a2, h3 = new b();
...
//# sourceMappingURL=chunk-I26BSZGI.js.map
