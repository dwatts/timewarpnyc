...
function l(t, n, r = 1e3) {
  switch (t.toLowerCase()) {
    ...
    case "mean":
      return s(le(n));
    case "min":
      return Math.min.apply(Math, le(n));
    case "sum":
      return u(le(n));
    case "max":
      return Math.max.apply(Math, le(n));
    case "stdev":
    case "stddev":
      return Math.sqrt(c(le(n)));
    case "var":
    case "variance":
      return c(le(n));
    case "count":
...
//# sourceMappingURL=chunk-6AXRLQ5N.js.map
