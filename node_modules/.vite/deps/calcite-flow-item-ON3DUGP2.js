...
import {
  ...
  setUpMessages,
  updateMessages
} from "./chunk-BJS35U5G.js";
import {
  componentFocusable,
  setComponentLoaded,
  setUpLoadableComponent
} from "./chunk-DCKF6OSV.js";
import {
  defineCustomElement
} from "./chunk-WEKMNWNG.js";
import {
  createObserver
} from "./chunk-ADBUEUHJ.js";
import {
  focusElement,
  focusFirstTabbable,
  focusable,
...
var customConfig = globalThis["calciteConfig"];
var focusTrapStack = (customConfig == null ? void 0 : customConfig.focusTrapStack) || [];
...
var Popover = proxyCustomElement(class extends H {
  ...
  renderCloseButton() {
    ...
    return closable ? h("div", { class: CSS.closeButtonContainer, key: CSS.closeButtonContainer }, h("calcite-action", {
    ...
    }, h("calcite-icon", { icon: "x", scale: this.scale === "l" ? "m" : this.scale }))) : null;
  }
  renderHeader() {
  ...
  render() {
    ...
    return h(Host, { "aria-hidden": toAriaBoolean(hidden), "aria-label": label, "aria-live": "polite", "calcite-hydrated-hidden": hidden, id: this.getId(), role: "dialog" }, h("div", {
      class: {
...
var Panel = proxyCustomElement(class extends H {
  ...
  renderHeaderContent() {
    ...
    const headingNode = heading ? h(Heading, { class: CSS3.heading, level: headingLevel }, heading) : null;
    const descriptionNode = description ? h("span", { class: CSS3.description }, description) : null;
    return !hasHeaderContent && (headingNode || descriptionNode) ? h("div", { class: CSS3.headerContent, key: "header-content" }, headingNode, descriptionNode) : null;
  }
  renderActionBar() {
    return h("div", { class: { [CSS3.actionBarContainer]: true, [CSS3.bottomSeparator]: this.hasDefaultContent }, hidden: !this.hasActionBar }, h("slot", { name: SLOTS2.actionBar, onSlotchange: this.handleActionBarSlotChange }));
  }
  /**
   * Allows user to override the entire header-content node.
   */
  renderHeaderSlottedContent() {
    return h("div", { class: CSS3.headerContent, hidden: !this.hasHeaderContent, key: "slotted-header-content" }, h("slot", { name: SLOTS2.headerContent, onSlotchange: this.handleHeaderContentSlotChange }));
  }
  renderHeaderStartActions() {
    const { hasStartActions } = this;
    return h("div", { class: { [CSS3.headerActionsStart]: true, [CSS3.headerActions]: true }, hidden: !hasStartActions, key: "header-actions-start" }, h("slot", { name: SLOTS2.headerActionsStart, onSlotchange: this.handleHeaderActionsStartSlotChange }));
  }
  renderHeaderActionsEnd() {
    const { close, hasEndActions, messages, closable, hasMenuItems } = this;
    const text = messages.close;
    const closableNode = closable ? h("calcite-action", {
      "aria-label": text,
      "data-test": "close",
      icon: ICONS2.close,
      onClick: close,
    ...
    return h("div", { class: { [CSS3.headerActionsEnd]: true, [CSS3.headerActions]: true }, hidden: !showContainer, key: "header-actions-end" }, slotNode, this.renderMenu(), closableNode);
  }
  renderMenu() {
    const { hasMenuItems, messages, menuOpen } = this;
    return h("calcite-action-menu", { flipPlacements: ["top", "bottom"], hidden: !hasMenuItems, key: "menu", label: messages.options, open: menuOpen, placement: "bottom-end" }, h("calcite-action", { icon: ICONS2.menu, slot: SLOTS.trigger, text: messages.options }), h("slot", { name: SLOTS2.headerMenuActions, onSlotchange: this.handleHeaderMenuActionsSlotChange }));
  }
  renderHeaderNode() {
    const { hasHeaderContent, hasStartActions, hasEndActions, closable, hasMenuItems, hasDefaultContent, hasActionBar } = this;
    const headerContentNode = this.renderHeaderContent();
    const showHeader = hasHeaderContent || headerContentNode || hasStartActions || hasEndActions || closable || hasMenuItems;
    return h("header", { class: { [CSS3.header]: true, [CSS3.bottomSeparator]: hasDefaultContent || hasActionBar }, hidden: !showHeader }, this.renderHeaderStartActions(), this.renderHeaderSlottedContent(), headerContentNode, this.renderHeaderActionsEnd());
  }
  renderFooterNode() {
    const { hasFooterContent, hasFooterActions } = this;
    const showFooter = hasFooterContent || hasFooterActions;
    return h("footer", { class: CSS3.footer, hidden: !showFooter }, h("slot", { key: "footer-slot", name: SLOTS2.footer, onSlotchange: this.handleFooterSlotChange }), h("slot", { key: "footer-actions-slot", name: SLOTS2.footerActions, onSlotchange: this.handleFooterActionsSlotChange }));
  }
  renderContent() {
    return h("div", {
      class: CSS3.contentWrapper,
      onScroll: this.panelScrollHandler,
      // eslint-disable-next-line react/jsx-sort-props
      ref: this.setPanelScrollEl
    }, h("section", { class: CSS3.contentContainer }, h("slot", { onSlotchange: this.handleDefaultSlotChange })), this.renderFab());
  }
  renderFab() {
    return h("div", { class: CSS3.fabContainer, hidden: !this.hasFab }, h("slot", { name: SLOTS2.fab, onSlotchange: this.handleFabSlotChange }));
  }
  render() {
    const { loading, panelKeyDownHandler, closed, closable } = this;
    const panelNode = h("article", {
      "aria-busy": toAriaBoolean(loading),
      class: CSS3.container,
      hidden: closed,
      onKeyDown: panelKeyDownHandler,
      tabIndex: closable ? 0 : -1,
      // eslint-disable-next-line react/jsx-sort-props
      ref: this.setContainerRef
    }, this.renderHeaderNode(), this.renderActionBar(), this.renderContent(), this.renderFooterNode());
...
var FlowItem = proxyCustomElement(class extends H {
  ...
  renderBackButton() {
    ...
    const icon = rtl ? ICONS3.backRight : ICONS3.backLeft;
    return showBackButton ? h("calcite-action", {
      "aria-label": label,
      class: CSS4.backButton,
      icon,
  ...
  render() {
    ...
    const label = messages.back;
    return h(Host, null, h("calcite-panel", {
      closable,
      closed,
      description,
      disabled,
      ...
      // eslint-disable-next-line react/jsx-sort-props
      ref: this.setContainerRef
    }, this.renderBackButton(), h("slot", { name: SLOTS3.actionBar, slot: SLOTS2.actionBar }), h("slot", { name: SLOTS3.headerActionsStart, slot: SLOTS2.headerActionsStart }), h("slot", { name: SLOTS3.headerActionsEnd, slot: SLOTS2.headerActionsEnd }), h("slot", { name: SLOTS3.headerContent, slot: SLOTS2.headerContent }), h("slot", { name: SLOTS3.headerMenuActions, slot: SLOTS2.headerMenuActions }), h("slot", { name: SLOTS3.fab, slot: SLOTS2.fab }), h("slot", { name: SLOTS3.footerActions, slot: SLOTS2.footerActions }), h("slot", { name: SLOTS3.footer, slot: SLOTS2.footer }), h("slot", null)), backButtonEl ? h("calcite-tooltip", { closeOnClick: true, label, overlayPositioning: "fixed", placement: "top", referenceElement: backButtonEl }, label) : null);
  }
  static get assetsDirs() {
    return ["assets"];
  }
...
@esri/calcite-components/dist/components/calcite-flow-item.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-flow-item-ON3DUGP2.js.map
