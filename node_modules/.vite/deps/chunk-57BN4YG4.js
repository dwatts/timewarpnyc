...
import {
  ...
  m2 as m7,
  s as s8
} from "./chunk-PKQ2SINV.js";
import {
  a as a8
} from "./chunk-SYR2G6XU.js";
import {
  d as d8
} from "./chunk-NCJWSWGW.js";
import {
  l as l4
} from "./chunk-MHABBCOV.js";
import {
  i as i2
...
var c10 = class extends m {
  ...
  _ensureDataQueryEngine() {
    ...
    const e10 = "timeInfo" in this.layer && this.layer.timeInfo && this.layer.timeInfo.toJSON() || null, t12 = this.layer.objectIdField, r6 = o3.toJSON(this._queryGeometryType), s10 = ((_a = this.layer.fields) == null ? void 0 : _a.map((e11) => e11.toJSON())) ?? [], n11 = this.priority, a9 = this.spatialReference.toJSON(), { hasZ: o5, hasM: u5, featureStore: c12, scheduler: l9 } = this.context;
    return this._dataQueryEngineInstance = new y2({ hasZ: o5, hasM: u5, geometryType: r6, fields: s10, timeInfo: e10, spatialReference: a9, objectIdField: t12, featureStore: c12, scheduler: l9, priority: n11 }), this._dataQueryEngineInstance;
  }
};
...
var y3 = class extends d3 {
  ...
  destroy() {
    this._updateRequested = false, this.handles.removeAll(), this.updatingHandles.removeAll(), this.clear(), this._updateTask = e3(this._updateTask), this._frameTask = o(this._frameTask), this._queryEngine = l(this._queryEngine), this._set("context", null);
  }
  get updating() {
  ...
  runTask(e10) {
    this._updateRequested && (this._updateTask = e3(this._updateTask), this._updateTask = d2(this._updateVisibility), this._updateRequested = false, e10.madeProgress()), this._frameTask.processQueue(e10);
  }
};
...
var A = class extends d3 {
  ...
  highlight(e10, i6) {
    ...
    if ("toArray" in e10 && (e10 = e10.toArray()), Array.isArray(e10) && e10.length > 0) {
      if (e10[0] instanceof h5) {
        const t12 = e10;
        if (null == n9(this.layer.fieldsIndex, t12[0].attributes, i6)) {
        ...
        e10 = t12.map((e11) => n9(this.layer.fieldsIndex, e11.attributes, i6));
      }
  ...
  _setupSuspendResumeExtent() {
    (this.frustumVisibility || this.scaleVisibility) && this.handles.add(l2(() => this.suspendResumeExtentMode, () => {
      switch (this.handles.remove(P2), this.suspendResumeExtentMode) {
        case "computed":
          this.handles.add([l2(() => this.graphicsCore.computedExtent, (e10) => this._updateSuspendResumeExtent(e10), h), l2(() => this.graphicsCore.extentPadding, () => this._updateSuspendResumeExtent(this.graphicsCore.computedExtent))], P2);
          break;
        case "data":
          this.handles.add([f3(() => this.dataExtent, (e10) => this._updateSuspendResumeExtent(e10), h), l2(() => this.graphicsCore.extentPadding, () => this._updateSuspendResumeExtent(this.dataExtent))], P2);
          break;
        default:
...
var _5 = A;
var P2 = "suspendResumeExtentMode";
var U3 = { remove() {
}, pause() {
}, resume() {
} };
...
var N3 = class extends m {
  ...
  set filterExtent(e10) {
    if (null != e10 && this.context.tilingScheme && !e10.spatialReference.equals(this.context.tilingScheme.spatialReference))
      return void P3.error("#filterExtent=", "extent needs to be in the same spatial reference as the tiling scheme");
  ...
  _applyEditsDeleteFeatures(e10) {
    ...
    e10.forEach(({ objectId: e11, globalId: a9 }) => {
      if ((!e11 || e11 < 0) && t12) {
        s10 || P3.errorOncePerTick(`Editing the specified service requires the layer's globalIdField, ${t12} to be included the layer's outFields for updates to be reflected in the view`);
    ...
    for (const i6 of e10)
      if (i6.needsFetching) {
        ...
        if (this._handleRequest(i6, s11, e11, (e12) => {
          i6.setFeatures([], 0, null), this._invalidateCounts(), i6.featuresMissing = false, this.context.logFetchError(P3, e12);
        }), t12.madeProgress())
          return true;
      }
    return t12.hasProgressed;
  ...
  _updated() {
    ...
    if (this._set("running", this._dirty), this._set("updating", t12), t12) {
      ...
      let o5 = 0, u5 = 0;
      t13 ? (u5 = t13, o5 = Math.min(r6 * t13 / i6, t13)) : (u5 = s10, o5 = r6), a9 = Math.min(this.maximumNumberOfFeatures - this.features.length, a9), this._set("updatingTotal", u5), this._set("updatingRemaining", o5), this._set("expectedFeatureDiff", a9);
    } else
  ...
  _updateMaximumNumberOfFeaturesExceeded() {
    const e10 = n(this._featureTiles, (e11) => e11.perTileMaximumNumberOfFeaturesExceeded);
  ...
  _referenceDisplayingFeaturesFromRelatedTiles(e10) {
    ...
    this._featureTiles.forEach((s10) => {
      if (!(null == s10.displayingFeatures || e10 === s10 || e10.descriptor.lij && s10.descriptor.lij && !x3(e10.descriptor.lij, s10.descriptor.lij))) {
        null == e10.displayingFeatures && (e10.displayingFeatures = []), e10.descriptor.extent && s10.descriptor.extent && (null == e10.extentIncludingBorrowedFeatures && (e10.extentIncludingBorrowedFeatures = u2(e10.descriptor.extent)), m2(e10.extentIncludingBorrowedFeatures, s10.descriptor.extent, e10.extentIncludingBorrowedFeatures));
...
var I6 = class extends m3(m) {
  ...
  get mode() {
    ...
    if ("feature" === e10.type && null != e10.infoFor3D)
      return "snapshot";
    if (false === ((_b = (_a = this.layerView.view.qualitySettings) == null ? void 0 : _a.graphics3D) == null ? void 0 : _b.snapshotAvailable) || this.serviceDataCount === P4.NO_SERVICE_DATA_COUNT || this.vertexLimitExceeded)
      return "tiles";
    ...
    if (e10 && e10.minScale && this.serviceDataExtent && r6) {
      ...
      if ((this.serviceDataExtent.width / t13 + this.serviceDataExtent.height / t13) / 2 > P4.MAX_SNAPSHOT_MIN_SCALE_FACTOR)
        return "tiles";
    }
  ...
  constructor(e10) {
    super(e10), this.type = "feature-tile-3d", this._watchUpdatingTracking = new c3(), this.serviceDataExtent = null, this.serviceDataCount = P4.NO_SERVICE_DATA_COUNT, this.vertexLimitExceeded = false, this.displayFeatureLimit = null, this._suspended = false, this._tileFetcher = null, this._handles = new t2(), this._fetchDataInfoPromise = null, this._fetchDataInfoAbortController = null, this._lifeCycleAbortController = new AbortController();
  }
  initialize() {
  ...
  destroy() {
    this._cancelFetchServiceDataInfo(), this._tileFetcher = l(this._tileFetcher), this._handles = l(this._handles), this._tilesHandle = o(this._tilesHandle), this._lifeCycleAbortController = e3(this._lifeCycleAbortController), this._watchUpdatingTracking.destroy(), this._set("_watchUpdatingTracking", null);
  }
  suspend() {
  ...
  _availableFieldsChanged(e10, t12) {
    null != this._tileFetcher && L4(this._tileFetcher.availableFields, t12) && this.refetch();
  }
  _requiredFieldsChanged(e10, t12) {
    null != this._tileFetcher && L4(this._tileFetcher.availableFields, t12) && this.restart();
  }
  ...
  async _tryUpdateServiceDataExtent(e10) {
    ...
    if (r6 && o5 <= P4.MAX_FEATURE_COUNT_FOR_EXTENT && (!s10 || !n11) && "queryExtent" in i6) {
      const t13 = this._createDataInfoQuery(), r7 = await i6.queryExtent(t13, { timeout: P4.QUERY_EXTENT_TIMEOUT, signal: e10 });
  ...
  async _updateServiceDataCount(e10) {
    ...
    if (!("queryFeatureCount" in t12) || !has("featurelayer-snapshot-enabled"))
      return void this._set("serviceDataCount", P4.NO_SERVICE_DATA_COUNT);
    const r6 = await _(t12.queryFeatureCount(this._createDataInfoQuery(), { timeout: P4.QUERY_STATISTICS_TIMEOUT, signal: e10 }));
    if (true === r6.ok)
      this._set("serviceDataCount", r6.value);
    else {
      if (d(r6.error))
        throw r6.error;
      this._set("serviceDataCount", P4.NO_SERVICE_DATA_COUNT);
    }
  }
  get vertexLimitInfo() {
  ...
  async _updateVertexLimitExceeded(e10, t12) {
    ...
    const c12 = this.serviceDataCount, u5 = c12 !== P4.NO_SERVICE_DATA_COUNT;
    if (h9 = u5 ? Math.ceil((o5 - c12 * l9) / (n11 || 1)) : Math.ceil(o5 / (n11 || 1)), a9 && (h9 = Math.min(h9, N4)), u5 && this._minimumNumberOfVerticesForGeometry * c12 > h9)
    ...
    const d13 = await _(this.layerView.layer.queryFeatures(this._createVertexLimitExceededQuery(h9), { timeout: P4.QUERY_STATISTICS_TIMEOUT, signal: t12 }));
    if (false === d13.ok) {
      if (d(d13.error))
        throw d13.error;
      return void this._set("vertexLimitExceeded", false);
...
d10.shader = new t8(a8, () => import("./Heatmap.glsl-QVJFLKH5.js"));
...
f7.shader = new t8(d8, () => import("./HeatmapDensity.glsl-DF3SDFUL.js"));
...
var d12 = class extends d6 {
  ...
  intersectDraped(r6, s10, i6, a9, o5, n11) {
    ...
    for (let u5 = 0; u5 < d13; u5++) {
      const r7 = u5 * l9.size, s11 = r(E7, l9.data[r7], l9.data[r7 + 1]);
...
function n10(n11, i6) {
  const { textureFloat: f8, colorBufferFloat: s10 } = n11.capabilities, u5 = f8 == null ? void 0 : f8.textureFloat, m9 = f8 == null ? void 0 : f8.textureFloatLinear, _7 = f8 == null ? void 0 : f8.textureHalfFloat, p2 = f8 == null ? void 0 : f8.textureHalfFloatLinear, d13 = f8 == null ? void 0 : f8.HALF_FLOAT, x5 = s10 == null ? void 0 : s10.textureFloat, b7 = s10 == null ? void 0 : s10.textureHalfFloat, c12 = s10 == null ? void 0 : s10.floatBlend, h9 = u(n11.driverTest).floatBufferBlend.result;
  if (!u5 && !_7)
  ...
  if (!(c12 && h9 || b7))
    throw new s2("heatmap:missing-float-blend", "HeatmapRenderer requires the WebGL extension EXT_float_blend or EXT_color_buffer_half_float." + (h9 ? "" : " This device claims support for EXT_float_blend, but does not actually support it."));
  const E9 = u5 && x5 && c12 && h9, F5 = _7 && b7, R4 = m9, L5 = p2, T3 = !!(s10 == null ? void 0 : s10.R32F), w3 = !!(s10 == null ? void 0 : s10.R16F);
  if (E9 && (R4 || !L5))
    return R4 || i6.warnOnce("Missing WebGL extension OES_texture_float_linear. Heatmap quality may be reduced."), { dataType: U2.FLOAT, samplingMode: R4 ? L2.LINEAR : L2.NEAREST, pixelFormat: T3 ? G.RED : G.RGBA, internalFormat: T3 ? P.R32F : G.RGBA };
  if (F5)
    return L5 || i6.warnOnce("Missing WebGL extension OES_texture_half_float_linear. Heatmap quality may be reduced."), { dataType: d13, samplingMode: L5 ? L2.LINEAR : L2.NEAREST, pixelFormat: w3 ? G.RED : G.RGBA, internalFormat: w3 ? P.R16F : G.RGBA };
...
var q3 = class extends d3 {
  ...
  initialize() {
    ...
    const { dataType: e10, samplingMode: t12, pixelFormat: r6, internalFormat: i6 } = n10(this._renderView.renderingContext, z3);
  ...
  get _radiusParameter() {
    return n2(this._heatmapRenderer, ({ radius: e10 }) => ({ searchRadius: u3(this._clampSearchRadius(e10)) }));
  }
  get _resolutionForScaleParameter() {
    return n2(this._heatmapRenderer, ({ referenceScale: e10 }) => ({ resolutionForScale: 0 === e10 ? 0 : r3(e10, this.view.spatialReference) }));
  }
  get _colorRampParameter() {
    return n2(this._heatmapRenderer, (e10) => ({ colorRampData: u4(e10.colorStops) }));
  }
  ...
  get _heatmapRendererFieldName() {
    return n2(this._heatmapRenderer, (e10) => e10.field);
  }
  get _heatmapRendererField() {
    return n2(this._heatmapRendererFieldName, (e10) => this.layer.fieldsIndex.get(e10));
  }
  ...
  _onLoadedFeaturesChange(e10) {
    ...
    this._featureStore.removeManyById(e10.removed.map((e11) => I3(e11, r6))), this._featureStore.addMany(e10.added.map((e11) => {
      const t12 = new t3(L(new t4(), e11.geometry), e11.attributes, n2(e11.centroid, (e12) => L(new t4(), e12)), I3(e11, r6));
...
//# sourceMappingURL=chunk-57BN4YG4.js.map
