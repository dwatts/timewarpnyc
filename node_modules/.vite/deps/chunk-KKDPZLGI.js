...
async function C2(e3) {
  const { computeObjectLayerResourceSize: t } = await import("./symbolLayerUtils-ABYZINA5.js"), o = await t(e3, 10), { width: n2, height: r, depth: l3 } = e3, i2 = [n2, l3, r];
  let c2 = 1;
  for (let s = 0; s < 3; s++) {
    const e4 = i2[s];
    if (null != e4) {
...
//# sourceMappingURL=chunk-KKDPZLGI.js.map
