    ...
    if (r4 && s5)
      for (const i5 of e3) {
        ...
        i5.sourceLayer && "geometryType" in i5.sourceLayer && "point" === i5.sourceLayer.geometryType && e4 && "getSymbolAsync" in e4 && e4.getSymbolAsync(i5).then(async (o3) => {
          ...
          n6 && (P || (P = (await import("./visualVariableUtils-K2CP7FHE.js")).getSize), a6 = P(n6, i5, { view: t.type, scale: t.scale, shape: "simple-marker" === o3.type ? o3.style : null })), a6 || (a6 = "width" in o3 && "height" in o3 && null != o3.width && null != o3.height ? Math.max(o3.width, o3.height) : "size" in o3 ? o3.size : 16), r4.includes(i5) && (i5.symbol = new y2({ style: "square", size: a6, xoffset: "xoffset" in o3 ? o3.xoffset : 0, yoffset: "yoffset" in o3 ? o3.yoffset : 0 }), s5(i5, "symbol"), i5.visible = true);
        });
      }
  }
...
//# sourceMappingURL=chunk-VDIVZBS2.js.map
