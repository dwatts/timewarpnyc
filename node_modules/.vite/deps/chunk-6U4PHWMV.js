...
var r = { convertToGEGeometry: s, exportPoint: a, exportPolygon: c, exportPolyline: h, exportMultipoint: m2, exportExtent: x2 };
function s(e, n) {
  if (null == n)
    return null;
...
function a(e, n, o) {
  const i = e.hasZ(n), r2 = e.hasM(n), s2 = new x({ x: e.getPointX(n), y: e.getPointY(n), spatialReference: o });
...
function h(e, n, t) {
  const o = new m({ paths: e.exportPaths(n), hasZ: e.hasZ(n), hasM: e.hasM(n), spatialReference: t });
...
function x2(n, t, o) {
  const i = n.hasZ(t), r2 = n.hasM(t), s2 = new M({ xmin: n.getXMin(t), ymin: n.getYMin(t), xmax: n.getXMax(t), ymax: n.getYMax(t), spatialReference: o });
  if (i) {
...
//# sourceMappingURL=chunk-6U4PHWMV.js.map
