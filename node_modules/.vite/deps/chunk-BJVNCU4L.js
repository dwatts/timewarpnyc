...
function i(t, n, l2, s) {
  ...
  if (n && u2)
    c3 = n;
  else if (n && "pointCloudUniqueValueRenderer" === (i2 == null ? void 0 : i2.type)) {
    a4 = a2.fromJSON(i2);
  ...
  } else if (n && "pointCloudStretchRenderer" === (i2 == null ? void 0 : i2.type)) {
    a4 = a.fromJSON(i2);
    const e = a4.stops;
    c3 = new Uint8Array(3 * s);
    ...
    for (let r = 0; r < s; r++) {
      ...
      if (t2 < e[0].value)
        c3[3 * r] = e[0].color.r, c3[3 * r + 1] = e[0].color.g, c3[3 * r + 2] = e[0].color.b;
      else if (t2 >= e[l3].value)
        c3[3 * r] = e[l3].color.r, c3[3 * r + 1] = e[l3].color.g, c3[3 * r + 2] = e[l3].color.b;
      else
  ...
  } else if (n && "pointCloudClassBreaksRenderer" === (i2 == null ? void 0 : i2.type)) {
    a4 = d.fromJSON(i2);
    ...
    c3 = new Uint8Array(3 * s).fill(255);
...
function u(e, r) {
  if (null == e.encoding || "" === e.encoding) {
    ...
    for (let e2 = 0; e2 < c3; e2++)
      a4[3 * e2] = l2[3 * e2] * u2[0] + i2[0], a4[3 * e2 + 1] = l2[3 * e2 + 1] * u2[1] + i2[1], a4[3 * e2 + 2] = l2[3 * e2 + 2] * u2[2] + i2[2];
    return a4;
  }
...
function c2(e, r, o) {
  return null != e && e.attributeInfo.useElevation ? r ? a3(r, o) : null : null != e && e.attributeInfo.storageInfo ? I(e.attributeInfo.storageInfo, e.buffer, o) : null;
}
function a3(e, r) {
...
//# sourceMappingURL=chunk-BJVNCU4L.js.map
