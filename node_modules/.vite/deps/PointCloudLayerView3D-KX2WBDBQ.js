...
var h9 = class {
  ...
  add(t11) {
    const i6 = new s6(t11);
    return this._highlights.add(i6), this._enableSet(i6), e2(() => this._removeSet(i6));
  }
  _removeSet(e9) {
...
m3.shader = new t5(C2, () => import("./PointRenderer.glsl-KI3HQ23R.js"));
...
var ge = class extends i5(n4(d2)) {
  ...
  destroy() {
    this.cancelLoading(), this._worker = l(this._worker), this._destroyRenderer(), this._memCache = l(this._memCache), this._codedDomainPopulationAbortController = e3(this._codedDomainPopulationAbortController), this._codedDomainPopulationPromise = null;
  }
  _initRenderer() {
...
//# sourceMappingURL=PointCloudLayerView3D-KX2WBDBQ.js.map
