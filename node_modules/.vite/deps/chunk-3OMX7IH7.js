...
var a3 = { visible: "visibleSublayers" };
var l = class extends a2(m) {
  constructor(e2) {
    super(e2), this.scale = 0;
  }
  set layer(e2) {
    this._get("layer") !== e2 && (this._set("layer", e2), this.handles.remove("layer"), e2 && this.handles.add([e2.sublayers.on("change", () => this.notifyChange("visibleSublayers")), e2.on("wms-sublayer-update", (e3) => this.notifyChange(a3[e3.propertyName]))], "layer"));
  }
  get layers() {
  ...
  get visibleSublayers() {
    const { layer: e2, scale: r } = this, s = e2 == null ? void 0 : e2.sublayers, t = [], o = (e3) => {
      const { minScale: s2, maxScale: a4, sublayers: l2, visible: i } = e3;
      i && (0 === r || (0 === s2 || r <= s2) && (0 === a4 || r >= a4)) && (l2 ? l2.forEach(o) : t.push(e3));
    };
    return s == null ? void 0 : s.forEach(o), t;
  }
  toJSON() {
    const { layer: e2, layers: r } = this, { imageFormat: s, imageTransparency: t, version: o } = e2;
    return { format: s, request: "GetMap", service: "WMS", styles: "", transparent: t ? "TRUE" : "FALSE", version: o, layers: r };
  }
};
...
//# sourceMappingURL=chunk-3OMX7IH7.js.map
