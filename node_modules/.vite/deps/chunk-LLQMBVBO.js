...
function d(i3) {
  return i3 ? m(t2(i3.origin), t2(i3.direction)) : m(n(), n());
}
function m(i3, n7) {
  return { origin: i3, direction: n7 };
}
function j(n7, r4) {
  return s(n7.origin, r4.origin) && s(n7.direction, r4.direction);
}
function p2(i3, n7) {
  const r4 = S.get();
...
function k(i3, n7 = d()) {
  return v3(i3.origin, i3.direction, n7);
}
function h(i3, n7, o4 = d()) {
  return r(o4.origin, i3), e(o4.direction, n7, i3), o4;
}
function v3(i3, n7, t4 = d()) {
  return r(t4.origin, i3), r(t4.direction, n7), t4;
}
function b(i3, n7) {
  const r4 = _(c2.get(), z(c2.get(), i3.direction), e(c2.get(), n7, i3.origin));
  return P(r4, r4);
}
function q(i3, n7, r4) {
...
function f2(n7, o4) {
  return P(n7, o4) / s3(n7);
}
function a4(o4, s5) {
  const c3 = P(o4, s5) / (s3(o4) * s3(s5));
  return -l(c3);
}
function i2(o4, r4, u4) {
  z(m2, o4), z(h2, r4);
  const e2 = P(m2, h2), f3 = l(e2), a5 = _(m2, m2, h2);
...
function N(n7, r4, e2) {
  return s2.getLogger("esri.geometry.support.sphere").error("sphere.setExtent is not yet supported"), n7 === e2 ? e2 : q2(n7, e2);
}
function Z(t4, n7, r4) {
  if (null == n7)
    return false;
  ...
  const i3 = o4[0] * o4[0] + o4[1] * o4[1] + o4[2] * o4[2];
  if (0 === i3)
    return false;
  const a5 = 2 * (o4[0] * s5[0] + o4[1] * s5[1] + o4[2] * s5[2]), c3 = a5 * a5 - 4 * i3 * (s5[0] * s5[0] + s5[1] * s5[1] + s5[2] * s5[2] - t4[3] * t4[3]);
  if (c3 < 0)
    return false;
  const u4 = Math.sqrt(c3);
  let f3 = (-a5 - u4) / (2 * i3);
  const m3 = (-a5 + u4) / (2 * i3);
  return (f3 < 0 || m3 < f3 && m3 > 0) && (f3 = m3), !(f3 < 0) && (r4 && (r4[0] = e2[0] + o4[0] * f3, r4[1] = e2[1] + o4[1] * f3, r4[2] = e2[2] + o4[2] * f3), true);
}
var U = n();
function V(t4, n7) {
  return Z(t4, n7, null);
...
function X(t4, n7, r4) {
  ...
  return u2(r4, n7.origin, g(c2.get(), n7.direction, x(n7.origin, e2) / s3(n7.direction))), r4;
}
function Y(t4, n7, r4) {
  const o4 = c2.get(), s5 = f.get();
  _(o4, n7.origin, n7.direction);
  const a5 = k2(t4);
  _(r4, o4, n7.origin), g(r4, r4, 1 / s3(r4) * a5);
...
function D(t4, n7, r4) {
  const e2 = e(c2.get(), n7, z2(t4)), o4 = g(c2.get(), e2, t4[3] / s3(e2));
...
function G(t4, r4) {
  const e2 = e(c2.get(), r4, z2(t4)), o4 = s3(e2), s5 = k2(t4), i3 = s5 + Math.abs(s5 - o4);
  return l(s5 / i3);
}
var H = n();
function I(t4, n7, e2, o4) {
  ...
  switch (e2) {
    ...
    case n6.Y: {
      const t5 = v2(s5, H), n8 = t5[1], e3 = t5[2], i3 = Math.sin(n8);
      return o(o4, -i3 * Math.cos(e3), -i3 * Math.sin(e3), Math.cos(n8));
    }
    case n6.Z:
      return z(o4, s5);
    default:
...
var $ = n();
var tt = _2();
var nt = Object.freeze(Object.defineProperty({ __proto__: null, NullSphere: R, altitudeAt: J, angleToSilhouette: G, axisAt: I, clear: O2, closestPoint: B, closestPointOnSilhouette: Y, containsPoint: Q, copy: q2, create: _2, distanceToSilhouette: F, elevate: L, fromCenterAndRadius: w, fromRadius: T, fromValues: E2, getCenter: z2, getRadius: k2, intersectRay: Z, intersectRayClosestSilhouette: X, intersectsRay: V, projectPoint: D, setAltitudeAt: K, setExtent: N, tmpSphere: tt, union: W, wrap: C }, Symbol.toStringTag, { value: "Module" }));
...
//# sourceMappingURL=chunk-LLQMBVBO.js.map
