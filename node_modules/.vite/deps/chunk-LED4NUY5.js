...
e([y({ type: Number, json: { write: true } })], a6.prototype, "code", void 0), e([y({ type: Object, json: { write: true } })], a6.prototype, "defaultValues", void 0), e([y({ json: { write: true } })], a6.prototype, "domains", void 0), e([o2("domains")], a6.prototype, "readDomains", null), e([r("domains")], a6.prototype, "writeDomains", null), e([y({ type: String, json: { write: true } })], a6.prototype, "name", void 0), a6 = e([a2("esri.layers.support.Subtype")], a6);
var c6 = a6;
...
var N = { key: "type", base: p4, errorContext: "renderer", typeMap: { simple: p5, "unique-value": A, "class-breaks": w } };
var $ = s4();
var k2 = u({ types: N });
var M2 = 0;
function _2(e3) {
...
function J(e3, t3) {
  ...
  return i4[t3.subtypeField] = e3, new p6({ name: "New Feature", drawingTool: r3, prototype: { attributes: i4 } });
}
...
var W = class extends a4(O(s3(_))) {
  ...
  set renderer(e3) {
    c5(e3, this.fieldsIndex), this._override("renderer", e3);
  }
  get renderer() {
  ...
  hasUserOverrides() {
    return G.some((e3) => this.originIdOf(e3) === r2.USER);
  }
  ...
  async queryFeatures(e3, t3) {
    ...
    const i4 = b2.from(e3) ?? r3.createQuery();
...
e([y({ readOnly: true, json: { read: false } })], W.prototype, "capabilities", null), e([y({ readOnly: true, json: { read: false } })], W.prototype, "effectiveCapabilities", null), e([y({ json: { write: { ignoreOrigin: true } } })], W.prototype, "charts", void 0), e([y({ type: Boolean, nonNullable: true, json: { name: "enableEditing", write: { ignoreOrigin: true } } })], W.prototype, "editingEnabled", void 0), e([y({ type: Boolean, readOnly: true })], W.prototype, "effectiveEditingEnabled", null), e([y({ readOnly: true, json: { read: false } })], W.prototype, "elevationInfo", null), e([y({ readOnly: true, json: { name: "layerDefinition.fieldOverrides", origins: { service: { read: false } }, write: { ignoreOrigin: true, allowNull: true } } })], W.prototype, "fieldOverrides", void 0), e([r("fieldOverrides")], W.prototype, "writeFieldOverrides", null), e([y({ ...$.fields, readOnly: true, json: { read: false } })], W.prototype, "fields", null), e([y($.fieldsIndex)], W.prototype, "fieldsIndex", void 0), e([y({ readOnly: true, json: { read: false } })], W.prototype, "floorInfo", null), e([y({ type: y2, json: { name: "formInfo", write: { ignoreOrigin: true } } })], W.prototype, "formTemplate", void 0), e([y({ type: String, readOnly: true, json: { origins: { service: { read: false } }, write: { ignoreOrigin: true } } })], W.prototype, "id", void 0), e([y({ readOnly: true, json: { read: false } })], W.prototype, "geometryType", null), e([y({ readOnly: true, json: { read: false } })], W.prototype, "type", void 0), e([y(_2(a(m)))], W.prototype, "labelsVisible", void 0), e([y({ type: [C], json: { name: "layerDefinition.drawingInfo.labelingInfo", origins: { service: { read: false } }, read: { reader: i3 }, write: { ignoreOrigin: true } } })], W.prototype, "labelingInfo", void 0), e([y({ type: ["ArcGISFeatureLayer"], readOnly: true, json: { read: false, write: { ignoreOrigin: true } } })], W.prototype, "layerType", void 0), e([y(_2(a(c)))], W.prototype, "legendEnabled", void 0), e([y({ type: ["show", "hide"] })], W.prototype, "listMode", void 0), e([y((() => {
  const e3 = a(I);
  return e3.json.origins.service.read = false, _2(e3);
})())], W.prototype, "minScale", void 0), e([y((() => {
  const e3 = a(D);
  return e3.json.origins.service.read = false, _2(e3);
})())], W.prototype, "maxScale", void 0), e([y({ readOnly: true })], W.prototype, "effectiveScaleRange", null), e([y({ readOnly: true, json: { read: false } })], W.prototype, "objectIdField", null), e([y({ type: Number, range: { min: 0, max: 1 }, nonNullable: true, json: { write: { ignoreOrigin: true } } })], W.prototype, "opacity", void 0), e([y()], W.prototype, "parent", void 0), e([y(_2(a(p2)))], W.prototype, "popupEnabled", void 0), e([y({ type: k, json: { name: "popupInfo", write: { ignoreOrigin: true } } })], W.prototype, "popupTemplate", void 0), e([y({ readOnly: true })], W.prototype, "defaultPopupTemplate", null), e([y({ types: N, json: { write: { target: "layerDefinition.drawingInfo.renderer", ignoreOrigin: true } } })], W.prototype, "renderer", null), e([o2("service", "renderer", ["drawingInfo.renderer", "subtypeField", "type"])], W.prototype, "readRendererFromService", null), e([o2("renderer", ["layerDefinition.drawingInfo.renderer"])], W.prototype, "readRenderer", null), e([y({ readOnly: true, json: { read: false } })], W.prototype, "spatialReference", null), e([y({ type: Number, json: { origins: { service: { read: false } }, write: { ignoreOrigin: true } } })], W.prototype, "subtypeCode", void 0), e([y({ type: [p6], json: { name: "layerDefinition.templates", write: { ignoreOrigin: true } } })], W.prototype, "templates", void 0), e([o2("service", "templates", ["geometryType", "subtypeField", "subtypes", "type"])], W.prototype, "readTemplatesFromService", null), e([y({ type: String, json: { write: { ignoreOrigin: true } } })], W.prototype, "title", void 0), e([o2("service", "title", ["subtypes"])], W.prototype, "readTitleFromService", null), e([y({ readOnly: true, json: { read: false } })], W.prototype, "url", null), e([y({ readOnly: true })], W.prototype, "userHasUpdateItemPrivileges", null), e([y({ type: Boolean, nonNullable: true, json: { name: "visibility", write: { ignoreOrigin: true } } })], W.prototype, "visible", void 0), W = e([a2(K)], W);
var X = (e3, t3, r3) => {
...
var se = s4();
var ie = class extends w2(c3(a3(a5(t2(p3(l3(c2(j(O(o3(i2(a4(b))))))))))))) {
  constructor(...e3) {
  ...
  async createGraphicsSource(e3) {
    const { default: r3 } = await p(import("./FeatureLayerSource-6D3CAPNQ.js"), e3);
  ...
  async queryAttachments(e3, r3) {
    return j2(this, e3, r3, ee);
  }
  async queryFeatures(e3, r3) {
    const t3 = await this.load(), s5 = b2.from(e3) ?? t3.createQuery(), i4 = s5.outFields ?? [];
  ...
  async _initLayerProperties(e3) {
    ...
    this._verifyFields(), p8(this.timeInfo, this.fieldsIndex);
  }
...
//# sourceMappingURL=chunk-LED4NUY5.js.map
