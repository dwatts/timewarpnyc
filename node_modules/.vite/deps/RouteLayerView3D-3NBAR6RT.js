...
function I(e2) {
  return e2 instanceof m || e2 instanceof c || e2 instanceof C || e2 instanceof T || e2 instanceof j || e2 instanceof S || e2 instanceof O;
}
var S2 = class extends n2(d) {
  constructor() {
  ...
  initialize() {
    this._set("processor", new x({ owner: this, scaleVisibilityEnabled: true, frustumVisibilityEnabled: true })), this.addResolvingPromise(this.processor.initializePromise), this.updatingHandles.addOnCollectionChange(() => this._routeItems, (e2) => this._routeItemsChanged(e2), h), this.addResolvingPromise(l3(this).then((e2) => this.fullExtentInLocalViewSpatialReference = e2)), this.handles.add(f(() => {
      var _a, _b;
  ...
  destroy() {
    var _a;
    this.handles.removeAll(), this.updatingHandles.removeAll(), this._set("processor", l(this.processor)), (_a = this._get("_routeItems")) == null ? void 0 : _a.destroy();
  }
  get _routeItems() {
    return new n({ getCollections: () => [this.layer.pointBarriers, this.layer.polygonBarriers, this.layer.polylineBarriers, this.layer.stops, this.layer.directionLines, this.layer.directionPoints, null != this.layer.routeInfo ? new V([this.layer.routeInfo]) : null] });
  }
  _routeItemsChanged(e2) {
    ...
    if (e2.added.length) {
      ...
      for (const t of e2.added)
        this.handles.add([l2(() => t.geometry, (e3, r2) => {
  ...
  getSuspendInfo() {
    ...
    return e2.outsideScaleRange = ((_a = this.processor) == null ? void 0 : _a.scaleVisibilitySuspended) ?? false, e2.outsideOfView = ((_b = this.processor) == null ? void 0 : _b.frustumVisibilitySuspended) ?? false, e2;
  }
  async fetchPopupFeatures(e2, t) {
    return (t == null ? void 0 : t.clientGraphics) ?? [];
  }
  getHit(e2) {
  ...
  computeAttachmentOrigin(e2, t) {
    var _a;
    return (_a = this.processor) == null ? void 0 : _a.computeAttachmentOrigin(e2, t);
  }
  ...
  highlight(e2) {
    return I(e2) && (e2 = this._byObjectID.get(e2)), this.processor.highlight(e2);
  }
  get updatePolicy() {
    var _a;
  ...
  isUpdating() {
    var _a, _b, _c;
    return !(!((_a = this.processor) == null ? void 0 : _a.updating) && ((_c = (_b = this.view) == null ? void 0 : _b.basemapTerrain) == null ? void 0 : _c.ready));
  }
  get performanceInfo() {
    var _a, _b;
  ...
  _updateGraphic(e2, t, r2, s) {
    ...
    o[t] = r2, _.graphic = o, _.property = t, _.oldValue = s, _.newValue = r2, (_a = this.processor) == null ? void 0 : _a.graphicsCore.graphicUpdateHandler(_);
  }
};
e([y()], S2.prototype, "_routeItems", null), e([y()], S2.prototype, "loadedGraphics", void 0), e([y({ readOnly: true })], S2.prototype, "legendEnabled", null), e([y()], S2.prototype, "layer", void 0), e([y({ readOnly: true })], S2.prototype, "processor", void 0), e([y({ type: Boolean })], S2.prototype, "slicePlaneEnabled", void 0), S2 = e([a("esri.views.3d.layers.RouteLayerView3D")], S2);
var _ = { graphic: null, property: null, oldValue: null, newValue: null };
var O2 = S2;
export {
  O2 as default
};
//# sourceMappingURL=RouteLayerView3D-3NBAR6RT.js.map
