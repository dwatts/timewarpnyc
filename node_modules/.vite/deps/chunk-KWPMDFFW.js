...
function r(n, i, r2) {
  ...
  if (!c(n) || u2 === a.Unsupported)
    return new s("layerview:unsupported-height-model-info", "The vertical coordinate system of the layer is not supported", { heightModelInfo: s3 });
  switch (u2) {
    case a.Units: {
...
function o(e, t, n) {
  ...
  if (e.heightModel !== t.heightModel)
    return a.HeightModel;
  switch (e.heightModel) {
    case "gravity-related-height":
      return a.Ok;
    case "ellipsoidal":
      return e.vertCRS === t.vertCRS ? a.Ok : a.CRS;
    default:
      return a.Unsupported;
  }
}
...
function l(e) {
  var _a;
  const i = e.url ? p(e.url) : void 0, r2 = (_a = e.spatialReference) == null ? void 0 : _a.vcsWkid;
  return !(null == r2 && null != i && "ImageServer" === i.serverType) && h(e) && e.heightModelInfo ? e.heightModelInfo : d(e) ? v.deriveUnitFromSR(p2, e.spatialReference) : null;
}
function h(e) {
...
var p2 = new v({ heightModel: "gravity-related-height" });
...
//# sourceMappingURL=chunk-KWPMDFFW.js.map
