...
import {
  ...
  H,
  n as n9
} from "./chunk-NVTTC6CF.js";
import {
  c as c4,
  y as y5
} from "./chunk-J374ZWQD.js";
...
import "./chunk-DBYXBMGX.js";
import "./chunk-NPHQ76KV.js";
import "./chunk-TC7VA65I.js";
import "./chunk-NGB5RAIG.js";
import {
  s as s11
} from "./chunk-3W7W7IYY.js";
import {
  A as A5,
  E,
  H as H2,
...
function D3(n16, r17, l15, u12) {
  ...
  if (!Hn(n16, l15, U4, s14) || !Hn(r17, l15, S2, s14))
    return null;
  if (u12 === a13.Direct) {
    return { direct: x3(S2, U4), unit: f12 };
  }
  ...
  return { direct: x3(S2, U4), horizontal: h17, vertical: Math.abs(p16), unit: f12 };
}
!function(n16) {
...
function T3(n16, o13, a17) {
  ...
  if (null == c9)
    return null;
  const l15 = o13 === t6.Vertical ? x(c9.value, c9.unit, a17) : C(c9.value, c9.unit, a17);
  return f4(c9, l15);
}
function w3(e13) {
  ...
  _addComputation(t15) {
    this._handles.has(t15) || this._handles.add(l3(() => w3(t15), (s14) => {
      ...
      if (W2(s14) && o13 !== t6.Direct) {
        const e13 = Math.round(j2(X3, "meters", "kilometers"));
...
e([y({ constructOnly: true })], g6.prototype, "analysisViewData", void 0), e([y({ constructOnly: true })], g6.prototype, "view", void 0), e([y()], g6.prototype, "analysis", null), e([y()], g6.prototype, "_defaultUnit", null), g6 = e([a("esri.views.3d.analysis.Dimension.support.DimensionController")], g6);
...
function le(e13, { isStart: t15, createSnappingPipelineStep: n16, dimension: r17, onUpdate: o13, view: i6 }) {
  const a17 = t15 ? "startPoint" : "endPoint", s14 = d4(e13, (e14, t16, s15, c9) => {
    ...
    s15 = s15.next(m8).next(R3(r17, [a17, "measureType", "orientation"])).next(l15), t16.next(m8).next(F3(i6)).next(...d9).next((e15) => {
      const t17 = x4(e15.mapEnd, new x2());
...
function ge(e13, t15, n16) {
  ...
  if (null == s14 || null == c9)
    return;
  const m8 = K(s14, a17), d9 = K(c9, a17), l15 = je(i6, n16), u12 = s6.shortestSignedDiff(l15, m8), f12 = s6.shortestSignedDiff(l15, d9);
...
function f9(e13, t15, { constraint: n16, view: i6 }) {
  ...
  if (null == o13)
    return;
  const { renderCoordsHelper: r17, spatialReference: a17 } = i6, { startRenderSpace: s14, endRenderSpace: l15 } = o13.directSegment, d9 = r17.fromRenderCoords(s14, new x2(), a17), c9 = r17.fromRenderCoords(l15, new x2(), a17);
  let m8;
  ...
  _updateLineSegmentInfinite(e13, t15) {
    ...
    switch (y3(this._ray, x6), e13) {
      ...
      case V5.GROUND_RAY: {
        ...
        this._isWorldDown && r18 < t16 && j3(x6.ray.direction, x6.ray.direction), this._extensionType === V5.GROUND_RAY && null != t16 && (x6.c1 = Math.abs(r18 - t16));
        break;
      }
    }
...
var x7 = class extends t10 {
  ...
  _computeStartEnd(e13, t15, r17, s14, i6, n16) {
    const d9 = l6(P6, r4(P6, e13[1] * r17, e13[0] * -r17), s14 + i6 / 2), h17 = s5(A6, s5(A6, s5(A6, t15, l6(A6, e13, n16 / 2)), d9), d9);
    return { start: h17, end: s5(M4, h17, l6(M4, e13, -n16)) };
  }
};
var V6 = n4();
var P6 = n6();
...
e([y({ type: Boolean })], o8.prototype, "enabled", void 0), o8 = e([a("esri.views.interactive.snapping.Settings.DefaultSnappingAlgorithm")], o8);
...
e([y({ type: o8, constructOnly: true, nonNullable: true, json: { write: true } })], l11.prototype, "lineSnapper", void 0), e([y({ type: o8, constructOnly: true, nonNullable: true, json: { write: true } })], l11.prototype, "parallelLineSnapper", void 0), e([y({ type: o8, constructOnly: true, nonNullable: true, json: { write: true } })], l11.prototype, "rightAngleSnapper", void 0), e([y({ type: o8, constructOnly: true, nonNullable: true, json: { write: true } })], l11.prototype, "rightAngleTriangleSnapper", void 0), e([y({ type: Number, nonNullable: true, range: { min: -1, max: 50, step: 1 }, json: { write: true } })], l11.prototype, "shortLineThreshold", void 0), e([y({ type: Number, nonNullable: true, range: { min: -1, max: 50, step: 1 }, json: { write: true } })], l11.prototype, "distance", void 0), e([y({ type: Number, nonNullable: true, range: { min: 0, max: 1e-5 }, json: { write: true } })], l11.prototype, "pointThreshold", void 0), e([y({ type: Number, nonNullable: true, range: { min: 0, max: 1e-5 }, json: { write: true } })], l11.prototype, "intersectionParallelLineThreshold", void 0), e([y({ type: Number, nonNullable: true, range: { min: 0, max: 1e-5 }, json: { write: true } })], l11.prototype, "parallelLineThreshold", void 0), e([y({ type: Number, nonNullable: true, range: { min: 0, max: 1 }, json: { write: true } })], l11.prototype, "verticalLineThreshold", void 0), e([y({ type: Number, nonNullable: true, range: { min: 0, max: 10 }, json: { write: true } })], l11.prototype, "touchSensitivityMultiplier", void 0), e([y({ type: Number, nonNullable: true, range: { min: 0, max: 1e-5 }, json: { write: true } })], l11.prototype, "pointOnLineThreshold", void 0), e([y({ type: h3, nonNullable: true })], l11.prototype, "orange", void 0), e([y({ type: h3, nonNullable: true })], l11.prototype, "orangeTransparent", void 0), e([y({ type: Number, nonNullable: true, range: { min: 0, max: 10 }, json: { write: true } })], l11.prototype, "lineHintWidthReference", void 0), e([y({ type: Number, nonNullable: true, range: { min: 0, max: 10 }, json: { write: true } })], l11.prototype, "lineHintWidthTarget", void 0), e([y({ type: Number, nonNullable: true, range: { min: 0, max: 1 }, json: { write: true } })], l11.prototype, "lineHintFadedExtensions", void 0), e([y({ type: Number, nonNullable: true, range: { min: 0, max: 10 }, json: { write: true } })], l11.prototype, "parallelLineHintWidth", void 0), e([y({ type: Number, nonNullable: true, range: { min: 0, max: 50 }, json: { write: true } })], l11.prototype, "parallelLineHintLength", void 0), e([y({ type: Number, nonNullable: true, range: { min: 0, max: 5 }, json: { write: true } })], l11.prototype, "parallelLineHintOffset", void 0), e([y({ type: Number, nonNullable: true, range: { min: 0, max: 46 }, json: { write: true } })], l11.prototype, "rightAngleHintSize", void 0), e([y({ type: Number, nonNullable: true, range: { min: 0, max: 6 }, json: { write: true } })], l11.prototype, "rightAngleHintOutlineSize", void 0), e([y({ type: Number, nonNullable: true, range: { min: 0, max: 5 }, json: { write: true } })], l11.prototype, "satisfiesConstraintScreenThreshold", void 0), l11 = e([a("esri.views.interactive.snapping.Settings.Defaults")], l11);
var p10 = new l11();
...
var O4 = class extends r13 {
  ...
  visualizeIntersectionPoint(e13, n16) {
    ...
    return o(new y5({ view: r17, primitive: "circle", geometry: p6(e13.intersectionPoint, t15), elevationInfo: e13.isDraped ? p4 : b3, size: 20, outlineSize: 2, color: o13.intersectionPointColor, outlineColor: o13.intersectionPointOutlineColor, pixelSnappingEnabled: false }));
  }
  visualizePoint(e13, n16) {
    const { view: t15, spatialReference: r17 } = n16, o13 = R4(), l15 = A7(e13.point, e13.domain, n16);
    return o(new y5({ view: t15, primitive: "circle", geometry: p6(l15, r17), elevationInfo: H5(e13, n16), size: 20, outlineSize: 2, color: o13.pointColor, outlineColor: o13.pointOutlineColor, pixelSnappingEnabled: false }));
  }
  visualizeLine(e13, n16) {
    ...
    return o(this._createLineSegmentHint(e13.type, l15, a17, r17, H5(e13, n16), t15, o13, e13.isDraped, e13.fadeLeft, e13.fadeRight));
  }
  visualizeParallelSign(e13, n16) {
    ...
    return E5.setDirectionFromPoints(u12, h17), E5.attached = true, o(E5);
  }
  visualizeRightAngleQuad(e13, n16) {
    ...
    return o(new P3({ view: t15, attached: true, color: a17 ? o13.rightAngleColorDraped : o13.rightAngleColor, renderOccluded: a17 ? o5.OccludeAndTransparent : o5.Transparent, outlineRenderOccluded: a17 ? o5.OccludeAndTransparent : o5.Opaque, outlineColor: o13.rightAngleOutlineColor, outlineSize: p10.rightAngleHintOutlineSize, size: p10.rightAngleHintSize, isDraped: a17, geometry: { previous: d9, center: v16, next: h17 }, renderGroup: a7.SnappingHint }));
  }
...
e([y({ constructOnly: true })], e11.prototype, "layer", void 0), e([y()], e11.prototype, "enabled", void 0), e([y()], e11.prototype, "updating", void 0), e([y()], e11.prototype, "availability", void 0), e11 = e([a("esri.views.interactive.snapping.FeatureSnappingLayerSource")], e11);
var p11 = e11;
...
e([y()], p12.prototype, "enabled", void 0), e([y()], p12.prototype, "enabledToggled", void 0), e([y()], p12.prototype, "selfEnabled", void 0), e([y()], p12.prototype, "featureEnabled", void 0), e([y({ type: V2.ofType(p11) })], p12.prototype, "featureSources", void 0), e([y()], p12.prototype, "distance", void 0), e([y()], p12.prototype, "touchSensitivityMultiplier", void 0), e([y({ readOnly: true })], p12.prototype, "effectiveEnabled", null), e([y({ readOnly: true })], p12.prototype, "effectiveSelfEnabled", null), e([y({ readOnly: true })], p12.prototype, "effectiveFeatureEnabled", null), p12 = e([a("esri.views.interactive.snapping.SnappingOptions")], p12);
var l12 = p12;
...
var M5 = class extends d {
  get updating() {
    return n(this.snappingSources, ({ snappingSource: e13 }) => e13.updating) || this.updatingHandles.updating;
  }
  get snappingSources() {
  ...
  _loadSourceModule(e13) {
    ...
    switch (e13) {
      case "featureService":
        return t15.addPromise(import("./FeatureServiceSnappingSource-K6D3M6SP.js"));
      case "featureCollection":
        return t15.addPromise(import("./FeatureCollectionSnappingSource-6XHOFUG3.js"));
      case "graphics":
      case "notes":
        return t15.addPromise(import("./GraphicsSnappingSource-KR7TV4SN.js"));
      case "scene":
        return t15.addPromise(import("./SceneLayerSnappingSource-ROKEOYZM.js"));
    }
  }
};
e([y({ constructOnly: true })], M5.prototype, "spatialReference", void 0), e([y({ constructOnly: true })], M5.prototype, "view", void 0), e([y()], M5.prototype, "options", void 0), e([y({ readOnly: true })], M5.prototype, "updating", null), e([y({ readOnly: true })], M5.prototype, "snappingSources", null), M5 = e([a("esri.views.interactive.snapping.FeatureSnappingEngine")], M5);
var R5 = class {
  constructor(e13, t15) {
...
e([y({ readOnly: true })], h14.prototype, "updating", void 0), e([y({ constructOnly: true })], h14.prototype, "view", void 0), e([y()], h14.prototype, "options", null), h14 = e([a("esri.views.interactive.snapping.SelfSnappingEngine")], h14);
...
var T5;
e([y({ constructOnly: true })], P8.prototype, "view", void 0), e([y()], P8.prototype, "options", void 0), e([y({ readOnly: true })], P8.prototype, "updating", null), e([y()], P8.prototype, "snappingEnginesFactory", void 0), e([y()], P8.prototype, "_engines", void 0), e([y()], P8.prototype, "_squaredMouseProximityTreshold", null), e([y()], P8.prototype, "_squaredTouchProximityThreshold", null), e([y()], P8.prototype, "_squaredSatisfiesConstraintThreshold", null), P8 = e([a("esri.views.interactive.snapping.SnappingManager")], P8), function(e13) {
...
function f11({ predicate: o13 = () => true, snappingManager: r17, snappingContext: l15, updatingHandles: u12, useZ: c9 = true }) {
  ...
  const T6 = () => {
    Z4 = e3(Z4), r17.doneSnapping(), null != j5 && j5.frameTask.remove(), j5 = null, f12 = o2(f12), z5 = null;
  }, k4 = d8(r17, c9, p16);
    ...
    if (null != j5) {
      ...
      if (U6 = C3, h15(s14, C3, g13, c9), w5 = m8, I6 = T7, "end" !== e13) {
        ...
        null == Z4 && (Z4 = new AbortController()), z5 = (e14) => {
          u12.addPromise(y2(k4({ frameTask: n17, event: S7, context: y8, point: m8, scenePoint: T7, delta: g13, getLastState: () => ({ point: w5, scenePoint: I6, updatePoint: e14.forceUpdate ? null : U6 }) }, Z4.signal)));
...
var p14 = class extends m {
  ...
  destroy() {
    this._abortController = e3(this._abortController), this._frameTask = o2(this._frameTask);
  }
  update(t15, s14, o13) {
  ...
  abort() {
    this._abortController = e3(this._abortController), this._snapPoints = null;
  }
};
e([y({ constructOnly: true })], p14.prototype, "view", void 0), e([y()], p14.prototype, "stagedPoint", null), e([y()], p14.prototype, "constrainResult", void 0), e([y()], p14.prototype, "_stagedPoint", void 0), p14 = e([a("esri.views.interactive.snapping.SnappingOperation")], p14);
...
var ut = class extends d {
  ...
  initialize() {
    ...
    this.addHandles([n16.on("after-add", (t16) => this._addComputation(t16.item)), n16.on("after-remove", (t16) => this._removeComputation(t16.item))]), this.addHandles([l3(() => ({ stagedPoint: this._snappingOperation.stagedPoint, stagedComputation: this._stagedComputation }), ({ stagedPoint: t16, stagedComputation: e14 }) => {
    ...
    }), l3(() => n3(this._stagedComputation, (t16) => {
      ...
      if (null == t16 || null != e14) {
        ...
        this.updatingHandles.addPromise(y2(this._snappingOperation.resnap(this._snappingManager, e15)));
      }
      if (null != t16) {
  ...
  onPointerMove({ mapPoint: t15, pointerType: e13 }) {
    ...
    this.updatingHandles.addPromise(y2(this._snappingOperation.snap({ point: t15 }, this._snappingManager, i6)));
  }
  ...
  _onUnstagedClick({ mapPoint: t15, pointerType: e13 }) {
    ...
    const o13 = new u3({ startPoint: x4(a17, new x2()), endPoint: null, measureType: t6.Horizontal });
...
e([y({ constructOnly: true })], ut.prototype, "analysis", void 0), e([y({ constructOnly: true })], ut.prototype, "analysisViewData", void 0), e([y({ constructOnly: true })], ut.prototype, "manipulators", void 0), e([y({ constructOnly: true })], ut.prototype, "parentTool", void 0), e([y({ constructOnly: true, nonNullable: true })], ut.prototype, "view", void 0), e([y({ readOnly: true })], ut.prototype, "updating", null), e([y()], ut.prototype, "firstGrabbedManipulator", null), e([y()], ut.prototype, "hasGrabbedManipulators", null), e([y()], ut.prototype, "snappingOptions", null), e([y()], ut.prototype, "_stagedDimension", void 0), e([y()], ut.prototype, "_activeComputation", null), e([y()], ut.prototype, "_stagedComputation", null), ut = e([a("esri.views.3d.analysis.Dimension.LengthDimensionSubTool")], ut);
var ct = n4();
...
var S6 = class extends a11 {
  ...
  initialize() {
    this._intersector = A3(this.view.state.viewingMode), this._intersector.options.store = t8.MIN, this._lengthDimensionSubTool = new ut({ analysis: this.analysis, analysisViewData: this.analysisViewData, manipulators: this.manipulators, parentTool: this, view: this.view }), this.addHandles([o(this._lengthDimensionSubTool), e2(() => this._clearPointerMoveTimeout()), l3(() => this.state, (e13) => {
  ...
  _clearPointerMoveTimeout() {
    this._prevPointerMoveTimeout = o2(this._prevPointerMoveTimeout);
  }
...
e([y({ constructOnly: true })], S6.prototype, "view", void 0), e([y({ constructOnly: true })], S6.prototype, "analysis", void 0), e([y({ readOnly: true })], S6.prototype, "state", null), e([y({ readOnly: true })], S6.prototype, "updating", null), e([y({ readOnly: true })], S6.prototype, "cursor", null), e([y({ constructOnly: true })], S6.prototype, "analysisViewData", void 0), e([y()], S6.prototype, "selectedDimension", null), e([y()], S6.prototype, "automaticManipulatorSelection", void 0), e([y()], S6.prototype, "_activeSubTool", void 0), e([y()], S6.prototype, "_lengthDimensionSubTool", void 0), S6 = e([a("esri.views.3d.analysis.Dimension.DimensionTool")], S6);
...
var v14 = class extends m {
  ...
  initialize() {
    for (const i6 of this._lineMaterials())
      this.view._stage.add(i6), this.addHandles(e2(() => {
        var _a;
    ...
    this.addHandles([e13.on("change", ({ added: e14, removed: i6 }) => {
      ...
      for (const i6 of this._dimensionVisualizations.values())
        i6.visible = e14;
    })]), this.addHandles([s4(() => this._updateMessageBundle()), f2(() => !this.loadingMessages, () => {
...
e([y({ constructOnly: true })], v14.prototype, "analysisViewData", void 0), e([y({ constructOnly: true, nonNullable: true })], v14.prototype, "view", void 0), e([y()], v14.prototype, "analysis", null), e([y()], v14.prototype, "visible", null), e([y()], v14.prototype, "loadingMessages", void 0), v14 = e([a("esri.views.3d.analysis.Dimension.DimensionVisualization")], v14);
...
e([y({ constructOnly: true, nonNullable: true })], t14.prototype, "dimension", void 0), e([y()], t14.prototype, "length", void 0), t14 = e([a("esri.views.3d.analysis.LengthDimensionResult")], t14);
var c8 = t14;
...
e([y({ constructOnly: true, nonNullable: true })], l14.prototype, "result", void 0), e([y({ constructOnly: true, nonNullable: true })], l14.prototype, "projectAndAlignPoint", void 0), e([y()], l14.prototype, "dimension", null), e([y()], l14.prototype, "length", null), e([y()], l14.prototype, "geometry", void 0), e([y()], l14.prototype, "unconstrainedGeometry", void 0), e([y()], l14.prototype, "elevationAlignedStartPoint", void 0), e([y()], l14.prototype, "elevationAlignedEndPoint", void 0), e([y()], l14.prototype, "preConstraintProperties", void 0), e([y()], l14.prototype, "previousConstraint", void 0), l14 = e([a("esri.views.3d.analysis.LengthDimensionComputation")], l14);
...
var r16 = (r17) => {
  ...
  return e([y({ constructOnly: true })], i6.prototype, "view", void 0), e([y({ constructOnly: true, nonNullable: true })], i6.prototype, "analysis", void 0), e([y()], i6.prototype, "tool", void 0), e([y({ readOnly: true })], i6.prototype, "results", null), e([y()], i6.prototype, "selectedDimension", void 0), e([y()], i6.prototype, "interactive", void 0), e([y()], i6.prototype, "visible", void 0), i6 = e([a("esri.views.analysis.DimensionAnalysisView")], i6), i6;
};
...
var v15 = class extends r16(s8(m)) {
  ...
  destroy() {
    this._placementTask = e3(this._placementTask), this._analysisVisualization = l(this._analysisVisualization), v8(this);
  }
  get updating() {
    var _a;
  ...
  async createLengthDimensions(i6) {
    return this.selectedDimension = null, this._placementTask = e3(this._placementTask), this._placementTask = l9(this, i6), this._placementTask.promise;
  }
  _onDimensionAdd(i6) {
...
e([y({ readOnly: true })], v15.prototype, "type", void 0), e([y()], v15.prototype, "tool", void 0), e([y()], v15.prototype, "updating", null), e([y({ readOnly: true })], v15.prototype, "results", null), e([y({ readOnly: true })], v15.prototype, "computations", void 0), e([y()], v15.prototype, "selectedDimension", void 0), e([y()], v15.prototype, "selectedComputation", null), e([y()], v15.prototype, "_analysisVisualization", void 0), e([y()], v15.prototype, "_analysisController", void 0), e([y()], v15.prototype, "_dimensionsToComputations", void 0), e([y()], v15.prototype, "_placementTask", void 0), v15 = e([a("esri.views.3d.analysis.DimensionAnalysisView3D")], v15);
var g12 = v15;
export {
  g12 as default
};
//# sourceMappingURL=DimensionAnalysisView3D-QR6LRH4T.js.map
