...
var o = class {
  ...
  async extractComponentsEdgeLocations(t) {
    const s = c(t), i = u2(s.data, s.skipDeduplicate, s.indices, s.indicesLength), a2 = p(i, p2, g), o2 = [];
    return { result: u(a2.regular.instancesData, o2), transferList: o2 };
  }
  async extractEdgeLocations(t) {
    const s = c(t), i = u2(s.data, s.skipDeduplicate, s.indices, s.indicesLength), a2 = p(i, f2, g), o2 = [];
    return { result: u(a2.regular.instancesData, o2), transferList: o2 };
  }
};
function c(e) {
...
//# sourceMappingURL=EdgeProcessingWorker-SNZDAJAY.js.map
