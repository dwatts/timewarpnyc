...
import {
  L as L2,
  p as p3
} from "./chunk-4SVRUNFD.js";
import {
  e as e2
} from "./chunk-A5HE5G4C.js";
import {
  o as o3
...
e([y({ type: M, json: { read: { source: "fullExtent" } } })], n.prototype, "fullExtent", void 0), e([y({ type: String, json: { read: { source: "id" } } })], n.prototype, "id", void 0), e([y({ type: j3, json: { read: { source: "tileInfo" } } })], n.prototype, "tileInfo", void 0), n = l3 = e([a2("esri.layer.support.TileMatrixSet")], n);
var p4 = n;
...
function L3(e3, t3, n2) {
  ...
  const T2 = F(e3, l4, p8, m3, M3[0]).toJSON(), y3 = new j3({ dpi: 96, spatialReference: f3, size: m3, origin: p8, lods: M3 }).toJSON();
...
var $ = W = class extends a4(p(t2(c(j2(O2(b)))))) {
  constructor(...e3) {
