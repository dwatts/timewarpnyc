...
function a(e2, t2, r2, n2, o2, i2, l2 = true) {
  ...
  for (let f2 = 0; f2 < i2; f2++)
    for (let r3 = 0; r3 < o2; r3++) {
      ...
      let M2 = 0, C = 0, m2 = 0, b2 = 0, p2 = 0, d2 = 0, I2 = 0;
      const h2 = (f2 + 0.5) * s2;
      for (let n3 = Math.floor(f2 * s2); n3 < (f2 + 1) * s2; n3++) {
        ...
        for (let s3 = Math.floor(r3 * c2); s3 < (r3 + 1) * c2; s3++) {
          ...
          o4 >= -1 && o4 <= 1 && (M2 = 2 * o4 * o4 * o4 - 3 * o4 * o4 + 1, M2 > 0 && (r4 = 4 * (s3 + n3 * t2), I2 += M2 * e2[r4 + 3], m2 += M2, e2[r4 + 3] < 255 && (M2 = M2 * e2[r4 + 3] / 250), b2 += M2 * e2[r4], p2 += M2 * e2[r4 + 1], d2 += M2 * e2[r4 + 2], C += M2));
        }
      }
      n2[y2] = b2 / C, n2[y2 + 1] = p2 / C, n2[y2 + 2] = d2 / C, n2[y2 + 3] = I2 / m2;
    }
}
function u(e2) {
...
var b = (e2, t2 = 0) => null == e2 || isNaN(e2) ? t2 : e2;
var p = (e2) => e2.tintColor ? u(e2.tintColor) : { r: 255, g: 255, b: 255, a: 1 };
var d = (e2) => {
  if (!e2)
    return false;
  for (const t2 of e2)
...
//# sourceMappingURL=chunk-RSPVLZNN.js.map
