...
var p = class extends y {
  ...
  initialize() {
    l(() => this.enabled, (e2) => this.view.basemapTerrain.renderPatchBorders = e2, h);
  }
  getTiles() {
    const e2 = null != this.view.basemapTerrain.spatialReference ? this.view.basemapTerrain.spatialReference : null;
    return this.view.basemapTerrain.test.getRenderedTiles().map((r) => ({ ...r, geometry: j.fromExtent(c(r.extent, e2)) }));
  }
};
p = e([a("esri.views.3d.layers.support.TerrainTileTree3DDebugger")], p);
export {
  p as TerrainTileTree3DDebugger
};
//# sourceMappingURL=TerrainTileTree3DDebugger-EPD4IAPJ.js.map
