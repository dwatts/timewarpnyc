  ...
  writeToStore(s16, o6, n6) {
    ...
    return s16.forEach((s17) => {
      ...
      if (n6 && (u4 = s17.properties[n6] ? rt(s17.properties[n6]) : null), "originId" in s17 && "destinationId" in s17 && (s17.properties[i] = s17.originId, s17.properties[r] = s17.destinationId), s17.properties[o6] = s17.id, s17.id && this._featureLookup.has(s17.id) && this._featureLookup.get(s17.id).attributes) {
        ...
        a8 = new t(u4 ? JSON.parse(JSON.stringify(u4)) : (e9 == null ? void 0 : e9.geometry) ? JSON.parse(JSON.stringify(e9.geometry)) : null, JSON.parse(JSON.stringify(Object.assign(e9.attributes, s17.properties))), null, s17.properties[o6]);
      } else
        a8 = new t(u4 ? JSON.parse(JSON.stringify(u4)) : null, s17.properties, null, s17.properties[o6]);
...
async function o3(s16) {
  if (s16) {
    const { default: s17 } = await import("./arcgis-knowledge-client-core-simd-K74N4VUO.js").then((e9) => e9.a);
    return s17({ locateFile: (s18) => a2(t9 + s18) });
  }
  const { default: n6 } = await import("./arcgis-knowledge-client-core-IHOTPDYX.js").then((e9) => e9.a);
...
function s10(i10, a8) {
  ...
  if (i10 instanceof x)
    return g(i10, a8);
  if (i10 instanceof m2 || i10 instanceof j)
    return c6(i10, a8);
...
function c6(e9, t16) {
  ...
  const i10 = [], a8 = [];
  let l7 = [];
  e9 instanceof m2 ? (n6.geometry_type = t16.esriGeometryType.esriGeometryPolyline, l7 = e9.paths) : e9 instanceof j && (n6.geometry_type = t16.esriGeometryType.esriGeometryPolygon, l7 = e9.rings);
  let s16 = 0, u4 = 0;
...
var k2 = { fetchKnowledgeGraph: async (e9) => {
  ...
  var _a, _b;
  const r6 = (await j2(e9.url, { query: { f: "json" } })).data;
  ...
  var _a;
  const i10 = `${e9.url}/graph/query`, d3 = await j2(i10, { responseType: "array-buffer", query: { f: "pbf", openCypherQuery: a8.openCypherQuery, ...o6 == null ? void 0 : o6.query }, signal: o6 == null ? void 0 : o6.signal, timeout: o6 == null ? void 0 : o6.timeout }), p19 = (_a = d3.getHeader) == null ? void 0 : _a.call(d3, "content-type"), c12 = d3.data;
...
async function R2(e9, r6) {
  return j2(e9, { responseType: "native-request-init", method: "post", query: { f: "pbf", ...r6 == null ? void 0 : r6.query }, body: "x", headers: { "Content-Type": "application/octet-stream" }, signal: r6 == null ? void 0 : r6.signal, timeout: r6 == null ? void 0 : r6.timeout });
}
async function P(e9) {
...
async function W(e9) {
  var _a;
  const a8 = `${e9.url}/dataModel/queryDataModel`, n6 = await j2(a8, { responseType: "array-buffer", query: { f: "pbf" } }), o6 = (_a = n6.getHeader) == null ? void 0 : _a.call(n6, "content-type"), i10 = n6.data;
...
var M4 = class extends m {
  ...
  async getData(e9, t16, i10) {
    ...
    if (t16.objectType.name && ((_a = this.inclusionModeDefinition) == null ? void 0 : _a.namedTypeDefinitions) && this.inclusionModeDefinition.namedTypeDefinitions.size > 0 && !this.inclusionModeDefinition.namedTypeDefinitions.has(t16.objectType.name))
      return [];
    let n6;
    if (n6 = e9 || new b2({ where: "1=1", outFields: ["*"] }), "link-chart" === t16.parentCompositeLayer.type) {
      ...
      let r6 = "", p19 = "";
      s16 && s16.extent && (r6 = p5(s16.extent.ymin, s16.extent.xmin, w2), p19 = p5(s16.extent.ymax, s16.extent.xmax, w2)), o6 && 1 === o6.length && o6[0] === f5 && "1=1" === n6.where || await Promise.all(i11 ?? []);
  ...
  async retrieveDataFromService(e9, t16, i10) {
    ...
    if (null != e9.geometry) {
      ...
      }), a8 = new a7({ openCypherQuery: u4, bindParameters: { param_filter_geom: new j({ rings: [[[n7.xmin, n7.ymin], [n7.xmin, n7.ymax], [n7.xmax, n7.ymax], [n7.xmax, n7.ymin], [n7.xmin, n7.ymin]]] }) } });
    } else {
      let i11 = "";
...
var M5 = class extends n2(p17(a3(t3(p3(b))))) {
  constructor(e9) {
    var _a, _b, _c, _d, _e;
  ...
  async refreshCachedQueryEngine() {
    const e9 = await this.parentCompositeLayer.dataManager.getData(new b2({ where: "1=1", outFields: [f5] }), this);
    this._cachedQueryEngine = this.loadQueryEngine(e9);
  }
  async _setupQueryObjects(e9, t16) {
    var _a;
    const r6 = b2.from(e9), o6 = r6.geometry;
    let s16;
    if (o6 && !((_a = o6.spatialReference) == null ? void 0 : _a.isWGS84) && (await Rn(o6.spatialReference, p), r6.geometry = nn(o6 instanceof j || o6 instanceof m2 ? o6 : o6.extent, p)), "link-chart" === this.parentCompositeLayer.type && this._cachedQueryEngine)
...
var r5 = null;
function n5() {
  return e8 || (e8 = import("./lclayout-PW2ZJPFE.js").then((t16) => t16.l).then(({ default: e9 }) => e9({ locateFile: (e10) => a2(`esri/libs/linkchartlayout/${e10}`) })).then((t16) => {
    s15(t16);
  }), e8);
}
function s15(t16) {
...
var j6 = class extends a3(t3(b)) {
        ...
        if (this._initializeLayerProperties({ knowledgeGraph: a8, inclusionModeDefinition: this._originalInclusionList }), ((_b = (_a = this.dataManager.inclusionModeDefinition) == null ? void 0 : _a.namedTypeDefinitions) == null ? void 0 : _b.size) || (this.dataManager.inclusionModeDefinition = { generateAllSublayers: false, namedTypeDefinitions: /* @__PURE__ */ new Map() }, (_c = this.dataManager.knowledgeGraph.dataModel.entityTypes) == null ? void 0 : _c.forEach((e10) => {
          ...
          this.loadLayerAssumingLocalCache(), this.dataManager.inclusionModeDefinition && (this.dataManager.inclusionModeDefinition.generateAllSublayers = false), (_e = this.dataManager.inclusionModeDefinition) == null ? void 0 : _e.namedTypeDefinitions.forEach((e10) => {
            ...
            e10.useAllData = false, (_a2 = e10.members) == null ? void 0 : _a2.forEach((e11) => {
              let t17;
              t17 = e11.linkChartLocation instanceof t2 ? e11.linkChartLocation : e11.linkChartLocation ? rt(e11.linkChartLocation) : null, this.linkChartDiagramLookup.set(e11.id, t17), t17 && 2 === t17.coords.length && 0 === t17.lengths.length ? this.linkChartGeohashLookup.set(e11.id, p5(t17.coords[1], t17.coords[0], w2)) : this.linkChartGeohashLookup.set(e11.id, "");
    ...
    this.memberRelationshipTypes.forEach((e9) => {
      ...
      (_a2 = e9.members) == null ? void 0 : _a2.forEach((e10) => {
        if (a8.add(e10.id), e10.linkChartLocation)
          if (e10.linkChartLocation instanceof t2)
            this.linkChartDiagramLookup.set(e10.id, e10.linkChartLocation), 2 === e10.linkChartLocation.coords.length && 0 === e10.linkChartLocation.lengths.length ? this.linkChartGeohashLookup.set(e10.id, p5(e10.linkChartLocation.coords[1], e10.linkChartLocation.coords[0], w2)) : this.linkChartGeohashLookup.set(e10.id, "");
          else {
            const t17 = rt(e10.linkChartLocation);
            this.linkChartDiagramLookup.set(e10.id, e10.linkChartLocation ? t17 : null), "x" in e10.linkChartLocation && "y" in e10.linkChartLocation ? this.linkChartGeohashLookup.set(e10.id, p5(e10.linkChartLocation.x, e10.linkChartLocation.y, w2)) : this.linkChartGeohashLookup.set(e10.id, "");
          }
      });
    }));
  }
  async calculateLinkChartLayout(e9 = "RADIAL_TREE", t16) {
    ...
    for (let a8 = 0; a8 < A4.length; a8++) {
      ...
      this.linkChartDiagramLookup.set(A4[a8].feature.attributes[f5], A4[a8].feature.attributes[T4] ? e10 : null), this.linkChartGeohashLookup.set(A4[a8].feature.attributes[f5], p5(A4[a8].feature.attributes[T4].y, A4[a8].feature.attributes[T4].x, w2)), A4[a8].feature.attributes[T4].x < P3.xmin && (P3.xmin = A4[a8].feature.attributes[T4].x), A4[a8].feature.attributes[T4].x > P3.xmax && (P3.xmax = A4[a8].feature.attributes[T4].x), A4[a8].feature.attributes[T4].y < P3.ymin && (P3.ymin = A4[a8].feature.attributes[T4].y), A4[a8].feature.attributes[T4].y > P3.ymax && (P3.ymax = A4[a8].feature.attributes[T4].y);
    }
  ...
  async _initializeDiagram() {
    ...
    this.defaultLinkChartConfig ? this.defaultLinkChartConfig.doNotRecalculateLayout ? ((_b = (_a = this.dataManager.inclusionModeDefinition) == null ? void 0 : _a.namedTypeDefinitions) == null ? void 0 : _b.forEach((e9) => {
      ...
      (_a2 = e9 == null ? void 0 : e9.members) == null ? void 0 : _a2.forEach((e10) => {
        ...
        const o6 = rt(a8);
        this.linkChartDiagramLookup.set(i10, o6), this.linkChartGeohashLookup.set(i10, p5(a8.x, a8.y, w2)), this.linkChartExtent.xmin > a8.x && (this.linkChartExtent.xmin = a8.x), this.linkChartExtent.xmax < a8.x && (this.linkChartExtent.xmax = a8.x), this.linkChartExtent.ymin > a8.y && (this.linkChartExtent.ymin = a8.y), this.linkChartExtent.ymax < a8.y && (this.linkChartExtent.ymax = a8.y);
      });
    }), this.memberRelationshipTypes.forEach((e9) => {
      var _a2;
...
//# sourceMappingURL=LinkChartLayer-DEKZFZO6.js.map
