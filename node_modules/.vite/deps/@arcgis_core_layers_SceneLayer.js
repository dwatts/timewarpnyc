...
var c5;
var p6 = c5 = class extends u(V.ofType(j)) {
  constructor(e3) {
    super(e3);
  }
  clone() {
  ...
  static fromJSON(e3, r4) {
    const t6 = new c5();
    return e3.forEach((e4) => t6.add(j.fromJSON(e4, r4))), t6;
  }
};
...
var g2 = h2 = class extends l {
  ...
  readGeometries(e3, r4, o2) {
    Array.isArray(e3) ? this.geometries = l5.fromJSON(e3, o2) : this._geometriesSource = { url: i2(e3, o2), context: o2 };
  }
  async loadGeometries(e3, o2) {
    if (null == this._geometriesSource)
      return;
    const { url: s7, context: t6 } = this._geometriesSource, i6 = await j3(s7, { responseType: "json", signal: o2 == null ? void 0 : o2.signal }), a4 = e3.toJSON(), p7 = i6.data.map((e4) => ({ ...e4, spatialReference: a4 }));
...
var ae = s4();
var ne = class extends c3(N(l3(c2(j4(t3(O(i3(i(b))))))))) {
  constructor(...e3) {
  ...
  async queryCachedAttributes(e3, t6) {
    const r4 = b3(this.fieldsIndex, await n3(this, p5(this)));
  ...
  async queryCachedStatistics(e3, t6) {
    ...
    for (const s7 of this.statisticsInfo)
      if (s7.name === r4.name) {
        ...
        return j3(e4, { query: { f: "json", token: this.apiKey }, responseType: "json", signal: t6 ? t6.signal : null }).then((e5) => e5.data);
      }
  ...
  async applyEdits(e3, t6) {
    const { applyEdits: r4 } = await import("./editingSupport-V4Y55T2Y.js");
    if (await this.load(), !this.associatedLayer)
...
} } }, "portal-item": { write: true }, service: { read: false } } } })], ne.prototype, "opacity", void 0), e([y({ type: ["Low", "High"], readOnly: true, json: { read: false, origins: { service: { read: true } } } })], ne.prototype, "priority", void 0), e([y({ type: ["Labels"], readOnly: true, json: { read: false, origins: { service: { read: true } } } })], ne.prototype, "semantic", void 0), e([y({ types: n2, json: { origins: { service: { read: { source: "drawingInfo.renderer" } } }, name: "layerDefinition.drawingInfo.renderer", write: true }, value: null })], ne.prototype, "renderer", null), e([y({ json: { read: false } })], ne.prototype, "cachedDrawingInfo", void 0), e([o("service", "cachedDrawingInfo")], ne.prototype, "readCachedDrawingInfo", null), e([y({ readOnly: true, json: { read: false } })], ne.prototype, "capabilities", null), e([y({ type: Boolean, json: { read: false } })], ne.prototype, "editingEnabled", null), e([y({ readOnly: true, json: { write: false, read: false } })], ne.prototype, "infoFor3D", null), e([y(p)], ne.prototype, "popupEnabled", void 0), e([y({ type: k, json: { name: "popupInfo", write: true } })], ne.prototype, "popupTemplate", void 0), e([y({ readOnly: true, json: { read: false } })], ne.prototype, "defaultPopupTemplate", null), e([y({ type: String, json: { read: false } })], ne.prototype, "objectIdField", void 0), e([o("service", "objectIdField", ["objectIdField", "fields"])], ne.prototype, "readObjectIdField", null), e([y({ type: String, json: { read: false } })], ne.prototype, "globalIdField", void 0), e([o("service", "globalIdField", ["globalIdField", "fields"])], ne.prototype, "readGlobalIdField", null), e([y({ readOnly: true, type: String, json: { read: false } })], ne.prototype, "displayField", null), e([y({ type: String, json: { read: false } })], ne.prototype, "profile", void 0), e([o("service", "profile", ["store.profile"])], ne.prototype, "readProfile", null), e([y({ readOnly: true, type: String, json: { origins: { service: { read: { source: "store.normalReferenceFrame" } } }, read: false } })], ne.prototype, "normalReferenceFrame", void 0), e([y(l2)], ne.prototype, "screenSizePerspectiveEnabled", void 0), ne = e([a2("esri.layers.SceneLayer")], ne);
...
//# sourceMappingURL=@arcgis_core_layers_SceneLayer.js.map
