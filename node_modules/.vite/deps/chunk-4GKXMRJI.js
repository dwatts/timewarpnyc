...
function v3(e5, s8, l4, a6) {
  r(g3, l4), g3[a6] = s8[a6];
  const c5 = e3(g3, g3, s8), u3 = e3(d4, e5, s8), f2 = P2(u3, c5), m4 = P2(c5, c5);
  let h2;
...
function c3(o5, s8) {
  if (null == o5)
    return w2();
  const c5 = o5.lods.length - 1, a6 = o5.spatialReference, m4 = ce(a6) || T(a6) || P(a6);
  if (a6.isWebMercator) {
...
//# sourceMappingURL=chunk-4GKXMRJI.js.map
