import {
  ...
  r,
  s as s4
} from "./chunk-J3HE7QNA.js";
import {
  o as o2,
  r as r2
} from "./chunk-3ESTI2X4.js";
import {
  f
...
async function o3(o5, i2, n, m3) {
  const a = f(o5), p2 = i2[0].spatialReference, u = { ...m3, query: { ...a.query, f: "json", sr: JSON.stringify(p2), target: JSON.stringify({ geometryType: v(i2[0]), geometries: i2 }), cutter: JSON.stringify(n) } }, c = await j2(a.path + "/cut", u), { cutIndexes: f2, geometries: g2 = [] } = c.data;
...
async function o4(o5, m3, f2) {
  const n = "string" == typeof o5 ? L(o5) : o5, p2 = m3[0].spatialReference, a = v(m3[0]), u = { ...f2, query: { ...n.query, f: "json", sr: p2.wkid ?? JSON.stringify(p2), geometries: JSON.stringify(r2(m3)) } }, { data: y2 } = await j2(n.path + "/simplify", u);
...
function w(e, n) {
  if (!(e instanceof m || e instanceof j)) {
  ...
  return g(e) ? new j({ rings: l, spatialReference: e.spatialReference }) : new m({ paths: l, spatialReference: e.spatialReference });
}
function j3(e, t, n) {
  if (t) {
    const t2 = w(e, 1e6);
...
async function b(t, n, r3) {
  ...
  let g2, y2, x2, d3, w2, P, v2, L2, U = 0;
  const z = [], A = [];
  for (const e of t)
    if (null != e)
      if (g2 || (g2 = e.spatialReference, y2 = d(g2), x2 = g2.isWebMercator, P = x2 ? 102100 : 4326, d3 = r[P].maxX, w2 = r[P].minX, v2 = r[P].plus180Line, L2 = r[P].minus180Line), y2)
        if ("mesh" === e.type)
          A.push(e);
          ...
          A.push(t2.rings ? new j(t2) : t2);
        } else if (e.extent) {
          const t2 = e.extent, n2 = i(t2.xmin, w2) * (2 * d3);
          let o5 = 0 === n2 ? e.clone() : s4(e.clone(), n2);
          t2.offset(n2, 0), t2.intersects(v2) && t2.xmax !== d3 ? (U = t2.xmax > U ? t2.xmax : U, o5 = j3(o5, x2), z.push(o5), A.push("cut")) : t2.intersects(L2) && t2.xmin !== w2 ? (U = t2.xmax * (2 * d3) > U ? t2.xmax * (2 * d3) : U, o5 = j3(o5, x2, 360), z.push(o5), A.push("cut")) : A.push(o5);
        } else
          A.push(e.clone());
      else
        A.push(e);
...
//# sourceMappingURL=chunk-PVUG2RDQ.js.map
