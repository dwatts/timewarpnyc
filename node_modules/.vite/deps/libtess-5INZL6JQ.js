    ...
    if ("string" != typeof r2 && !Array.isArray(r2)) {
      for (const t4 in r2)
        if ("default" !== t4 && !(t4 in n)) {
          const e3 = Object.getOwnPropertyDescriptor(r2, t4);
          e3 && Object.defineProperty(n, t4, e3.get ? e3 : { enumerable: true, get: () => r2[t4] });
        }
    }
  }
...
var r;
var o = { exports: {} };
o.exports, e = o, void 0 !== (r = function() {
  function n(n2) {
    const t3 = n2.locateFile, r2 = {};
    var o2 = void 0 !== o2 ? o2 : {};
    const i2 = (() => {
      let n3;
      return { resolve: (t4) => n3(t4), promise: new Promise((t4) => n3 = t4) };
    })(), a2 = () => i2.promise;
    o2.locateFile = t3, o2.onRuntimeInitialized = () => {
      i2.resolve(r2);
    ...
    y ? (g = d ? require_path().dirname(g) + "/" : __dirname + "/", f = function(n3, t4) {
      return p || (p = require_fs()), m || (m = require_path()), n3 = m.normalize(n3), p.readFileSync(n3, t4 ? null : "utf8");
    }, l = function(n3) {
      var t4 = f(n3, true);
      return t4.buffer || (t4 = new Uint8Array(t4)), j(t4.buffer), t4;
    }, c = function(n3, t4, e2) {
      p || (p = require_fs()), m || (m = require_path()), n3 = m.normalize(n3), p.readFile(n3, function(n4, r3) {
        n4 ? e2(n4) : t4(r3.buffer);
      });
      ...
      r3.open("GET", n3, true), r3.responseType = "arraybuffer", r3.onload = function() {
        200 == r3.status || 0 == r3.status && r3.response ? t4(r3.response) : e2();
    ...
    var S = false;
    function j(n3, t4) {
      n3 || Q("Assertion failed: " + t4);
    }
    var T, x, I, H, M = "undefined" != typeof TextDecoder ? new TextDecoder("utf8") : void 0;
    function F(n3, t4, e2) {
      for (var r3 = t4 + e2, o3 = t4; n3[o3] && !(o3 >= r3); )
        ++o3;
      if (o3 - t4 > 16 && n3.subarray && M)
        return M.decode(n3.subarray(t4, o3));
      for (var i3 = ""; t4 < o3; ) {
        var a3 = n3[t4++];
        if (128 & a3) {
          var u2 = 63 & n3[t4++];
          if (192 != (224 & a3)) {
            var s2 = 63 & n3[t4++];
            if ((a3 = 224 == (240 & a3) ? (15 & a3) << 12 | u2 << 6 | s2 : (7 & a3) << 18 | u2 << 12 | s2 << 6 | 63 & n3[t4++]) < 65536)
    ...
    function en() {
      if (!A && (h || d)) {
        ...
        if (c)
          return new Promise(function(n3, t4) {
            c(V, function(t5) {
              n3(new Uint8Array(t5));
            }, t4);
          });
      }
    ...
    function rn() {
      ...
      function i3() {
        return A || "function" != typeof WebAssembly.instantiateStreaming || $(V) || nn(V) || "function" != typeof fetch ? r3(e2) : fetch(V, { credentials: "same-origin" }).then(function(t5) {
          return WebAssembly.instantiateStreaming(t5, n3).then(e2, function(n4) {
      ...
      if (J(), o2.instantiateWasm)
        try {
          return o2.instantiateWasm(n3, t4);
        } catch (a3) {
    ...
    function on(n3) {
      for (; n3.length > 0; ) {
        ...
        if ("function" != typeof t4) {
          var e2 = t4.func;
          "number" == typeof e2 ? void 0 === t4.arg ? H.get(e2)() : H.get(e2)(t4.arg) : e2(void 0 === t4.arg ? null : t4.arg);
        } else
          t4(o2);
      }
    }
    ...
    function un(n3, t4, e2) {
      x.copyWithin(n3, t4, t4 + e2);
    }
    function sn(n3) {
      try {
    ...
    var cn = { mappings: {}, buffers: [null, [], []], printChar: function(n3, t4) {
      var e2 = cn.buffers[n3];
      0 === t4 || 10 === t4 ? ((1 === n3 ? w : b)(F(e2, 0)), e2.length = 0) : e2.push(t4);
    ...
    function ln(n3, t4, e2, r3) {
      for (var o3 = 0, i3 = 0; i3 < e2; i3++) {
        for (var a3 = I[t4 + 8 * i3 >> 2], u2 = I[t4 + (8 * i3 + 4) >> 2], s2 = 0; s2 < u2; s2++)
    ...
    function _n(n3) {
      ...
      try {
        ...
        if (gn(t4), e2 !== e2 + 0 && "longjmp" !== e2)
          throw e2;
        vn(1, 0);
      }
    }
    function En(n3, t4, e2) {
      var r3 = yn();
      try {
        return H.get(n3)(t4, e2);
      } catch (o3) {
        if (gn(r3), o3 !== o3 + 0 && "longjmp" !== o3)
          throw o3;
        vn(1, 0);
    ...
    function Rn(n3, t4, e2, r3) {
      var o3 = yn();
      try {
        return H.get(n3)(t4, e2, r3);
      } catch (i3) {
    ...
    const Cn = (n3, t4, e2) => {
      ...
      const u2 = e2 * Mn;
      Tn || (Tn = Hn._malloc(u2 * a3)), r3 = Hn.HEAPF32, r3.set(n3, xn / a3), Hn.HEAP32.set(t4, In / o3);
      const s2 = u2 / i3, f2 = jn(xn, In, Math.min(t4.length, Fn), i3, Tn, s2), c2 = f2 * i3;
      r3 = Hn.HEAPF32;
...
var i = o.exports;
var a = t2({ __proto__: null, default: t(i) }, [i]);
export {
  a as l
};
//# sourceMappingURL=libtess-5INZL6JQ.js.map
