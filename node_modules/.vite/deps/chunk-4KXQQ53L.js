...
var f;
var d2 = { read: { reader: n }, write: { writer: a2, overridePolicy() {
...
e([y({ type: d, json: { write: { allowNull: true, writer(e2, r, t, i) {
  const s2 = e2 == null ? void 0 : e2.write({}, i);
  s2 && 0 !== Object.keys(s2).length ? o(t, s2, r) : o(t, null, r);
} } } })], p.prototype, "filter", void 0), e([y({ json: { write: true, origins: { "web-map": d2, "portal-item": d2 } } })], p.prototype, "includedEffect", void 0), e([y({ json: { write: true, origins: { "web-map": n2, "portal-item": n2 } } })], p.prototype, "excludedEffect", void 0), e([y({ type: Boolean, json: { write: true, name: "showExcludedLabels", origins: { "web-map": a3, "portal-item": a3 } } })], p.prototype, "excludedLabelsVisible", void 0), p = f = e([a("esri.layers.support.FeatureEffect")], p);
var w = p;

export {
  w
};
//# sourceMappingURL=chunk-4KXQQ53L.js.map
