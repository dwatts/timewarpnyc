...
function l(n) {
  ...
  return s2 > 0 ? (r2.x /= s2, r2.y /= s2, true === n.hasZ && (r2.z /= s2), true === n.hasM && (r2.m /= s2), new x(r2)) : o2 > 0 ? (e2.x /= o2, e2.y /= o2, true === n.hasZ && (r2.z /= o2), true === n.hasM && (e2.m /= o2), new x(e2)) : null;
}
function u(n) {
  ...
  return c2.spatialReference = n.spatialReference.toJSON(), true === n.hasZ && (c2.z = o2 / n.points.length), true === n.hasM && (c2.m = s2 / n.points.length), new x(c2);
}
function y(t, n) {
...
function z(t, n, e2) {
  ...
  return Math.atan2(x2(r2, o2), y(r2, o2));
}
function P(t, n, e2) {
...
//# sourceMappingURL=chunk-T4WPQ2DU.js.map
