...
function _(e4, s) {
  h(e4, s, new e3("slicePlaneOrigin", (e5, i2) => g(s, e5, i2)), new e3("slicePlaneBasis1", (e5, i2) => {
    var _a;
...
function P(e4, s) {
  h(e4, s, new o3("slicePlaneOrigin", (e5, i2) => g(s, e5, i2)), new o3("slicePlaneBasis1", (e5, i2) => {
    var _a;
    return I(s, e5, i2, (_a = i2.slicePlane) == null ? void 0 : _a.basis1);
...
#define discardBySlice(_pos_) { if (sliceByPlane(_pos_)) discard; }`, l = o2`vec4 applySliceHighlight(vec4 color, vec3 pos) {
...
}`, c = s.hasSliceHighlight ? o2`
        ${l}
        #define highlightSlice(_color_, _pos_) (sliceEnabled() ? applySliceHighlight(_color_, _pos_) : (_color_))
      ` : o2`#define highlightSlice(_color_, _pos_) (_color_)`;
  s.hasSliceInVertexProgram && e4.vertex.code.add(a), e4.fragment.code.add(a), e4.fragment.code.add(c);
}
function p(e4, s, i2) {
...
function g(e4, s, a) {
  if (null == a.slicePlane)
    return f;
  const l = p(e4, s, a), c = m(l, a.slicePlane), r = H(e4, l, a);
  return null != r ? O(v, c, r) : c;
}
function I(e4, s, c, r) {
  if (null == r || null == c.slicePlane)
    return f;
  const t = p(e4, s, c), n3 = m(t, c.slicePlane), f2 = H(e4, t, c);
  return null != f2 ? (u(B, r, n3), O(v, n3, f2), O(B, B, f2), e(B, B, v)) : r;
}
var b = n();
var v = n();
var B = n();
...
//# sourceMappingURL=chunk-XMR2X5WG.js.map
