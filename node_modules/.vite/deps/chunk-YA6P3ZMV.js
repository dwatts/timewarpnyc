...
var r7 = class extends n5 {
  ...
  find(e10) {
    let r8;
    return n2(this._map, (t10) => !!e10(t10) && (r8 = t10, true)), r8;
  }
  forEach(e10) {
...
var a5 = class {
  ...
  find(e10) {
    let s6;
    return n2(this._map, (t10) => !!e10(t10) && (s6 = t10, true)), s6;
  }
  toArray() {
    return [...this._map.values()];
  }
...
var xt = (t10) => {
  let o9 = class extends t10 {
    ...
    initialize() {
      ...
      this.updatingHandles.add(() => this.rendererTextureUsage, a8), this.updatingHandles.add(() => this.uncompressedTextureDownsamplingEnabled, a8), this.updatingHandles.add(() => this.contentVisible, (e11) => this._contentVisibleChanged(e11), h2), this.updatingHandles.add(() => this.i3slayer.labelsVisible, () => this._labelingChanged(), h2), this.updatingHandles.add(() => this.i3slayer.labelingInfo, () => this._labelingChanged(), h2), this.updatingHandles.add(() => this._modifications, () => this._modificationsChanged(), h2), this.handles.add([l3(() => t5.I3S_TREE_SHOW_TILES, (e11) => {
        if (e11 && !this._treeDebugger) {
          ...
          import("./I3STreeDebugger-WDRBTLK7.js").then(({ I3STreeDebugger: t12 }) => {
    ...
    _preLoadBasis() {
      !has("disable-feature:i3s-basis") && 0 != (this.supportedTextureEncodings & e8.Basis) && n3(this.i3slayer.textureSetDefinitions, (e10) => e10.some((e11) => e11.formats.some((e12) => "basis" === e12.format || "ktx2" === e12.format))) && g2();
    }
    ...
    _findGraphicNodeAndIndex(e10) {
      ...
      let i12 = null;
      return n2(this._nodeId2Meta, (e11) => {
        if (null == e11)
          return false;
...
function Ht(e10, t10) {
  ...
  if (null != t10)
    for (const s6 of t10)
      null != s6 && n(s6.data) && (i12 += s6.data.byteLength);
  return i12;
}
function Ut(e10, t10) {
...
//# sourceMappingURL=chunk-YA6P3ZMV.js.map
