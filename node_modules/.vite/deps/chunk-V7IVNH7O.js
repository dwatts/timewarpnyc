...
function w(e3) {
  return e3.split(t4)[0];
}
function v6(e3) {
  return e3.split(t4)[1];
}
...
var z2 = class {
    ...
    for (const p4 of this.items) {
      ...
      if (e3.returnVertex) {
        ...
        for (let t7 = 0; t7 < e4; t7 += i4) {
          ...
          u2 <= 1 && l5.candidates.push(t2(s6.getObjectId(p4), m5(e5), Math.sqrt(u2)));
        }
      }
    }
  ...
  _getStatisticValue(e3, t5, s6, i4) {
    ...
    let n4 = null;
    n4 = (s6 == null ? void 0 : s6.has(a5)) ? s6.get(a5) : ae(this.fieldsIndex.get(a5)) ? f3({ values: t5, returnDistinct: i4 }) : d({ values: i4 ? [...new Set(t5)] : t5, minValue: null, maxValue: null, useSampleStdDev: true }), s6 && s6.set(a5, n4);
...
var ee = class {
  ...
  async executeQueryForSnapping(e3, t5) {
    ...
    u2 && await f4(i4.spatialReference, this.spatialReference);
  ...
  async _checkStatisticsSupport(e3, t5) {
    ...
    return this._checkAttributesQuerySupport(e3), Promise.all([this._checkStatisticsParamsSupport(t5, e3), P2(e3, this.geometryType, this.spatialReference), f4(this.spatialReference, e3.outSR)]).then(() => e3);
  }
  ...
  async _checkQuerySupport(e3) {
    if ((e3.distance ?? 0) < 0 || null != e3.geometryPrecision || e3.multipatchOption || e3.pixelSize || e3.relationParam || e3.text)
      throw new s(W, "Unsupported query options", { query: e3 });
    return this._checkAttributesQuerySupport(e3), this._checkStatisticsQuerySupport(e3), Promise.all([P2(e3, this.geometryType, this.spatialReference), f4(this.spatialReference, e3.outSR)]).then(() => e3);
  }
...
//# sourceMappingURL=chunk-V7IVNH7O.js.map
