...
e([y({ constructOnly: true })], p.prototype, "renderCoordsHelper", void 0), e([y({ constructOnly: true })], p.prototype, "fetchEdgeLocations", void 0), e([y({ constructOnly: true })], p.prototype, "schedule", void 0), e([y({ readOnly: true })], p.prototype, "availability", void 0), p = e([a("esri.views.interactive.snapping.featureSources.sceneLayerSource.SceneLayerSnappingSourceWorker")], p);
...
var p2 = class extends d {
  ...
  destroy() {
    this._tracker = o2(this._tracker), this._abortController = e2(this._abortController);
  }
  initialize() {
    ...
    } }), this.updatingHandles.addPromise(this._setupLayerView()), this.handles.add([o(this._workerHandle), o(this._edgeWorker)]);
  }
  ...
  async _setupLayerView() {
    ...
    null == r3 || a2(e3) || (this._tracker = r3.trackSnappingSources({ add: (r4, t) => {
...
//# sourceMappingURL=SceneLayerSnappingSource-ROKEOYZM.js.map
