import{hS as m,hT as P,hU as v,bf as f,hV as u,hW as y,hX as O,hY as A,hZ as $,hu as r,h_ as g,h$ as S,i0 as c,i1 as C,aQ as E,i2 as x,i3 as _,ay as o,i4 as n,i5 as d,i6 as b,i7 as w,i8 as N,i9 as D,ia as M,ib as R,ic as I,id as F,ie as L,ig as U,ih as W,ii as B,ij as G,ik as j,il as z,im as H,io as q,hv as p,ip as Q,iq as V,ir as k,is as X}from"./index-2c565904.js";function Y(a){const e=new m,{vertex:t,fragment:s}=e;return P(t,a),e.include(v,a),e.attributes.add(f.POSITION,"vec3"),e.attributes.add(f.UV0,"vec2"),e.varyings.add("vpos","vec3"),a.hasMultipassTerrain&&e.varyings.add("depth","float"),t.code.add(u`
    void main(void) {
      vpos = position;
